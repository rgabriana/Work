...
def send_mail(dashboardFileName, filename):
    ...
    #receivers = ['Lalit Bhatt <Lalit.Bhatt@enlightedinc.com>','Yogesh Chitnis <Yogesh.Chitnis@enlightedinc.com>','Kushal.Chokhani@enlightedinc.com','sheetal.kulkarni@enlightedinc.com'] 
