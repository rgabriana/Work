		                ...
		                //      buildingNode.setSweepTimerId(campusNode.getSweepTimerId());
		                    ...
		                    for (Floor floor : floorlist) {
		                    	if(floor.getVisible()){
			                        ...
			                        if(dRTargetManager.isDRAssignedAndActiveOnFacility(floor.getId(), FacilityType.FLOOR)){
			                        	floorNode.setName(floor.getName() + " (DR)");
			                        	buildingNode.setName(building.getName()+ " (DR)");
		                            	campusNode.setName(campus.getName()+ " (DR)");
		                            	companyNode.setName(company.getName()+ " (DR)");
			                        }else{
			                      ...
			                      //    sweepTimerId = buildingNode.getSweepTimerId();
			                        ...
			                        for (Area area : arealist) {
			                        	if(area.getVisible()){
				                            ...
				                            if(dRTargetManager.isDRAssignedAndActiveOnFacility(area.getId(), FacilityType.AREA)){
				                            	areaNode.setName(area.getName()+ " (DR)");
				                            	floorNode.setName(floor.getName()+ " (DR)");
				                            	buildingNode.setName(building.getName()+ " (DR)");
				                            	campusNode.setName(campus.getName()+ " (DR)");
				                            	companyNode.setName(company.getName()+ " (DR)");
