...
public class Gateway extends Device implements Serializable {
    ...
    @XmlElement(name="noOfPlugloads")
    private Integer noOfPlugloads;
 
    @XmlElement(name = "noofactiveerc")
    private Integer noOfActiveErc;
	...
	public String getHexWirelessNetworkId() {
		return Integer.toHexString(this.wirelessNetworkId) ;
	...
	/**
   * @return the noOfPlugloads
   */
  public Integer getNoOfPlugloads() {
      return noOfPlugloads;
  }

  /**
   * @param noOfPlugloads the noOfPlugloads to set
   */
  public void setNoOfPlugloads(Integer noOfPlugloads) {
      this.noOfPlugloads = noOfPlugloads;
  }
	...
	public Integer getNoOfActiveErc() {
		return noOfActiveErc;
	}

	public void setNoOfActiveErc(Integer noOfActiveErc) {
		this.noOfActiveErc = noOfActiveErc;
	}
