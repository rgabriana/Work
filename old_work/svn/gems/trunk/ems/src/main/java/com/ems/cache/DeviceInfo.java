...
public class DeviceInfo {
  ...
  protected Long dbId = null; //id in the fixture table
  protected Date lastStatsRcvdTime = null;
  ...
  protected String deviceState = ServerConstants.FIXTURE_STATE_COMMISSIONED_STR;
  ...
  protected ArrayList<Long> profileSeqList = new ArrayList<Long>();
  ...
  public DeviceInfo(Fixture fixture) {
    ...
    this.deviceName = fixture.getFixtureName();
...
public void setLampCalibrationStatus(int lampCalibrationStatus) {
  ...
  public String dumpDeviceInfo() {
  	...
  	sb.append(";bootTime=");
  	sb.append(bootTime);
  	sb.append(";lastStatsRcvdTime =");
  	sb.append(lastStatsRcvdTime);
  	sb.append(";lastZeroBucketTime =");
  	sb.append(lastZeroBucketTime);
  	sb.append(";uptime =");
  	sb.append(uptime);
  	return sb.toString();
