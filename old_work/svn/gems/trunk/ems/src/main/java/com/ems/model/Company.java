...
public class Company implements Serializable {
    ...
    private String ntpServers = "0.us.pool.ntp.org,1.us.pool.ntp.org,2.us.pool.ntp.org,3.us.pool.ntp.org";  

    @XmlElement(name = "title24")
    private Title24 title24 = new Title24();
    ...
    private Boolean emcMode;
    
    private String emcKafkaServer;
	...
	public Title24 getTitle24() {
		return title24;
	}

	public void setTitle24(Title24 title24) {
	...
	public void setEmcMode(Boolean emcMode) {
		this.emcMode = emcMode;
	}

	public Boolean getEmcMode() {
		return emcMode;
	}

	public void setEmcKafkaServer(String emcKafkaServer) {
		this.emcKafkaServer = emcKafkaServer;
	}

	public String getEmcKafkaServer() {
		return emcKafkaServer;
	}
