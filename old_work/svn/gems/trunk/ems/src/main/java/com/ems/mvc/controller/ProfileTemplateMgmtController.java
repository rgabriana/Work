...
public class ProfileTemplateMgmtController {
	...
	public String manageProfileTemplate(Model model,@CookieValue(FacilityCookieHandler.selectedFacilityCookie) String cookie) throws EmsValidationException
	{
	...
	@RequestMapping(value = "/list.ems", method = {
			RequestMethod.POST, RequestMethod.GET })
	public String loadAllTemplate(Model model,@CookieValue(FacilityCookieHandler.selectedFacilityCookie) String cookie, @RequestParam(value = "status", required = false) String status) throws EmsValidationException
	{
    ...
    public String saveTemplate(ProfileTemplate profileTemplate) throws EmsValidationException {
    	 String type=null;
    	 String profileName = profileTemplate.getName();
    	 CommonUtils.isParamValueAllowedAndThrowException(messageSource, systemConfigurationManager, "profileTemplateMgmtController.profileName", profileName);
