        ...
        try {
          if (suPacket) {
            ...
            case ServerConstants.GATEWAY_INFO_RESP:
                ...
                break;
            case ServerConstants.GATEWAY_STATS_MSG:
            	if(logger.isDebugEnabled()) {
            		logger.debug(gwIp + ": stats packet " + ServerUtil.getLogPacket(pkt));
            	}
            	break;
            ...
            case ServerConstants.GATEWAY_PMG_RADIO_STATUS:
                ...
                break;
            case ServerConstants.CMD_FILE_XFER:
            	ImageUpgradeSO.getInstance().gwMissingPacketRequest(gwId, pkt);
            	break;
            ...
            if(logger.isDebugEnabled()) {
                ...
                break;
            default:
            	/* this must be gen 1 gateway protocol code. so commenting it out
                ...
                */
                    logger.error(gwIp + ": Unknown message(" + msgType + ")");
                //}
                break;
            }
          } 
