...
INSERT INTO system_configuration (id, name, value) values ((select coalesce(max(id),0)+1 from system_configuration), 'ble.forwarding.server', '');
 ...
 update system_configuration  set value ='22,8085,7,443,8443,80,389,12302,9191,2332,9092,2181' where name = 'iptables.rules.static.ports';
...
--Sree 08/17/2016
ALTER TABLE fixture add COLUMN curr_ble_mode character varying;    
