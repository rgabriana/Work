...
<%   
   ...
   if ( sAction != null) { %>   
   <script> alert("Error occured while saving EM, Please enter unique IP/Name");</script>   
<% } %> 
...
<div class="innerdiv">
<button id="addGEMButton"><spring:message code="gems.newEM" /></button>
...
<%-- 				<th align="center"><spring:message code="gems.gemsMacAddress" /></th> --%>
				<th align="center"><spring:message code="gems.gemsIpAddress" /></th>
				<th align="center"><spring:message code="gems.port" /></th>
				<th align="center"><spring:message code="gems.timezone" /></th>
