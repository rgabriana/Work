...
public final class CommandsConstants {
    ...
    public static final int BORDCAST_HEADER_BIT1 = 0x7f;
    public static final int BORDCAST_HEADER_BIT2 = 0x6f;
    ...
    public static final int OVERRIDE_PROFILE2 = 3;
    ...
    // plugload energy consumption values
    public static final double ENERGY_CONSUMPTION_FULL_ON = 5.0;
    public static final double ENERGY_CONSUMPTION_FULL_OFF = 0.0;
    public static final double ENERGY_CONSUMPTION_FULL_ON_BASELINE = 5.0;
    public static final double ENERGY_CONSUMPTION_FULL_OFF_BASELINE = 0.0;
 //saving type
    public static final byte PLUGLOAD_NONE_SAVING = 0;
    public static final byte PLUGLOAD_OCC_SAVING = 1;
    public static final byte PLUGLOAD_AMBIENT_SAVING = 2;
    public static final byte PLUGLOAD_TUNE_UP_SAVING = 3;
