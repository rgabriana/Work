...
public class CommunicatorConstant {
	...
	final public static String fileBasePathDir = System.getenv().get("OPT_ENLIGHTED")+"/communicator/logFileBaseDirPaths.properties" ;
	final public static String configFilePath = System.getenv().get("OPT_ENLIGHTED")+"/communicator/config.properties" ;
	
	final public static String syncDataDir = System.getenv().get("OPT_ENLIGHTED")+"/communicator/syncdata/";
	...
	public static final String getLastWalSyncService = emInstanceCloudContext+"/services/org/communicate/v3/em/lastWalSynced/";
	...
	public static final String callHomeService = ecloudContext+"/services/org/communicate/em/callhome/v5";
	
	public static final String downloadImageService = ecloudContext + "/services/org/upgrades/getdebian";
	
	public static final String downloadTSCertificateService = ecloudContext + "/services/org/communicate/getTSFile";
	
	public static final String downloadKSCertificateService = ecloudContext + "/services/org/communicate/getKSFile";
	...
	public static String emIpAddress = "";
	...
	public static final String TOMCAT_SERVICE = SYS_ENV.get("TOMCAT_SERVICE");
}
