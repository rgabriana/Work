...
public class EmFixtureUrls {
	...
	public static String getListOfWds = "/api/org/wds/list/";
	public static String getWdsDetails = "/api/org/wds/details/";
    ...
    public static String getEMMaxProfileNo = "/api/org/profile/getmaxprofileno/";
}
