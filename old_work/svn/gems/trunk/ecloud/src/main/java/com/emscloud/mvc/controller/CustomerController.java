...
public class CustomerController {
	...
	public String saveCustomer(Model model, Customer customer) throws EcloudValidationException {
		
		Map<String,Object> nameValMap = new HashMap<String, Object>();
        nameValMap.put("customerName", customer.getName());
        nameValMap.put("customerAddr", customer.getAddress());
        nameValMap.put("customerEmail", customer.getEmail());
        nameValMap.put("customerPhone", customer.getContact());
