...
//		}
	...
	public List<Long> getFloorsBySiteId(EmInstance emInstance, Long siteId) {
		return sppaDao.getFloorsBySiteId(emInstance.getDatabaseName(), emInstance.getReplicaServer().getInternalIp(), siteId);
	}
