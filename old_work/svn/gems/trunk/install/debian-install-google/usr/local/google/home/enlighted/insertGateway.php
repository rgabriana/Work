...
function updateGateway($ipAddress, $macAddress) {
  ...
  if( $ip_prev !== $ipAddress ){
        ...
        $link = "sh "+os.environ["ENL_APP_HOME"]+"/webapps/ems/adminscripts/callusingCurl.sh admin  -H \"Content-Type:application/xml\" -X POST https://localhost/ems/api/org/gateway/updateGatewayIP/macaddr/$macAddress/ipaddr/$ipAddress";
