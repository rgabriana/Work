...
-- Added by Yogesh 05/09/2012
CREATE SEQUENCE hvac_devices_seq
   INCREMENT 1
   START 1;
ALTER TABLE hvac_devices_seq OWNER TO postgres;
...
ALTER TABLE public.hvac_devices OWNER TO postgres;

ALTER TABLE ONLY hvac_devices
    ADD CONSTRAINT hvac_devices_pkey PRIMARY KEY (id);
