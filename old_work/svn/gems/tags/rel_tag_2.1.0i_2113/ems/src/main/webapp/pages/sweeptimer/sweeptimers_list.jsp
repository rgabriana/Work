...
var COLOR_FAULT = "red";
      ...
      $(document).ready(function() {
		...
		if(assignStatus)
		{
			if(assignStatus==1)
			{
				displayLabelMessage("Sweep Timer assignment failed. Please try after some time.",COLOR_FAULT);
			}else if(assignStatus==0)
			{
				displayLabelMessage("Sweep Timer has been assigned successfully.",COLOR_SUCCESS);
			}
