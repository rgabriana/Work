		...
		<c:forEach items="${usersList}" var="user">
			<tr>
				...
				<td align="right" style="padding-right:3px;">					
					...
					<div style="float:right;padding-right:10px;"><button id="btnAssignFacility" onclick="return assignFacility('${assignFacilityUserUrl}/${user.id}/assignFacilityUser.ems');">Assign Facility</button></div>
