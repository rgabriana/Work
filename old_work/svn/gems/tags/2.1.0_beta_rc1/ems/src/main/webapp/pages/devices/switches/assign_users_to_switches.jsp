...
function createUsersGrid(){
	jQuery("#asu-user-table").jqGrid({
		...
		autowidth: true,
		forceFit: true,
	   	colNames:['id', 'First Name', 'Last Name', 'Email', 'type'],
	   	colModel:[
  	   		{name:'id', index:'id', hidden: true},
	   		{name:'firstname', index:'firstname', sortable:false, width:"34%"},
	   		{name:'lastname', index:'lastname', sortable:false, width:"33%"},
	   		{name:'email', index:'email', sortable:false, width:"33%"},
