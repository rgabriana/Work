...
<script type="text/javascript">
    ...
    function loadTreeDlg() {
    	...
    	function applySwitchChanges() {
    		var yesorno = confirm("Are you sure you want to apply the changes to the fixtures and/or WDS?");
    		 if(yesorno == false)
    			 return;
    		 
    		$.ajax({
    			type: "POST",
    			url: "${applySwitchChangesURL}",
...
<input type=button onclick="applySwitchChanges();" value="Apply"/>
