...
/*    @RequestMapping("/home.ems")
    ...
    */
    ...
    public String getAuditLog(Model model) {
        ...
        SystemConfiguration auditlogfile = systemConfigurationManager.loadConfigByName("report.auditlogfile");
        String path = null;
        if (auditlogfile != null) {
            path = auditlogfile.getValue();
        }

        String log = readfile(path);
        model.addAttribute("auditlog",log);
