...
public class EventsAndFaultManager {
    ...
    public void addAlarm(Gateway gw, String desc, String eventType, String severity) {
    ...
    public void clearAlarm(Fixture fixture, String eventType) {
            
      eventsAndFaultDao.resolveFixtureAlarms(fixture.getId(), eventType);
            
    } //end of method clearAlarm

    public void addAlarm(Fixture fixture, String desc, String eventType, String severity) {
        if (eventType.equals(EventsAndFault.FIXTURE_PROFILE_GROUP_ASSOCIATION_CHANGED)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_MISMATCH)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_MISMATCH_USERACTION)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_PUSH_USERACTION)) {
    ...
    public void addEvent(Fixture fixture, String desc, String eventType, String severity) {
        if (eventType.equals(EventsAndFault.FIXTURE_PROFILE_GROUP_ASSOCIATION_CHANGED)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_MISMATCH)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_MISMATCH_USERACTION)
                || eventType.equals(EventsAndFault.FIXTURE_PROFILE_PUSH_USERACTION)) {
    ...
    // it does not check whether an event of the same type is outstanding
    public void addEvent(Gateway gateway, String desc, String eventType, String severity) {
