...
<spring:url	value="/services/org/templateManagement/delete" var="deleteTemplateUrl" scope="request" />
...
var deleteTemplateData = [];
	$(document).ready(function() {		
		...
		jQuery("#templateMgmtTable").jqGrid({
			...
			forceFit: true,
			hoverrows: false,
			colNames:["id", "templateId","Name", "Profile associated","Fixture associated", "Action"],
		   	colModel:[
...
<div id="template-list-topPanel" style="background:#fff">
		<div id="template-dialog-form">
			...
			<form id="addTemplateButton" name="addtemplate" method="post" action="${actionAddTemplateURL}" style="float: right;">
				<input type="button" id="addGatewayBtn" onClick="return addTemplateDialog('${actionAddTemplateURL}')" value="<spring:message code='profiletemplate.label.addtemplateBtn'/>" style="float: left; margin-right:5px" />
			</form>
