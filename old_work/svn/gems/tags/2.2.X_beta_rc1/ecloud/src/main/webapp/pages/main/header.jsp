...
<!-- 								<ul> -->
<%-- 									<spring:url value="/createCustomer.ems" var="custMan" />	 --%>
									
<%-- 									<li><a href="${custMan}" onclick="highLightTab(2);"><spring:message --%>
<%-- 												code="menu.customer.management" /> --%>
<!-- 										</a> -->
<!-- 									</li> -->
...
<!-- 								</ul> -->
									<ul>
										<spring:url value="/eminstance/listUnregEms.ems" var="unRegEmList" />
												<li><a href="${unRegEmList}" >Unregistered EMs</a></li>
									</ul>
						</li>
