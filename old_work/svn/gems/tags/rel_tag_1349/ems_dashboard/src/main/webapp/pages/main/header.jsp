	...
	<table id="tblcompcreated" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<td align="right">
				<div class="nav">
					<ul id="cssdropdown">
						<spring:url value="/dashboard/home.ems" var="facilities" />
						...
						<li class="headlink" style="width: 140px"><a id="2" href="#" class="link"> <spring:url
								...
								<ul>
									<spring:url value="/gems/list.ems" var="gemsList" />	
									
									<li><a href="${gemsList}" onclick="highLightTab(2);"><spring:message
												code="menu.gemssetup" />
										</a>
									</li>
		...
		<tr>
			...
			<td align="right"><ems:showAppVersion />&nbsp;<c:set var="now"
				...
				<fmt:formatDate pattern="yyyy-MM-dd HH:mm Z" value="${now}" /></td>
		</tr>
	</table>
</c:if>
