...
//  	  EventsAndFault.FIXTURE_IMG_UP_STR, EventsAndFault.MAJOR_SEV_STR);
    ...
    public String nodeRebooted(Fixture fixture, short currVer, short otherVer, byte appId, int imgUpgrStatus) {
      ...
      return updateUpgradeCompleteStatus(fixture, details, appId, currVer, otherVer, imgUpgrStatus);
  ...
  public String nodeRebooted(Fixture fixture, short currVer, short otherVer, byte appId,
    ...
    if(gwFixUpgThrMap.containsKey(gwId)) {
      return gwFixUpgThrMap.get(gwId).nodeRebooted(fixture, currVer, otherVer, appId, imgUpgrStatus);
    }
    return ServerConstants.IMG_UP_STATUS_NOT_PENDING;
