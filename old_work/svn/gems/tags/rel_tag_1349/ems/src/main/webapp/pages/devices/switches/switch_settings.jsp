...
$(document).ready(function() {
	...
	$( "#sws_slider_fixture" ).bind( "slide", function(event, ui) {
		updateSliderValueSpan(ui.value);
		setDimmerState(ui.value);
	});
	...
	<tr>
		...
		<td style="height: 45px;">
			<div class="sws-btn-wrapper">
				<!-- AUTO -->
				<div id="auto" class="sws-button" style="border-right: 1px solid #CCCCCC;" onclick="applySceneToSwitch('auto','auto');">
				...
				<c:forEach items='${scenes}' var='scene'>
					<c:if test="${scene.name == 'All On'}">
							<div id='fullon' class="sws-button" onclick="applySceneToSwitch('fullon','${scene.id}');">
					<div class="sws-btn-icon-wrapper">
						<div class="sws-status-icon icon-btn sws-status-off"></div>
					</div>
				...
				<c:forEach items='${scenes}' var='scene'>
					<c:if test="${scene.name == 'All Off'}">
						<div id='fulloff' class="sws-button" style="border-left: 1px solid #CCCCCC;" onclick="applySceneToSwitch('fulloff','${scene.id}');">
					<div class="sws-btn-icon-wrapper">
						<div class="sws-status-icon icon-btn sws-status-off"></div>
					</div>
