		...
		<form:form id="ldap-settings" method="post" action="${actionURL}"
			...
			<table cellspacing="10px">
				...
				<tr>
					...
					<td class="formValue"><form:input path="name" class="biginput" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.server.url" />:</td>
					<td class="formValue"><form:input path="server"
							class="biginput" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.server.port" />:</td>
					<td class="formValue"><form:input path="port" class="biginput" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.base.dns" />:</td>
					<td class="formValue"><form:textarea path="baseDns"
							class="biginput" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.user.attribute" />:</td>
					<td class="formValue"><form:input path="userAttribute"
							class="biginput" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="formValue"><form:checkbox path="allowAnonymous" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.anonymous.dn" />:</td>
					<td class="formValue"><form:input path="nonAnonymousDn"
							class="biginput" /></td>
				</tr>
				<tr>
					<td class="formPrompt"><spring:message
							code="ldap.auth.anonymous.password" />:</td>
					<td class="formValue"><form:password path="nonAnonymousPassword"
							class="biginput" /></td>
				</tr>
				<tr>
