...
public class UsersController {
    ...
    String createUser(Model model, @RequestParam("tenantId") Long tenantId) {
        ...
        userAuditLoggerUtil.log("Create user: " + user.getEmail() +"(" + user.getRole() +")", UserAuditActionType.User_Update.getName());
    ...
    String saveUser(User user, @RequestParam("tenantId") Long tenantId, @RequestParam("password") String password) {
        ...
        userAuditLoggerUtil.log("Update user: " + user.getEmail() +"(" + user.getRole() +":"+user.getId() +")", UserAuditActionType.User_Update.getName());
