									...
									<security:authorize access="hasAnyRole('Admin','FacilitiesAdmin')">
										<li class="headlink"><a id="2" href="#" class="link"> <spring:url
											...
											<ul>
												...
												<spring:url value="/settings/system_management.ems" var="systemManagement" />
												<li><a href="${systemManagement}" onclick="highLightTab(2);"><spring:message
...
<%-- 													<a href="${bulb}" onclick="highLightTab(3);"><spring:message code="menu.bulb" /></a></li> --%>
												<li><spring:url value="/reports/auditlog.ems" var="auditlog" />											
													<a href="${auditlog}" onclick="highLightTab(3);"><spring:message code="menu.auditlog" /></a></li>
											</ul>
										</li>
									</security:authorize>
