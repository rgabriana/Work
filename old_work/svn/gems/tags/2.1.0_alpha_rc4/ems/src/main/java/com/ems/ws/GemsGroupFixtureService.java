...
public class GemsGroupFixtureService {
    ...
    public Response applyGroupToFixtures(@PathParam("gid") Long gid, List<Fixture> fixtures) {
        ...
        for(Fixture fixture: fixtures) {
        	fixtNames.append(fixture.getFixtureName() + ",");
        }
        userAuditLoggerUtil.log("Apply group " + gemsGroupManager.loadGemsGroup(gid).getGroupName()
        		+ " to fixtures " + fixtNames, UserAuditActionType.Group_Fixture_Update.getName());
        return new Response();
    }
    ...
    public Response removeFixtureFromGroup(@PathParam("gid") Long gid, List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Remove group " + gemsGroupManager.loadGemsGroup(gid).getGroupName()
        		+ " from fixtures " + fixtNames, UserAuditActionType.Group_Fixture_Update.getName());
        return new Response();
    }
    ...
    public Response resetAllGroupsOnFixture(List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Reseting all groups for fixtures " + fixtNames, UserAuditActionType.Group_Fixture_Update.getName());
