...
public class FacilityTreeManager {
    ...
    public String getNodePath(String nodeType, Long nodeID) {
        ...
        if (nodeType.equalsIgnoreCase("CAMPUS")) {
            ...
            campus = buildingManager.getBuildingById(nodeID).getCampus().getName();
            building = buildingManager.getBuildingById(nodeID).getName();
            
        } else if (nodeType.equalsIgnoreCase("FLOOR")) {

            try {
                campus = floorManager.getFloorById(nodeID).getBuilding().getCampus().getName();
                building = floorManager.getFloorById(nodeID).getBuilding().getName();
            ...
            try {
                campus = areaManager.getAreaById(nodeID).getFloor().getBuilding().getCampus().getName();
                building = areaManager.getAreaById(nodeID).getFloor().getBuilding().getName(); 
        ...
        return company + (campus != "" ? " > " + campus : "")  + ( building != "" ? " > " + building : "")  + (floor != "" ? " > " + floor : "") + (area != "" ? " > " + area : "");
    }
}
