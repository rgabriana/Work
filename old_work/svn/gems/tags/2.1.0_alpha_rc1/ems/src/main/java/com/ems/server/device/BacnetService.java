...
public class BacnetService implements EmsShutdownObserver {
    ...
    public static final int BACNET_MSGTYPE_DISCOVER = 0x1;
    ...
    public void processBacnetPacket(byte[] bacnetPkt) {
        ...
        try {
            ...
            case BACNET_MSGTYPE_DISCOVER:
                ...
                fillBacnetHeader(responsePkt, (byte) BACNET_MSGTYPE_DISCOVER, result);
            ...
            case BACNET_MSGTYPE_SU_DATA_ID:
                ...
                for (int k = 0; k < noOfNodesReq; k++) {
                    long nodeId = ServerUtil.extractIntAsLongFromByteArray(bacnetPkt, fillPos);
                    addrPos += 4;
