...
<div class="settingDivTop">
	...
	<div class="settingDivOuter">
		<spring:url value="/profile/updateBasicConfiguration.ems" var="updateBasicConfig"/>
						...
						<div class="settingAccordionFormDiv">							
							<fieldset>
								...
								<div class="settingAccordionFormField">
									...
									<div class="settingAccordionFormInputField"><form:input   class='validate[required,custom[integer],min[0],max[25]] text-input' path="minLevelBeforeOff" size="3"/></div>
									<span><spring:message code='profile.advanced.general.4.2'/></span>
									<div class="settingAccordionFormInputField"><form:input   class='validate[required,custom[integer],min[0],max[600]] text-input' path="toOffLinger" size="3"/></div>
