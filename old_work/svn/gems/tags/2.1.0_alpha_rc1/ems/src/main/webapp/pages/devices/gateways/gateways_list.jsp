			...
			colNames:["id", "Name", "Channel", "Network ID", "Version", "Commissioned", "No. of Fixtures", "Upgrade Status", "Action"],
		   	colModel:[
				{name:'id', index:'id', hidden: true},
		   		...
		   		{name:'noOfSensors', index:'noOfSensors', sortable:false, width:"11%"},
...
// 		   	pager: '#gatewayPagingDiv',
		...
		<c:forEach items="${gateways}" var="gateway">
			...
			localData.noOfSensors = "${gateway.noOfSensors}";
				...
				success: function(data){
					if(data != null){
						if((1*data.msg) == 0){
							...
							alert("This Gateway has associated fixture(s) with it. It cannot be deleted");
						}
					}
				},
				dataType:"json",
