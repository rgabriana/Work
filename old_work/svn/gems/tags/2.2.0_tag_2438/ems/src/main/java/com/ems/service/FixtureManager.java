...
public class FixtureManager {
    ...
    public void updateAdvancedProfile(Fixture fixture) {
        ...
        Groups groups = groupDao.getGroupById(fixture.getGroupId());
        ProfileHandler profileHandler = groups.getProfileHandler();// fixture.getProfileHandler();
        if (currentProfile.equals(ServerConstants.CUSTOM_PROFILE)) {
        	
        	// we have create first Group and Profile handler
        	// If it is already present then just update group id.
