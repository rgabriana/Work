...
public class SweepTimerController {
	...
	public String getSweepTimerList(Model model,@RequestParam(value = "deleteStatus", required = false) Integer deleteStatus,
		...
		if(assignStatus!=null)
			model.addAttribute("assignStatus",assignStatus);
