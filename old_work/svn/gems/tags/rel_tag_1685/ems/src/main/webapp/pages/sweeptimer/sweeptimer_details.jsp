	...
	function validateTimerIntervals()
	{
		...
		for (var count = 0; count < 7; count++) {
			...
			*/
			...
			var overrideTimer = document.getElementById(count+"_overrideTimer");
			if(isNaN(overrideTimer.value))
			{
				$("#domainMsg").text('Please enter valid numbers only');
			...
			<c:forEach items="${sweepTimer.sweepTimerDetails}" var="sweepTimerDetail" varStatus="idx">
				...
				<td align="center">
					<div class="innerContainerInputFieldValue">
							...
							name="${sweepTimerDetail.overrideTimer}" style="text-align: right;"/>
					</div>
				</td>
				</tr>
			</c:forEach>
