...
var flash_fx_ec = function(nodetype, nodeid) {
	...
	*/
	...
	if ($.browser.msie) {
		...
		EC_data +=  "<param name='src' value='${fixtureEnergySummaryUrl}'/>";
		...
		EC_data +=  "<embed id='fx-energy-summary' name='fx-energy-summary' src='${fixtureEnergySummaryUrl}' pluginspage='http://www.adobe.com/go/getflashplayer'";
