...
<style>
		...
		#gateway-dialog-form select, #gateway-dialog-form input.text { margin-bottom:7px; width:95%; padding: 2px;}
		#gateway-dialog-form fieldset { padding:0; border:0; margin-top:2px; }
		#gateway-dialog-form fieldset.column { padding:0; border:0; margin-top:2px; float:left; width:32%; }
...
<!--<div id="gateway_message" class="server_message" style="background-color: #EEEEEE; border: thin solid #AAAAAA; left: 494px; margin: auto; position: absolute; top: 200px; padding:2px;">
	...
	<fieldset class="column">
		...
		<form:input type="text" name="boundFixr" id="boundFixr" value="" class="text readonly" path="noOfSensors"/>
	...
	<fieldset class="column">
		...
		<form:input class="text" id="wirelessNetworkId" name="wirelessNetworkId" size="40" path="wirelessNetworkId"/>
