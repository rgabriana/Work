...
<script type="text/javascript">
	...
	var loadFP = function() {
		try{
			...
			getFloorPlanObj("floorplan").changeLevel(treenodetype, treenodeid, 'REPORT','BULB');
		}
		catch (ex){
	...
	var flash_fp = function(nodetype, nodeid) {		
		...
		if ($.browser.msie) {
			...
			FP_data +=  " flashvars='orgType=" + nodetype + "&orgId=" + nodeid + "&mode=REPORT&modeid=BULB'/>";
			FP_data +=  "</object>";
		} else {
			FP_data = "<embed id='floorplan' name='floorplan' src='${plotchartmodule}' pluginspage='http://www.adobe.com/go/getflashplayer'";
			FP_data +=  " height='100%'";
...
<div class="outermostdiv" style="margin-left:0px;">
	<div class="outerContainer">
		<span><spring:message code="menu.bulb" /></span>
	</div>
