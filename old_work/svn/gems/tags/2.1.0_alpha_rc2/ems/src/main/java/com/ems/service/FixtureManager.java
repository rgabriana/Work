...
public class FixtureManager {
    ...
    public int commissionFixtures(long gatewayId, long floorId, int type) {
        ...
        System.out.println("Done with bulk commissionFixtures API");
        return ret;
    }
    ...
    public void updateBootInfo(Fixture fixture) {
        fixtureDao.updateBootInfo(fixture);
    }
