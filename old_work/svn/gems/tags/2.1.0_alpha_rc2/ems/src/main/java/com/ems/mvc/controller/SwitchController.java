...
public class SwitchController {
    ...
    String createSwitch(Model model, @CookieValue(FacilityCookieHandler.selectedFacilityCookie) String cookie) {
	...
	public Switch saveSwitch(Switch switchObj) {
		userAuditLoggerUtil.log("Create Switch: " + switchObj.getName());
