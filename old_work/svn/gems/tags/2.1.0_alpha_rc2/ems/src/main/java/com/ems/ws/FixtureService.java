...
public class FixtureService {
    ...
    public Response dimFixture(@PathParam("mode") String mode, @PathParam("percentage") String percentage,
        ...
        userAuditLoggerUtil.log("Dimmed Fixtures, Dim %: " + percentage);
        return new Response();
    }
    ...
    public Response applyModeToFixtures(@PathParam("modetype") String modetype, List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Applied Mode to  Fixture id :" + fixtureList + " Mode: " + modetype);
        return oStatus;
    }
    ...
    public Response getFixtureRealTimeStats(List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Real Time for Fixture");
        return new Response();
    }
    ...
    public Response updateFixturePosition(List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Update Fixture Position");
        return new Response();
    }
    ...
    public Response startNetworkDiscovery(@PathParam("floorId") Long floorId, @PathParam("gatewayId") Long gatewayId) {
        ...
        userAuditLoggerUtil.log("Start Network Discovery");
        return oStatus;
    }
    ...
    public Response commissionFixture(@PathParam("fixtureId") Long fixtureId, @PathParam("type") int type) {
        ...
        response.setStatus(status);
        userAuditLoggerUtil.log("Commission Fixture: " + fixtureId);
        return response;
    }
    ...
    public Response exitCommission(@PathParam("gatewayId") Long gatewayId) {
        ...
        response.setStatus(status);
        userAuditLoggerUtil.log("Exit Comission");
        return response;
    }
    ...
    public Response updateDuringCommission(Fixture fixture) {
        ...
        userAuditLoggerUtil.log("Update during Comission for Fixture : " + fixture.getId());
    ...
    public Response changeProfile(@PathParam("fixtureId") long fixtureId, @PathParam("groupId") long groupId,
        ...
        userAuditLoggerUtil.log("Change Profile for Fixture : " + fixtureId);
        return new Response();
    }
    ...
    public Response deCommissionFixtures(List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Decommission Fixture");
        return oResponse;
    }
    ...
    public Response deCommissionFixturesWithoutAck(List<Fixture> fixtures) {
        ...
        userAuditLoggerUtil.log("Decommission Fixture without Ack");
        return oResponse;
    }
    ...
    public Response SwitchRunningImage(Fixture fixture) {
        ...
        userAuditLoggerUtil.log("Switch Running Image");
        return oResponse;
    }
