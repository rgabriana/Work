					...
					echo "step6;"
						...
						then
								...
								then
                                        ...
                                        cp /home/enlighted/upgradeSQL.sql /var/lib/tomcat6/Enlighted/tempExtract/${DEBIAN_REV_NUMBER}_upgradeSQL.sql
                                        ...
                                        if [ `psql -q -U postgres ems -h localhost  -t -c "select 1 from system_configuration where name = 'cloud.communicate.type' and value = '2'"` -eq 1 ] 
                                        then
                                            psql -U $DBUSER -h $DBHOST $DB < /home/enlighted/sppa.sql >> $LOGS_DB 2>> $LOGS_DB
                                        fi
