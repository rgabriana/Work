...
public class TestSuite {
    ...
    public void executeTestSuite() throws Throwable 
    {
        ...
        while (rowIter1.hasNext()) 
        {
            ...
            if (testCaseName == null || testCaseName.equalsIgnoreCase(Keyword.FINISH)) 
            {
                break;
            }
        ...
        //
        CellStyle style = testResultWb.createCellStyle();
        style = testResultWb.createCellStyle();
        style.setFillForegroundColor(IndexedColors.GREEN.getIndex());
        passTestLabelCell = summaryPassTestCasesRow.createCell((short) 2);
        passTestLabelCell.setCellStyle(style);
        //
        ...
        failTestLabelCell = summaryFailsTestCasesRow.createCell((short) 2);
        failTestLabelCell.setCellStyle(style);
        //
        ...
        headerTestCasesDetail.createCell(0).setCellValue("SR. No.");
        ...
        String resultWorkbookName = format.format(new Date()) + "_"+ this.context.getBrowserType() + "_Result_" + file.getName();
    ...
    public static Iterator executeTestSuiteDataFile() throws Throwable 
    {
        FileInputStream suiteRunner = new FileInputStream(suiteName);
        XSSFWorkbook testCaseWB = new XSSFWorkbook(suiteRunner);
        XSSFSheet suiteSheet = testCaseWB.getSheet("Datafile");
        Iterator rowIter2 = ((Sheet) suiteSheet).rowIterator();
        return(rowIter2);
     }
}
