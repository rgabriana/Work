...
<script type="text/javascript"> 
	function resetOrg() {
		...
		<c:if test="${page == 'floor'}">
			$('#useOrgLocation').val('${org.useOrgLocation}');
			if('${org.useOrgLocation}' == 'true'){
				...
				$('#latitude').val('${org.latitude}');
				$('#longitude').val('${org.longitude}');
			}
		</c:if>
...
<div id="editOrg" style="padding:10px 0px 0px 0px; height:100% !important;background:#fff">
				...
				<c:if test="${page == 'floor'}">
					<div class="field">
						...
						<div style="float:left">
								<form:select name="useOrgLocation" path="useOrgLocation" onchange="toggleLocationData(this);" id="useOrgLocation">
					...
					<div class="field">
						...
						<div style="float:left"><form:input id="latitude" path="latitude" name="latitude" /></div>
					</div>
					<div class="field">
						<div class="formPrompt"><span><spring:message code="companySetup.label.longitude"/></span></div>
						<div style="float:left"><form:input id="longitude" path="longitude" name="longitude" /></div>
					</div>
				</c:if>
	...
	<c:if test="${page == 'floor'}">
		<script type="text/javascript">
			...
			function toggleLocationData(obj){
				if($(obj).val() == 'true'){
					$('#latitude').val('${companyLatitude}');
					$('#longitude').val('${companyLongitude}');
					$('#latitude').attr('disabled', 'disabled');
