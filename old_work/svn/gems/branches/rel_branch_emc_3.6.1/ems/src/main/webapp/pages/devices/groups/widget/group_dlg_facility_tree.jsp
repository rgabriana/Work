...
<script type="text/javascript">
    ...
    function loadTreeDlg() {
    	...
    	function isFormValid(){
    		...
    		var grpNameregExpStr = /^[A-Za-z0-9\_\.\s\@\-\#]+$/i;
    		
    		if($.trim($("#groupName").val())==""){
    			setMessage("Please enter Group name", "red");
    			return false;
    		}
    		
    		if(grpName!=""){
    			if(grpNameregExpStr.test(grpName) == false) {
    				setMessage("Group Name is invalid", "red");
    			   	return false;   	
    			}
    		}
    		return true;
...
<div style="padding-top: 5px;padding-left: 10px; padding-bottom: 5px; border-style:solid;border-width:2px;" class="appbg" style="height:14%">
<input type=button onclick="applyGroupChanges();" value="Apply" style="height: 24px;"/>
<div id="motionGroupUpdateProgressDiv" style="font-weight: bold; padding: 0px 5px; display: inline;"></div>
	...
	<label style="font-weight: bold;padding-left: 1px;">Fixture version:</label>
	<label>${group.fixtureVersion}+</label>
</div>
</div>
<div id="accordionfacilitydlg" class="left-menu" style="height:84%">
