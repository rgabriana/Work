...
function ntpClicked(){
	if($("#ntpFlag").is(":checked")) {
		...
		if(ntpServers != undefined && ntpServers != null && ntpServers != ''){
			...
			$('#ntpServersId').val('0.us.pool.ntp.org,1.us.pool.ntp.org,2.us.pool.ntp.org,3.us.pool.ntp.org');
		}
...
<div class="innerContainer">
	<div class="formContainer">
		...
		<div class="field">
			...
			<div class="formValue"><input id="ntpServersId" name="ntpServers" type="text" value="0.us.pool.ntp.org,1.us.pool.ntp.org,2.us.pool.ntp.org,3.us.pool.ntp.org" /></div>
		</div>
		<div class="field">
