...
public class ServerConstants {
    ...
    public static final int CMD_FILE_XFER=0xb7; //gateway image upgrade missing packet
    public static final int UPGRADE_ACK=0xad; //gateway upgrade ack
    ...
    public static final int SET_COLOR_TEMP = 0xd7;
    ...
    public static final int CMD_ASTRO_CLOCK_TIME = 0xe1;
    ...
    // Should the BLE mode set message be different?
    public static final int BLE_MODE_SET = 0xfb;
    /* found that this message type is not used on the sensor. so commenting it out
    ...
    */
    ...
    public static final int ISP_BLE_APP_INIT_OPCODE = 0x39;
    ...
    // dali research / wiring test
    public static final int CMD_REINIT_WIRING = 0x43;
    ...
    public static final int CURR_PL_STATE_GOTO_MANUAL_NORMAL_HIGH = 17;
    ...
    public static final int EVENT_BLE = 12;
    public static final int EVENT_BLE_RAW = 14;
    ...
    public static final short GATEWAY_STATS_MSG = 0x8;
    public static final short GATEWAY_REBOOT_CMD = 0xa;
    public static final short GATEWAY_SYSTEM_REBOOT_CMD = 0xb;
    public static final short GATEWAY_FILE_XFER_INIT = 0xb6;
    public static final short GATEWAY_FILE_XFER = 0xb7;
    ...
    public static final short GATEWAY_FILE_XFER_ACK = 0xb8;
    public static final short GATEWAY_SECURITY_CMD = 0xaf;
    public static final short UEM_FORWARD_CMD = 0xb0;
    public static final short GATEWAY_SHORT_PM_DATA = 0xd7;
    ...
    public static final String SET_PROFILE_STR = "Scheduled Profile";
    ...
    public static final int CFG_TYPE_INFO = 8;
    ...
    //kafka networks
    public static final String KAFKA_GW_NETWORK = "kafkaGwNetwork";
    public static final String KAFKA_BLE_NETWORK = "kafkaBleNetwork";
    public static final String KAFKA_BLE_TOPIC = "em";
