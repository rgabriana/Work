...
import com.ems.http.MotionSimHandler;
...
public class Simulator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            startExtCommunictionServerListener();
        }
    ...
    private static void startExtCommunictionServerListener() {
        ...
        context.addServlet(new ServletHolder(new MotionSimHandler()),"/motion");
        server.setHandler(context);
        ...
        try {
            ...
            System.out.println("Unable to start http listener for external communication");
        }
    }
