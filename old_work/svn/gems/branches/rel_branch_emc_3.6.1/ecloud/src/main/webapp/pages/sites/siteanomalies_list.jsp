...
function startSiteAnomolies(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#siteanamoliesTable").jqGrid({
			...
			colNames: ["id", "Geo Location", "Report Date","Start Date", "End Date","Issue","Details"],
		       ...
		       { name: "reportDate", index: 'reportDate',formatter: siteanomalieslistdateformatter, sortable:true,width:'6%'},
		       { name: "startDate", index: 'startDate',formatter: siteanomalieslistdateformatter, sortable:true,width:'6%'},
		       { name: "endDate", index: 'endDate',formatter:siteanomalieslistdateformatter, sortable:true,width:'6%'},
...
function siteanomalieslistdateformatter(cellvalue, options, rowObject)
{
