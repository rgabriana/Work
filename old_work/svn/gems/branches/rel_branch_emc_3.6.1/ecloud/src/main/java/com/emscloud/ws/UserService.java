...
public class UserService {
    ...
    public Response deleteUser(@PathParam("id") Long id) {
		...
		if(user != null && RoleType.Admin.getName().equals(user.getRoleType())) {
			cloudAuditLoggerUtil.log("Deleting of Admin user not allowed", CloudAuditActionType.User_Delete.getName());
