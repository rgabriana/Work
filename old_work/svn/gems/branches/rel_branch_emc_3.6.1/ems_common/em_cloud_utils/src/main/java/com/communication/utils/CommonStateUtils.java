...
public class CommonStateUtils {
	...
	// Table name 
		...
		public static String plugloadEnergyTableName = "plugload_energy_consumption" ;
		public static String plugloadEnergyHourlyTableName = "plugload_energy_consumption_hourly" ;
		public static String plugloadEnergyDailyTableName = "plugload_energy_consumption_daily" ;
		...
		public static ArrayList<String> tableNameList = new ArrayList<String>() {{ 
				...
				add(plugloadEnergyTableName);
				add(plugloadEnergyHourlyTableName);
				add(plugloadEnergyDailyTableName);
		...
		public static String getStateSartAccordingToTableName(String tableName2, Boolean remigration)
		{
			if(remigration != null && remigration) {
				...
				} else if(tableName2.equalsIgnoreCase(plugloadEnergyTableName))
				{
					return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_START.getName() ;
				}else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
				{
					return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START.getName();
				} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
				{
					return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START.getName() ;
				...
				{
					return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_START.getName() ;
				}else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
				{
					return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START.getName();
				} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
				{
					return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START.getName() ;
				} else if(tableName2.equalsIgnoreCase(motionBitTableName))
				{
	...
	public static String getStateSuccessAccordingToTableName(String tableName2, Boolean remigration)
	{
		if(remigration != null && remigration) {
			...
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS.getName() ;
			}else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS.getName() ;
			} else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
			...
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS.getName() ;
			}else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS.getName() ;
			} else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
	...
	public static String getStateFailAccordingToTableName(String tableName2, Boolean remigration)
	{
		if(remigration != null && remigration) {
			...
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_FAIL.getName() ;
			}else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL.getName() ;
			} else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
			...
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_FAIL.getName() ;
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL.getName() ;
			} else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
	...
	public static String getStateInProgressAccordingToTableName(String tableName2, Boolean remigration)
	{
		if(remigration != null && remigration) {
			...
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
			} else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
			...
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyHourlyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName();
			} else if(tableName2.equalsIgnoreCase(plugloadEnergyDailyTableName))
			{
				return DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
			}  else if(tableName2.equalsIgnoreCase(motionBitTableName))
			{
	...
	public static String getFailState(DatabaseState databaseState) {
		...
		case ENERGY_CONSUMPTION_SUCCESS:
			...
			break;
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
			state =  DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL.getName() ;
			break;
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
			state =  DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL.getName() ;
			break;
		case PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
			state =  DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_FAIL.getName() ;
			break;
		...
		case RESTRICTED_ENERGY_CONSUMPTION_SUCCESS:
			...
			break;
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
			state =  DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL.getName() ;
			break;
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
			state =  DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL.getName() ;
			break;
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
			state =  DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_FAIL.getName() ;
			break;
	...
	public static String getTableNameAccordingToState(DatabaseState databaseState) {
		...
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_FAIL:
			tableName = plugloadEnergyDailyTableName ;
			break;
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_FAIL:
			tableName =  plugloadEnergyHourlyTableName ;
			break;
		case PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_START:
		case PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
		case PLUGLOAD_ENERGY_CONSUMPTION_FAIL:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_START:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
		case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_FAIL:
			tableName =  plugloadEnergyTableName ;
			break ;
		case MOTION_BIT_IN_PROGRESS:
		case MOTION_BIT_START:
		case MOTION_BIT_SUCCESS:
