...
<c:if test="${customerSetup != 'true'}">
	<!-- Following table to be shown when customer details are available -->
	<script type="text/javascript">
	...
	<table id="tblcompcreated" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<td><span id="dashboardTitle" class="dashboardTitle"><spring:message
						code="header.dashboardTitle" /></td>

			<td align="right">
				<div class="nav">
					<ul id="cssdropdown">
						<spring:url value="/home.ems" var="facilities" />
						<li class="headlink" style="width: 80px"><a id="1"
							href="${facilities}" class="link" onclick="highLightTab(1);">
								<spring:url value="/themes/default/images/home.png"
									var="imgfacilities" />
								<div class='imgicon'>
						...
						<li class="headlink" style="width: 140px"><a id="2" href="#"
							class="link"> <spring:url
							...
							<ul>
								<spring:url value="/createCustomer.ems" var="createCustomer" />

								<li><a href="${createCustomer}" onclick="highLightTab(2);"><spring:message
											code="menu.customer.management" /> </a></li>
								<spring:url value="/generateKey.ems" var="generateKey" />

								<li><a href="${generateKey}" onclick="highLightTab(2);"><spring:message
											code="menu.create.key" /> </a></li>

							</ul></li>
						<li class="headlink" style="width: 90px"><spring:url
								value="/themes/default/images/report.png" var="imgreport" /> <a
							id="3" href="#">
								<div class='imgicon'>
									<img src="${imgreport}" />
								</div>
