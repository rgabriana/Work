...
# BEGIN COMMENT1: This block of code will not work\
# due to permission limitations. Unless the cron job is\
# executed with admin priveleges. moving this action\
# of the script to a separate script in the debian.
# Rolando Gabriana 
