...
echo  "Copying ems_communicator.jar to debian_communicator$OPT_ENLIGHTED/communicator directory!!"
cp ems_communicator/target/ems_communicator.jar debian_communicator$OPT_ENLIGHTED/communicator
