...
public class InitializeSecureConnection {
	static final Logger logger = Logger.getLogger(InitializeSecureConnection.class.getName());
	
	private static Boolean isSppaCertificateInitialized = false ;
	// Set up the certificate
	private final static String STR_CERTS_PATH = CommunicatorConstant.ENL_APP_HOME+"/Enlighted/certs/";
