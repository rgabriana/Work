...
public class GemsGroupFixtureService {
	...
	public String applyGroupToFixtures(@PathParam("gid") Long gid,
			List<Fixture> fixtures) {
		String status = gemsGroupManager.saveGemsGroupFixtures(gid, fixtures);
		...
		try {
			for (Fixture fixture : fixtures) {
			    if(FixtureCache.getInstance().getDevice(fixture.getId()) != null){
			        fixtNames.append(FixtureCache.getInstance()
	...
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Produces({ MediaType.TEXT_PLAIN})
	public String asssignFixturesToGroup(@PathParam("gid") Long gid,
			List<Fixture> fixtures) {
		String status = gemsGroupManager.asssignFixturesToGroup(gid, fixtures);
		StringBuffer fixtNames = new StringBuffer("");
	...
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Produces({ MediaType.TEXT_PLAIN })
	public String resetAllGroupsOnFixture(List<Fixture> fixtures) {
		String status = gemsGroupManager.resetAllGroupOnFixtures(fixtures);
