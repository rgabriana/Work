...
public class ProfileManager {
    ...
    public ProfileHandler createCannedProfile(String strParamPrefix, int profileGroupId,HashMap<String,String> mMap, boolean bSave) {
        HashMap<String, String> scMap = mMap;
        
        //sParamPrefix = profilename
    ...
    {
    	HashMap<String, String> scMap = systemConfigurationManager.loadAllConfigMap();
    	CannedProfileManager.setCannedProfiles(scMap);
    }
