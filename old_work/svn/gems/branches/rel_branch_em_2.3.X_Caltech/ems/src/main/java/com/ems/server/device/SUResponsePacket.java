  ...
  public void processResponse() {
    ...
    switch (msgType){      	
    	case ServerConstants.REPT_PM_DATA_MSG_TYPE:	  	  
        	...
        	if (gwInfo.getOperationalMode() == GatewayInfo.GW_NORMAL_MODE) {
        		if (fixture.getState().equals(ServerConstants.FIXTURE_STATE_DELETED_STR)) {
        			...
        			eventMgr.addEvent(fixture, sMsg, EventsAndFault.WIRELESS_PARAMS_MISMATCH_STR);
        ...
        case ServerConstants.SU_CMD_HEART_BEAAT_MSG_TYPE:
        	EmService.getInstance().heartbeat(fixture.getMacAddress(), pkt, PerfSO.getInstance().getTemperatureOffsetSU2());
      		break;
      	default:
