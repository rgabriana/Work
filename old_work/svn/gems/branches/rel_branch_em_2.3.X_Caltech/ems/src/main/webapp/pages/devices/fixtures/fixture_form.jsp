			...
			<div class="upperdiv divmiddle">
				<fieldset class="column33">
					...
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="ballastType" name="ballastType"
								path="ballast.id" class="text"
								onchange="javascript: setNoOfLamps();">
								<form:options items="${ballasts}" itemValue="id"
									itemLabel="ballastName" />
							</form:select>
						</div>
					</div>
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="lampType" name="lampType" path="bulb.id"
								class="text">
								<form:options items="${lamps}" itemValue="id"
									itemLabel="bulbName" />
							</form:select>
						</div>
					</div>
				...
				<fieldset class="column33 longlabel">
					...
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="noOfFixtures" name="noOfFixtures"
								path="noOfFixtures" class="text">
					...
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="noOfBulbs" name="noOfBulbs" path="noOfBulbs"
								class="text">
								<form:option value="1">1</form:option>
								<form:option value="2">2</form:option>
								<form:option value="3">3</form:option>
...
<!-- 					</div> -->
				...
				<fieldset class="column33">
					...
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="voltage" name="voltage" path="voltage"
								class="text">
