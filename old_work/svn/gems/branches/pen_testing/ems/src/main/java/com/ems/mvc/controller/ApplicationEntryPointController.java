...
public class ApplicationEntryPointController {
	...
	public String deleteAreaRefresh(@RequestParam("cid") Long cid,
			@RequestParam("bid") Long bid, @RequestParam("fid") Long fid)
			throws EmsValidationException {
		// Map<String, Object> nameValMap = new HashMap<String, Object>();
		// nameValMap.put("cid", cid);
		// nameValMap.put("bid", bid);
		// nameValMap.put("fid", fid);
		// CommonUtils.isParamValueAllowedAndThrowException(messageSource, systemConfigurationManager, nameValMap);
        return "redirect:createArea.ems?default_selected_campus="
	...
	public String deleteFloorRefresh(@RequestParam("cid") Long cid,
			@RequestParam("bid") Long bid) throws EmsValidationException {
		// Map<String, Object> nameValMap = new HashMap<String, Object>();
		// nameValMap.put("cid", cid);
		// nameValMap.put("bid", bid);
		// CommonUtils.isParamValueAllowedAndThrowException(messageSource, systemConfigurationManager, nameValMap);
	...
	public String deleteBuildingRefresh(@RequestParam("cid") Long cid)
			throws EmsValidationException {
		// CommonUtils.isParamValueAllowedAndThrowException(messageSource, systemConfigurationManager, "cid", cid);
