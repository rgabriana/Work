...
sudo tar -cvpzf $backupfile  /opt/enLighted/communicator /etc/network/interfaces /etc/timezone /etc/default/ntpdate /etc/default/dhcp3-server /etc/iptables.rules /etc/sudoers /var/lib/tomcat6/Enlighted --exclude=var/lib/tomcat6/Enlighted/cloudServerInfo.xml --exclude=var/lib/tomcat6/Enlighted/emsmode --exclude=var/lib/tomcat6/Enlighted/ems_log4j --exclude=var/lib/tomcat6/Enlighted/UpgradeImages --exclude=var/lib/tomcat6/Enlighted/bacnet/bacnetLighting --exclude=var/lib/tomcat6/Enlighted/tempExtract --exclude=var/lib/tomcat6/Enlighted/bkRestoreFolderTemp --exclude=opt/enLighted/DB/DBBK --exclude=var/lib/tomcat6/Enlighted/adminlogs  --exclude=opt/enLighted/communicator/syncdata --exclude=opt/enLighted/communicator/last_communication_time --exclude=**/*.sh --exclude=**/*.log --exclude=**/*.jar --exclude=**/*.deb  --exclude=**/*.pl --exclude=**/*.bin
