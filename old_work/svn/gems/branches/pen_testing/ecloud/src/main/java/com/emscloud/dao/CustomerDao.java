...
public class CustomerDao {
	...
	public CustomerList loadCustomerList(String orderway, int offset, int limit,List<Long> cList) {
		...
		// case Admin user - set customer count equal to projected value i.e. total customers in db 
		...
		}else{  // case Non-Admin user - set customer count equal to cList.size()
			customerList.setTotal(cList.size());			
		}
