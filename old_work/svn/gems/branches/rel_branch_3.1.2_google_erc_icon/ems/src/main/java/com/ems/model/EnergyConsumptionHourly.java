 ...
 * 
 */
public class EnergyConsumptionHourly implements Serializable {
    ...
    public EnergyConsumptionHourly() {
    }

    public EnergyConsumptionHourly(Long id, BigDecimal powerUsed, Date captureAt) {
        this.id = id;
        this.powerUsed = powerUsed;
        this.captureAt = captureAt;
    }

    public EnergyConsumptionHourly(Long id, String name, BigDecimal powerUsed) {
        this.id = id;
        this.powerUsed = powerUsed;
        this.name = name;
    }
    ...
    /**
     * @return the lightOn
     * @hibernate.property column="light_on"
     */
