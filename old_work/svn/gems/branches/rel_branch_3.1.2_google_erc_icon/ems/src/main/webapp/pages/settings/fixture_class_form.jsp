...
<spring:url value="/services/org/fixtureclassservice/getfixtureCount/" var="checkForFixtureCountUrl" scope="request" />
...
function checkForFixtureCount(){
	
	$.ajax({
		type: 'POST',
		url: "${checkForFixtureCountUrl}"+"${fixtureClass.id}"+"?ts="+new Date().getTime(),
		data: "",
