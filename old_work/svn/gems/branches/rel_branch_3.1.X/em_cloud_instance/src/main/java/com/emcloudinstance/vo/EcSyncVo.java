...
public class EcSyncVo  implements Comparable{
	...
	public int compareTo(Object o) {
		EcSyncVo e = (EcSyncVo) o;
		return (e.getZbUpdate().booleanValue() == this.zbUpdate.booleanValue() ? 0
				: (this.zbUpdate.booleanValue() ? 1 : -1));
	}
