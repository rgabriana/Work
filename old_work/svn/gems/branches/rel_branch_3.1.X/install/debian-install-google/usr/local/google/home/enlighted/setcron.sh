...
then
    echo "#" > /usr/local/google/home/enlighted/Desktop/root
    crontab -u root /usr/local/google/home/enlighted/Desktop/root
    rm -f /usr/local/google/home/enlighted/Desktop/root
...
then
    ...
    echo "*/30 * * * * /usr/local/google/home/enlighted/scripts/ems_heartbeat_tracker.sh" >> /var/spool/cron/crontabs/root
...
then
    ...
    echo "*/15 * * * * /usr/local/google/home/enlighted/scripts/ems_memory_tracker.sh" >> /var/spool/cron/crontabs/root
...
then
    ...
    echo "*/15 * * * * /usr/local/google/home/enlighted/scripts/ems_custom_logrotate.sh" >> /var/spool/cron/crontabs/root
