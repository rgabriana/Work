...
function ShowCommissionedFixtureToHopperFinalMessage(){
	...
	if(COMMISSION_FIXTURE_HOPPER_FAILURE_NUMBER == 0 && currentCommissionedFixtureToHopperCompleted == TOTAL_COMMISSIONED_FIXTURE_HOPPER_NUMBER){
		displayPlacedFxCommissionMessage("All the Commissioned Fixture(s) are Sucessfully Made as Hoppers. Total No of Fixtures Which are Made as Hoppers: "+COMMISSION_FIXTURE_HOPPER_SUCCESS_NUMBER, COLOR_SUCCESS);
		startGateWaytoDefaultMode();
	}
}
...
function ShowAllFixtureToHopperFinalMessage(){
	...
	if (SELECTED_COMMISSION_FIXTURES_TO_HOPPER.length > 0 && SELECTED_PLACED_FIXTURES_TO_HOPPER.length == 0){
		...
		if(COMMISSION_FIXTURE_HOPPER_FAILURE_NUMBER == 0 && currentCommissionedFixtureToHopperCompleted == TOTAL_COMMISSIONED_FIXTURE_HOPPER_NUMBER){
			displayPlacedFxCommissionMessage("All the Commissioned Fixture(s) are Sucessfully made as Hoppers. Total No of Fixtures made as Hoppers: "+COMMISSION_FIXTURE_HOPPER_SUCCESS_NUMBER, COLOR_SUCCESS);
		}
	}
