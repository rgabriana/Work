...
<spring:url value="/devices/hvac/manage.ems" var="hvacList" />
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		else if(innertabselected == 'hvac') { $("#hvac,#innerdevicecenter").click(); }
		else manageGateways();		
	});	
</script>
...
<script type="text/javascript">
	...
	function manageHVAC() {
		$.cookie('innertabselected', 'hvac',  {path: '/' });
		var ifr;
		ifr = document.getElementById("hvacFrame");
		ifr.contentWindow.document.body.innerHTML = "&nbsp;<spring:message code='action.loading'/>";
		ifr.src = "${hvacList}";
		return false;
	}
...
<div id="innerdevicecenter" class="ui-layout-center pnl_rht_inner">
	<ul
		...
		<li><a id="wds" href="#tab_wds"
			onclick="manageWds();"><span>EWSs</span> </a>
		</li>
		<li><a id="others" href="#tab_others"
			onclick="manageOthers();"><span>Others</span> </a>
		</li>
		<li><a id="hvac" href="#tab_hvac"
			onclick="manageHVAC();"><span>HVAC</span> </a>
		</li>
	</ul>
	<div class="ui-layout-content ui-widget-content ui-corner-bottom"
		...
		<div id="tab_hvac" class="pnl_rht">
			<iframe frameborder="0" id="hvacFrame"
				style="width: 100%; height: 100%;"></iframe>
				<script type="text/javascript">		
				$(function() {
					$(window).resize(function() {
						$("#hvacFrame").css("height", $(window).height() - 40);
					});
				});
				$("#hvacFrame").css("height", $(window).height() - 40);
				</script>
