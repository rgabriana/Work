package com.enlightedinc.components
{
	public class Constants
	{
		...
		public static const NO_FIXTURE_SELECTED_ERROR:String = "Please select fixtures for the operation to take place";
		...
		public static const DEFINE_GROUP_BEHAVIOUR:String = "Define Group Behavior";
		public static const DEFINE_SWITCH_BEHAVIOUR:String = "Define Switch Behavior";
		...
		public static const CREATE_HVAC_DEVICE:String = "Create HVAC Device";
		...
		public static const HVAC_RENDERER:String = "HvacRenderer";
		...
		public static const FIXTURE_TAB:String = "Fixture";
		
		public static const SCENE_TAB:String = "Scene";
		
		public static const WDS_TAB:String = "EWS";
		...
		public static const CALIBRATE_FIXTURES:String = "Calibrate Fixtures";
