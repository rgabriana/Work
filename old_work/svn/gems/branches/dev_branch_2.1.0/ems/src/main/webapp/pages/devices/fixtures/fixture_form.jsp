...
// 	$("#updateButton").button();
	...
	function loadFormValues(){
		...
		$( "#slider_fixture" ).bind( "slide", function(event, ui) {
			updateSliderValueSpan(ui.value);
			setDimmerState(ui.value);
		});
	...
	function loadAllProfiles(){
		...
		if(FX_CURRENT_PROFILE_BEFORE_UPDATE == "Custom"){
			//alert("if Custom ");
			var modifiedCurrentProfile = document.getElementById("currentProfile");
			modifiedCurrentProfile.add(new Option("Custom"), null);
					...
					<div class="fieldWrapper">
						...
						<div class="fieldValue">
							<form:select id="currentProfile" name="currentProfile"
								path="currentProfile" class="text">
								<form:options items="${groups}" itemValue="name"
									itemLabel="name" />
							</form:select>
						</div>
					</div>
