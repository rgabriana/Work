...
public class EnergyConsumptionService {
    ...
    /**
     * Returns the meter data savings dashboard record for one hour
     * CAUTION :-RECORDS ARE SEND IN GMT TIME ZONE AND NOT LOCAL TIME ZONE. 
     * 
     * @param pid
     *            property unique identifier
     * @param property
    ...
    public List<DashboardRecord> getHourlyDashboardDetailsBetween(@PathParam("property") String property,
        ...
        // Converted to gmt time zone from local timezone and send the records
       return WebServiceUtils.convertToGMT(energyConsumptionManager.loadHourSummaryBetween(pid, property, dFrom, dTo));
       // CAUTION :-RECORDS ARE SEND IN GMT TIME ZONE AND NOT LOCAL or SERVER TIME ZONE.
    }
