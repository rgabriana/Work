...
public class DeviceInfo {
  ...
  private Fixture fixture = null;
  private ProfileHandler prHandler = null;
  private byte sPrChecksum = -1;
  private byte aPrChecksum = -1;
    
  /**
   * @return the sPrChecksum
   */
  public byte getsPrChecksum() {
  
    return sPrChecksum;
  }
  
  /**
   * @param sPrChecksum the sPrChecksum to set
   */
  public void setsPrChecksum(byte sPrChecksum) {
  
    this.sPrChecksum = sPrChecksum;
  }
  
  /**
   * @return the aPrChecksum
   */
  public byte getaPrChecksum() {
  
    return aPrChecksum;
  }
  
  /**
   * @param aPrChecksum the aPrChecksum to set
   */
  public void setaPrChecksum(byte aPrChecksum) {
  
    this.aPrChecksum = aPrChecksum;
  }

  /**
   * @return the prHandler
   */
  public ProfileHandler getPrHandler() {
  
    if(prHandler == null) {
      System.out.println(fixture.getId() + ": profile handler not in cache");
      prHandler = DeviceServiceImpl.getInstance().getProfileHandlerById(
	  fixture.getProfileHandler().getId());
    }
    return prHandler;
  ...
  /**
   * @param prHandler the prHandler to set
   */
  public void setPrHandler(ProfileHandler prHandler) {
  ...
  public DeviceInfo(Fixture fixture) {
    ...
    this.sPrChecksum = DeviceServiceImpl.getInstance().calculateScheduledProfileChecksum(fixture);
    this.aPrChecksum = DeviceServiceImpl.getInstance().calculateGlobalProfileChecksum(fixture);
