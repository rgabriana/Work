...
public class DeviceServiceImpl implements DeviceService {
   ...
   */
    ...
    public ProfileHandler getProfileHandlerById(long id) {
      ...
      return profileMgr.getProfileHandlerById(id);
    ...
    public void setCurrentTime(Fixture fixture, int seqNo) {
      ...
      DeviceInfo device = null;
        try {            
            byte[] dataPacket = new byte[0];
            device = ServerMain.getInstance().getDevice(fixture);
            if(device != null) {
    ...
    public void nodeBootInfo(Fixture fixture, byte[] packet, long gwId, int pktLen) {
    ...
    public void initiateProfileSyncActivity(Fixture fixture, byte gProfChecksum, byte sProfChecksum,
        ...
        byte bFixtureProfileGroupId = fixture.getGroupId().byteValue(); //getProfileGroupId(fixture);
        ...
        DeviceInfo device = ServerMain.getInstance().getDevice(fixture);
        byte calcSchedPrChecksum = device.getsPrChecksum(); //calculateScheduledProfileChecksum(fixture);
        ...
        byte calcGlobalPrChecksum = device.getaPrChecksum(); //calculateGlobalProfileChecksum(fixture);
    ...
    public class ProfileSyncWork implements Runnable {
        ...
        public void run() {
            try {
              ...
              profileLogger.error(fixture.getId() + ": error in profile sync " + e.getMessage());
            }
        }
    }
