...
//    } // end of method getBit
    ...
    public void updateStatsFromZigbee(Fixture fixture, byte[] packet, long gwId, int pktLen) {
      ...
      if(logger.isDebugEnabled()) {
        ...
        if (!fixture.getState().equals(ServerConstants.FIXTURE_STATE_COMMISSIONED_STR)) {
            ...
            DeviceListener.returnReceivePacket(packet);
            return;
        }
        ...
        PMStatsWork statsWork = new PMStatsWork(fixture, packet, seqNo, pktLen);
        statsProcessThPool.addWork(statsWork);
        fixture = null;
        packet = null;
