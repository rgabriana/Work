...
public class PMStatFrame implements ICommandPktFrame {
    ...
    char currApp = '2';
    char global_profile_checksum = '1';
    char profile_checksum = '1';
    char group_id = (byte) 9;

    private char frame_end_marker = 0x5e;
    
    private int pmSeqNo = -1;

    public PMStatFrame(int pmSeq) {
        Random randomGenerator = new Random();

        min_voltage_step = (char) randomGenerator.nextInt(100);
        max_voltage_step = min_voltage_step;
        avg_voltage_step = (short) min_voltage_step;
        last_voltage_step = min_voltage_step;
    ...
    public byte[] toByte(String nodeName) {
        ...
        try {
            ...
            output.write((byte) current_state);
    ...
    public void setCurrent_state(char current_state) {
    ...
    public char getGlobal_profile_checksum() {
        return global_profile_checksum;
    }

    public void setGlobal_profile_checksum(char global_profile_checksum) {
        this.global_profile_checksum = global_profile_checksum;
    }

    public char getProfile_checksum() {
        return profile_checksum;
    }

    public void setProfile_checksum(char profile_checksum) {
