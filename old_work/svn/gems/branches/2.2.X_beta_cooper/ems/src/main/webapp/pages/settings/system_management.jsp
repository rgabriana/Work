...
<div class="outermostdiv">
	...
	<div class="outerContainer">
		<span><spring:message code="header.system.cloudServerSettings" /></span>
		<div class="i1"></div>
	</div>
	
	<div class="upperdiv"
		style="height: 35px; margin: 10px; padding: 10px;">
		<spring:url value="/settings/cloud_setting.ems"
			var="cloudSetting"  />
		<form action="${cloudSetting}">
			<input type="submit" value='<spring:message	code="system.label.cloudSettings" />' />
		</form>
	</div>
