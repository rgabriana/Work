...
{
logger -p 6 -t emsdashboard_memory_tracker "Checking out of memory condition for EMS Dashboard"
managerUser="admin"
managerPass="admin"
...
then
    ...
    rm -rf /var/lib/tomcat6/work/Catalina/localhost/ems_dashboard
    service tomcat6 start
    logger -p 6 -t emsdashboard_memory_tracker "Tomcat rebooted as out of memory detected"
fi
}
