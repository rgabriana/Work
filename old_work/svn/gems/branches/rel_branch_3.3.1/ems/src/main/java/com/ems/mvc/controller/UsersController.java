...
public class UsersController {
    ...
    public String resetUserPassword(User user,  @RequestParam("password") String password) {
    	...
    	if(resetPassword(user, password, false)){
    		...
    		//return "redirect:/login.jsp?resetSuccess=true";
    		//return "redirect:/j_spring_security_logout?resetSuccess=true";
    		return "redirect:/pages/users/reset_password.jsp?resetSuccess=true";
    	}else{
    		//return "redirect:/login.jsp?resetFail=true";
    		//return "redirect:/j_spring_security_logout?resetFail=true";
