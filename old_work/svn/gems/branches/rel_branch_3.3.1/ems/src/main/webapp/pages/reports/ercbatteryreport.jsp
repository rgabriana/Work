...
<spring:url value="/wdsreport/downloadWdsPdfReport.ems" var="exportWdsPdfReportUrl" />
...
<div style="width: 100%; height: 100%; background: #fff; padding: 0px 5px 0px 0px" >
 ...
 <form id="exportWdsPdfReportForm" action="${exportWdsPdfReportUrl}" target="_blank" METHOD="POST"></form>