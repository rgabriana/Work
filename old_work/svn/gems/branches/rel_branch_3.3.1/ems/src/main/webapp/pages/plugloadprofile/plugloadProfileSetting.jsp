...
var OriprofileName="";
	$(document).ready(function() {		
		...
		}else if(manageType=='readonly')
		{
			...
			$('#edit-basic input').attr('readonly', 'readonly');
			$('#edit-basic select').attr('disabled', true);
			var deactivator = function(event){ event.preventDefault(); }; 
			$(':checkbox').click(deactivator); 
				...
				<table class="entable rhtinput" style="width: 100%; height: 100%;" border="0">
					<thead>
						<tr>
							...
							<th  align="center">Manual Override Time</th>
							<th  align="center">Mode</th>
							</tr>
					</thead>
					<tbody>
						<tr>
							<td colspan="4" class="profheader">
						...
						<tr>
							...
							<td align="right" style="padding-right:10px">
								<form:select class="inputField" path="morningProfile.mode">
									...
									<form:option value="1" label="Always off" />
									<form:option value="2" label="Occupancy" />
									<form:option value="3" label="Vacancy" />
								</form:select>
							</td>
	...
	<div class="settingDivOuter">
			...
			<table class="entable rhtinput" style="width: 100%; height: 100%;" border="0">
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="profheader cleartd">
							</td>
						</tr>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override5.id}" class='validate[required,custom[integer],min[0],max[100],funcCall[validateLevel]] text-input' path="override5.activeMotion"/></div></td>
							
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override5.id}" class='validate[required,custom[integer],min[0],max[1000],funcCall[validateLevel]] text-input' path="override5.manualOverrideTime"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override6.id}" class='validate[required,custom[integer],min[0],max[100],funcCall[validateLevel]] text-input' path="override6.activeMotion"/></div></td>
							
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override6.id}" class='validate[required,custom[integer],min[0],max[1000],funcCall[validateLevel]] text-input' path="override6.manualOverrideTime"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override7.id}" class='validate[required,custom[integer],min[0],max[100],funcCall[validateLevel]] text-input' path="override7.activeMotion"/></div></td>
							
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override7.id}" class='validate[required,custom[integer],min[0],max[1000],funcCall[validateLevel]] text-input' path="override7.manualOverrideTime"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="1" id="${profilehandler.override8.id}" class='validate[required,custom[integer],min[0],max[100],funcCall[validateLevel]] text-input' path="override8.activeMotion"/></div></td>
							
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override8.id}" class='validate[required,custom[integer],min[0],max[1000],funcCall[validateLevel]] text-input' path="override8.manualOverrideTime"/></div></td>
						...
						<div class="settingAccordionFormDiv">
							<fieldset>
								...
								<div class="settingAccordionFormField" >
									...
									<span>Unsuccessful attempts in obtaining occupancy status from motion group memebers</span>
								</div>
								<div class="settingAccordionFormField" >
									<span>Set an Intreval of</span>
								...
								<div class="settingAccordionFormField" >
									<span>Set switched outlet plug to</span>
									<div class="settingAccordionFormInputField">
