...
var flash_fx_ec = function(nodetype, nodeid) {
	...
	*/
	...
	var EC_data = "";
	if ($.browser.msie) {
		EC_data = "<object id='fx-energy-summary' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='https://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab' width='100%' height='100%'>";
