...
public class CommunicatorConstant {
	...
	public static final String callHomeService = ecloudContext+"/services/org/communicate/em/callhome/v3";
	...
	public static final String setPeriodicAndRealTimeHB= "https://localhost/ems/services/uem/setPeriodicAndRealTimeHB/";
