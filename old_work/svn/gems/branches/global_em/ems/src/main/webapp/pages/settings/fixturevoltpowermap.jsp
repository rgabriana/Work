...
function start(pageNum, orderBy, orderWay) {	
	...
	jQuery("#fixturepowermapTable").jqGrid({
		...
		colNames: ["Id","Light level","Power","Include"],
	       colModel: [
...
<tr><td>Characterization DateTime: <span id="fvpcharacterizationTime"><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss a "	value="${characterizationTime}" /></span></td></tr>
<tr><td>Warm-up: <span id="fvpWarmupTime">${warmupTime}</span> sec</td></tr>
<tr><td>Stabilization: <span id="fvpStabilizationTime">${stabilizationTime}</span> sec</td></tr>
</table>
</td>
