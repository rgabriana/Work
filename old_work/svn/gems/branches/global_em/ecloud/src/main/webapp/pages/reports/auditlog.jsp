...
<script type="text/javascript">
	...
	function start(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#auditsTable").jqGrid({
			...
			hoverrows: false,
			forceFit: true,
		   	colNames:["<spring:message code='audit.time'/>","<spring:message code='audit.username'/>","<spring:message code='audit.ipAddress'/>", "<spring:message code='audit.action'/>", "<spring:message code='audit.description'/>"],
		   	colModel:[
		   		{name:'logTime',index:'logTime', sorttype:"string", width:"12%"},
		   		{name:'username',index:'username', sorttype:"string", width:"15%"},
		   		{name:'ipAddress',index:'ipAddress', sorttype:"string", width:"10%"},
		   		{name:'actionType',index:'actionType', sorttype:"string", width:"15%"},
		   		{name:'description',index:'description', sortable:false, width:"40%"}
		   	],
		   	pager: '#auditsDiv',
		   	page: pageNum,
		   	sortorder: orderWay,
	...
	function ModifyGridDefaultStyles() {  
		   $('#' + "auditsTable" + ' tr').removeClass("ui-widget-content");
		   $('#' + "auditsTable" + ' tr:nth-child(even)').addClass("evenTableRow");
		   $('#' + "auditsTable" + ' tr:nth-child(odd)').addClass("oddTableRow");
	}
