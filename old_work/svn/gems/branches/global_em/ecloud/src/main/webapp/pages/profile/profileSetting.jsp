...
<div id="basicConfigurationTop1" style="border:1px;border-style:solid; vertical-align:middle; border-color:#F2F2F2;padding-left: 10px;padding-right: 10px;padding-top: 5px;padding-bottom: 10px;">
	...
	function daylightHarvestingOpenDialog() {
		...
		if(daylightHarvestingVal == '1'){
	    	$("#daylightHarvestingDialog").html("<p>Daylight Harvesting will be <strong><span style=\"color:#FF0000\">OFF</span></strong>.<br/><br/> Please confirm by clicking &#39;Yes&#39;&nbsp;if you do not want to do the Daylight Harvesting</p>");
		}else{
			$("#daylightHarvestingDialog").html("<p>You have selected the Daylight Harvesting to be <strong><span style=\"color:#00FF00\">ON</span></strong>.<br/><br/> Please confirm by clicking &#39;Yes&#39;&nbsp;</p>");
		}
	    // Define the Dialog and its properties.
	    $("#daylightHarvestingDialog").dialog({
	        resizable: false,
	        modal: true,
	        title: "Confirm daylightHarvesting Value change....",
	        height: 250,
	        width: 400,
	        buttons: {
	            "Yes": function () {
