...
<script type="text/javascript">
	...
	function start(pageNum, orderWay) {
		jQuery("#emStatsTable").jqGrid({
			...
			colNames: ["id", "Captured At (UTC)", "Active thread Count", "GC Count", "GC Time", "Heap Used", "Non Heap Used", "Sys Load", "CPU %"],
		       colModel: [
	...
	function forceFitStatsTableHeight(){		
