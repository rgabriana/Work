...
public class SppaService {
	...
	public SppaBill generateLastMonthBillPerCustomer(@PathParam("custId") Long custId,@PathParam("startDate") String startDateStr,@PathParam("endDate") String endDateStr) {
		...
		SppaBill customerBill = sppaManager.generateLastMonthBillPerCustomer(custId,startDate,endDate);
		return customerBill;
	...
	public List<SppaBill> generateLastMonthBillListPerCustomer(@PathParam("custId") Long custId,@PathParam("startDate") String startDateStr,@PathParam("endDate") String endDateStr) {
		...
		while(emIter.hasNext()) {
			...
			sppaBill = sppaManager.generateLastMonthBillPerSite(emInst.getId(),startDate, endDate);
			if (sppaBill != null) {
