...
//			gemsGroupManager.deleteGemsGroupsFromFixture(fixtureId);
   ...
   /* *
	...
	public javax.ws.rs.core.Response getFixtureCSVListById(
		...
		output.append("#ballast type :"+ ballastDisplayLabel +"\r\n");
		output.append("#no. lamps,"+ fixture.getNoOfBulbs() +"\r\n");
		output.append("#lamp manufacturer,"+ fixture.getBallast().getBallastManufacturer()+"\r\n");
		output.append("#lamp type,"+ fixture.getBallast().getLampType() +"\r\n");
		output.append("#lamp wattage,"+ fixture.getWattage() +"\r\n");
		output.append("#line voltage,"+ fixture.getVoltage() +"\r\n");
	...
	@Path("forgetFixtureCurve/{fixtureId}")
	@POST
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public com.ems.ws.util.Response forgetFixtureCurve(@PathParam("fixtureId") Long fixtureId) {
		com.ems.ws.util.Response resp = new com.ems.ws.util.Response();
		Fixture fixture = fixtureManager.getFixtureById(fixtureId);
