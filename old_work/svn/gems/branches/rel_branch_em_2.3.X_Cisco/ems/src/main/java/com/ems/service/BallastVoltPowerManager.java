...
public class BallastVoltPowerManager {
	...
	public void add(Long ballastId, Double voltage, Double volt, Double power,Long voltPowerMapid) {
		// TODO Auto-generated method stub
		ballastVoltPowerDao.add(ballastId,voltage,volt,power,voltPowerMapid);		
	}
