...
//All Java Script functions 
	function createSwitchPageFixtureGrid(){
		...
		jQuery("#switchfixtureTable").jqGrid({
		    ...
		    gridComplete: function(){
		    	...
		    	ModifySwitchFormGridDefaultStyles();
		    }
		});
	...
	function ModifySwitchFormGridDefaultStyles() {  
		   $('#' + "switchfixtureTable" + ' tr').removeClass("ui-widget-content");
		   $('#' + "switchfixtureTable" + ' tr:nth-child(even)').addClass("evenTableRow");
		   $('#' + "switchfixtureTable" + ' tr:nth-child(odd)').addClass("oddTableRow");
	}
	...
	function createScenePageFixtureGrid(){
		...
		jQuery("#scenefixtureTable").jqGrid({
		    ...
		    gridComplete: function(){
		    	...
		    	ModifySceneFormGridDefaultStyles();
		    }
		});
	}
	
	function ModifySceneFormGridDefaultStyles() {  
		   $('#' + "scenefixtureTable" + ' tr').removeClass("ui-widget-content");
		   $('#' + "scenefixtureTable" + ' tr:nth-child(even)').addClass("evenTableRow");
		   $('#' + "scenefixtureTable" + ' tr:nth-child(odd)').addClass("oddTableRow");
	}
