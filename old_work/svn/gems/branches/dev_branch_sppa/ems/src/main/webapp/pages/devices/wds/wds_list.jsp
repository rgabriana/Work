...
<div id="wds-list-topPanel" style="background: #fff">
	<c:if test="${page == 'floor' or page == 'area'}">
		<button id="newWds" onclick="javascript: parent.parent.showWdsCommissioningIdentifyWindow();">Add EWS</button>
		...
		WDS_GRID.jqGrid({
			...
			forceFit: true,
		   	...
		   	colModel:[
		   		...
		   		{name:'switchName', index:'switchName', sorttype:"string", width:"34%"},
