...
<script type="text/javascript">
	...
	function validateSchedule() {
		var schedulename = $("#name").val().trim();
		...
		var url = "${validateMotionBitsScheduleUrl}"+schedulename+"/"+$("#captureStart").val().trim()+"/"+$("#captureEnd").val().trim()+"/"+"${motionBitsSchedule.id}"+"?ts="+new Date().getTime();
