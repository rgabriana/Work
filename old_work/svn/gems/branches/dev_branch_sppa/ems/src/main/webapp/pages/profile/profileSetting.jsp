	...
	$(document).ready(function() {
		...
		$('.helpAdvanced').click(function() {
			$("#helpDialog").html('<p>This screen allows the following low level configuration attributes to be changed:</p> <br />' +
					...
					'<p class="dialogbigpad">&bull;&nbsp;&nbsp;&nbsp;Motion threshold (0-255) -- the threshold between 1 (minimal) and 255 (maximal) for detecting motion. When set to zero, the default value is used. The recommended values are 1 to 10. This value should be increased if there are false trigger of motion, such as heat from a printer located beneath the fixture, or air from a vent.</p><br />' +
									...
									<div class="settingProfileNameFieldValue">
										...
										<c:if test="${management=='edit'}">
											<c:choose>
												...
												<c:otherwise>
													<input id="profilename11"  name="profilename"  class='validate[required] text-input' size="20"/>
												</c:otherwise>
											</c:choose>
										</c:if>
					...
					<div class="settingProfileNameFieldLabel">
							...
							<div style="float: right;padding-right: 20px;">
								...
								<c:if test="${management=='readonly' && type=='fixture' && group.defaultProfile!='true'}">
									 <input type="button" id="pushbtn" onclick="pushProfileToSU();"
											value="Push Profile"/>
								 </c:if>
