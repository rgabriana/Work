...
public class Profile {
    ...
    public void setScheduleProfile(byte[] profile, int iType) {
        int idx = 3;
        ScheduleProfileFrame oProfile = null;
        ...
        oLogger.fine(oBuff.toString());
    }

    public void setAdvanceProfile(byte[] profile) {
        StringBuffer oBuff = new StringBuffer();
        oBuff.append(sName)
    ...
    public byte getDefaultScheduleProfileChecksum() {
        ...
        oLogger.fine(sName + " (Schedule Profile) - (" + s_profile.length + ", " + s_profile_cksum + ") "
    ...
    public byte getDefaultAdvanceProfileChecksum() {
        ...
        oLogger.fine(sName + " (Advance Profile) - (" + g_profile.length + ", " + g_profile_cksum + ") "
    ...
    public byte[] getAdvanceProfile() {
        byte[] g_profile = oAdvanceProfile.toByte("");
        oLogger.fine(sName + " (Advance Profile) - (" + g_profile.length + ") " + Utils.getPacket(g_profile));
        return g_profile;
    }
