...
function startAllSiteAnomolies(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#allanamoliesTable").jqGrid({
			...
			colNames: ["id", "Geo Location", "Report Date", "Start Date", "End Date", "Issue","Details"],
		       ...
		       { name: "reportDate", index: 'reportDate',formatter:allanomalieslistcustomdateformatter, sortable:true,width:'6%'},
		       { name: "startDate", index: 'startDate',formatter:allanomalieslistcustomdateformatter, sortable:true,width:'6%'},
		       { name: "endDate", index: 'endDate',formatter:allanomalieslistcustomdateformatter, sortable:true,width:'6%'},
	...
	function allanomalieslistcustomdateformatter(cellvalue, options, rowObject)
	{
