...
public class Test {
	...
	public static void main(String[] args) {
		...
		encryptedJsonLicenseString = LicenseUtil.getEncryptedJsonLicenseString(uuid,noOfEmDevices,bacnetEnabled,noOfBacnetDevices,zoneSensorsEnabled,noOfZoneSensors,hvacEnabled,emProductId,bacnetProductId,zoneSensorsProductId);
