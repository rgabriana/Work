...
public abstract class AbstractEnlightedWSTest extends AbstractEnlightedTest {
	...
	public ClientResponse getAPIResponse(final String urlAccess, String email, String key, final boolean isGet)
			throws Exception {
		...
		ClientResponse res = isGet? wr.type(MediaType.TEXT_PLAIN).get(ClientResponse.class) :  wr.type(MediaType.TEXT_PLAIN).post(ClientResponse.class);
		return res;
	}
