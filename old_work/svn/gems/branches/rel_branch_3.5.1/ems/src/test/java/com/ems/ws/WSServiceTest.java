...
//			}
	...
	@Test
	public void testSingleAPIForBacnetUser(){
	...
	public void testisParamValueAllowed(){
		try {
	    	...
	    	checkAssertFalseWithArgException(testattachedMessageSource, systemConfigurationManager, "p10","asdad",!isApplyValidation?Response.Status.OK.getStatusCode():Response.Status.OK.getStatusCode());
	    	checkAssertFalseWithArgException(testattachedMessageSource, systemConfigurationManager, "p10","asd*&ad",!isApplyValidation?Response.Status.OK.getStatusCode():Response.Status.NOT_ACCEPTABLE.getStatusCode());
	    	checkAssertFalseWithArgException(testattachedMessageSource, systemConfigurationManager, "p10","",!isApplyValidation?Response.Status.OK.getStatusCode():Response.Status.OK.getStatusCode());
	    	checkAssertFalseWithArgException(testattachedMessageSource, systemConfigurationManager, "p10"," ",!isApplyValidation?Response.Status.OK.getStatusCode():Response.Status.OK.getStatusCode());
	    	checkAssertFalseWithArgException(testattachedMessageSource, systemConfigurationManager, "p10","\t",!isApplyValidation?Response.Status.OK.getStatusCode():Response.Status.OK.getStatusCode());
			//yyyyMMdd : HH:mm:ss
...
//		}
	...
	public void testNetWorkSettings(){
		...
		try{
			...
			Builder wrOther = getWebResourceWithoutAuth(HOST_ADDR+"/ems/api/org/networksettings/apply/settings", MediaType.TEXT_PLAIN);
			wrOther.header("AuthenticationToken", authTokenOther);
			wrOther.header("ts", String.valueOf(dtOther.getTime()));
			wrOther.header("UserId", email);
			res = wrOther.type(MediaType.TEXT_PLAIN).get(ClientResponse.class);
