...
public class DashboardRecord {
    ...
    @XmlElement(name = "unmanagedpowerused")
    private Double unmanagedPowerUsed;
    @XmlElement(name = "unmanagedbasepowerused")
    private Double unmanagedBasePowerUsed;
    @XmlElement(name = "unmanagedsavedpower")
    private Double unmanagedSavedPower;    
    @XmlElement(name = "powerFactor")
    private Double powerFactor;  
    @XmlElement(name = "unmanagedpowerfactor")
    private Double unmanagedPowerFactor;  
	...
	public Double getUnmanagedPowerUsed() {
		return unmanagedPowerUsed;
	}

	public void setUnmanagedPowerUsed(Double unmanagedPowerUsed) {
		this.unmanagedPowerUsed = unmanagedPowerUsed;
	}

	public Double getUnmanagedBasePowerUsed() {
		return unmanagedBasePowerUsed;
	}

	public void setUnmanagedBasePowerUsed(Double unmanagedBasePowerUsed) {
		this.unmanagedBasePowerUsed = unmanagedBasePowerUsed;
	}

	public Double getUnmanagedSavedPower() {
		return unmanagedSavedPower;
	}

	public void setUnmanagedSavedPower(Double unmanagedSavedPower) {
		this.unmanagedSavedPower = unmanagedSavedPower;
	}
	...
	public Double getUnmanagedPowerFactor() {
		return unmanagedPowerFactor;
	}

	public void setUnmanagedPowerFactor(Double unmanagedPowerFactor) {
