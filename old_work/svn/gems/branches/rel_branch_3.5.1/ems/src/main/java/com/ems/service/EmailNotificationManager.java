...
@Service("emailNotificationManager")
...
public class EmailNotificationManager {
	...
	public void sendNotificationEmail() {
		try {
			...
			String emailSubject = "Energy Manager Notification";
			String emailMessage = "Please find the Energy Manager Notification report as an attachment.";
			...
			if(emailNotificationConfiguraiton!=null)
			{
				...
				if(emailNotification.getEnabled()){
						...
						String emailNotificationDataCsv = getEventsAndFaultsDataCSV(emailNotification.getEventTypeList(),emailNotification.getSeverityList());
						...
						if(!"".equalsIgnoreCase(emailNotificationDataCsv)){
							...
							attachment.setFileName("EM_Notification.csv");
	...
	public String getEventsAndFaultsDataCSV(String eventTypeList, String severityList){
		...
		if(!"".equalsIgnoreCase(severityList)){
			filter.add(Arrays.asList(severityList.split(",")));
		}else{
			filter.add(null);
		}
		
		if(!"".equalsIgnoreCase(eventTypeList)){
			filter.add(Arrays.asList(eventTypeList.split(",")));
		}else{
			filter.add(null);
		}
