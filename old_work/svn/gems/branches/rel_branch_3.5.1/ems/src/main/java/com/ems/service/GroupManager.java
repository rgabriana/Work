...
//        }
	...
	public int deleteProfile(long profileId) {
		...
		try
		{
			...
			Profile override5 =  (Profile) groupDao.loadObject(Profile.class, profileHandler.getOverride5().getId());
			Profile override6 =  (Profile) groupDao.loadObject(Profile.class, profileHandler.getOverride6().getId());
			Profile override7 =  (Profile) groupDao.loadObject(Profile.class, profileHandler.getOverride7().getId());
			Profile override8 =  (Profile) groupDao.loadObject(Profile.class, profileHandler.getOverride8().getId());
			...
			//Remove override profile
			groupDao.removeObject(Profile.class, override5.getId());
			groupDao.removeObject(Profile.class, override6.getId());
			groupDao.removeObject(Profile.class, override7.getId());
			groupDao.removeObject(Profile.class, override8.getId());
