...
public class SettingsController {
    ...
    String saveemailconfig(Model model,EmailConfiguration config) {
     	...
     	if(config == null ){
	     	...
	     	try {
	     		final String prevPort = StringUtils.isEmpty(config.getPrevPort()) ? "" : config.getPrevPort();
				String[] cmdArr = { "bash", ServerMain.getInstance().getTomcatLocation() + "adminscripts/enablePort.sh", config.getPort(), prevPort };
