		...
		<div id="tenantfacilityTreeViewDiv">
				<ul>
					<c:forEach items='${facilityTreeHierarchy.treeNodeList}' var='node1'>
						...
						<select name="${node1.nodeType.lowerCaseName}_${node1.nodeId}" id='<c:out value="${node1.nodeType.lowerCaseName}"/>_${node1.nodeId}_select' onchange="javascript: comboChange(this);">
							...
							<ul>
								<c:forEach items='${node1.treeNodeList}' var='node2'>
									...
									<select name="${node2.nodeType.lowerCaseName}_${node2.nodeId}" id='<c:out value="${node2.nodeType.lowerCaseName}"/>_${node2.nodeId}_select' onchange="javascript: comboChange(this);">
										...
										<ul>
											<c:forEach items='${node2.treeNodeList}' var='node3'>
												...
												<select name="${node3.nodeType.lowerCaseName}_${node3.nodeId}" id='<c:out value="${node3.nodeType.lowerCaseName}"/>_${node3.nodeId}_select' onchange="javascript: comboChange(this);">
													...
													<ul>
														<c:forEach items='${node3.treeNodeList}' var='node4'>
															...
															<select name="${node4.nodeType.lowerCaseName}_${node4.nodeId}" id='<c:out value="${node4.nodeType.lowerCaseName}"/>_${node4.nodeId}_select' onchange="javascript: comboChange(this);">
																...
																<ul>
																	<c:forEach items='${node4.treeNodeList}' var='node5'>
																		...
																		<select name="${node5.nodeType.lowerCaseName}_${node5.nodeId}" id='<c:out value="${node5.nodeType.lowerCaseName}"/>_${node5.nodeId}_select' onchange="javascript: comboChange(this);">
