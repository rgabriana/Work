...
public class MotionBitsSchedulerJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
        	MotionBitsConfigManager motionBitsConfigManager = (MotionBitsConfigManager) SpringContext
                    .getBean("motionBitsConfigManager");
            FixtureManager fixtureManager = (FixtureManager) SpringContext.getBean("fixtureManager");
            GemsGroupManager gemsGroupManager = (GemsGroupManager) SpringContext.getBean("gemsGroupManager");

            MotionBitsScheduler schedule = motionBitsConfigManager.loadMotionBitsScheduleById(id);

            List<GemsGroupFixture> listFixtureGroup = gemsGroupManager.getGemsGroupFixtureByGroup(schedule
