...
public class FacilityTreeManager {
	...
	public TreeNode<FacilityType> loadCompanyHierarchy() {
		...
		TreeNode<FacilityType> companyHierachy = companyManager
	...
	public TreeNode<String> loadCompanyHierarchyForUem() {
		return companyManager.loadCompanyHierarchyForUem();
	}
	...
	public void onlyInValidateFacilitiesTreeCache() {
		facilityTreeMap.clear();
	}
	...
	public void setUserFacilities(String[] assignedFacilities, Long userId) {
		...
		// Let's get user locations
		User currentUser = userManager.loadUserById(emsAuthContext.getUserId());
	...
	public void deleteParents(FacilityType locationType, long userId,
