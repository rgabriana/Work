    ...
    private String getLocation(Long locationId, String locationType) {
        ...
        if (locationType != null) {
            ...
            if (locationType.equalsIgnoreCase("floor")) {
            	...
            	FloorManager floorManager = (FloorManager) SpringContext.getBean("floorManager");
                if (floorManager != null) {

                    Floor floor = null;
					try {
						floor = floorManager.getFloorById(locationId);
            	...
            	BuildingManager buildingManager = (BuildingManager) SpringContext.getBean("buildingManager");
                ...
                CampusManager campusManager = (CampusManager) SpringContext.getBean("campusManager");
