...
<!--<div id="gateway_message" class="server_message" style="background-color: #EEEEEE; border: thin solid #AAAAAA; left: 494px; margin: auto; position: absolute; top: 200px; padding:2px;">
	...
	<fieldset class="column">
		<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" var="lastConnectivity" value="${gateway.lastConnectivityAt}"/>
		<label for="gw_info_lastConnectivityAt"><spring:message code="gatewayForm.label.lastCommunication"/></label>
		<input class="text readonly" id="gw_info_lastConnectivityAt" name="lastConnectivityAt1" size="40" value='<ems:breakDateDiffInString  dateValue="${lastConnectivity}" datePattern="yyyy-MM-dd HH:mm:ss"/>'/>
