        ...
        try {
            ...
            case BACNET_MSGTYPE_ASSIGN_SU_PROFILE:
              ...
              if (profileResult != BACNET_RES_DEVICE_NOT_FOUND) {
              	...
              	if(profileSched == 1) {
              		fixtureMgr.changeFixtureProfile(fixtureMgr.getFixtureById(nodeId), (long)profileGrpId, groups.getName(), fixture.getCurrentProfile());
              	} else {
              		fixtureMgr.pushProfileToFixtureNow(fixtureMgr.getFixtureById(nodeId), profileGrpId);
              	}
              }
            ...
            case BACNET_MSGTYPE_PROFILE_DIM:
              ...
              fillPos += 2;
              // result             
              DeviceServiceImpl.getInstance().dimFixturesByGroup(profileGrpId, (byte)percentage, (int)duration, dimType, true);              
              sendBacnetPacket(responsePkt);
              break;
            default:
            if(logger.isInfoEnabled()) {
