...
public class FixtureController {
    ...
    public String loadFixtureObject(Model model, @RequestParam("fixtureId") long fixtureId) {
    	...
    	fixtureManager.setRealTimeStats(fixture);
    	model.addAttribute("fixture", fixture);
        model.addAttribute("ballasts", ballastManager.getAllBallasts());
        model.addAttribute("lamps", bulbManager.getAllBulbs());
    ...
    public String updateFixture(Fixture fixture, Locale local) {
        ...
        savedFixture.setBallast(ballastManager.getBallastById(fixture.getBallast().getId()));
        savedFixture.setBulb(bulbManager.getBulbById(fixture.getBulb().getId()));
        ...
        if (savedFixture.getGroupId().longValue() != fixture.getGroupId().longValue()) {
            fixtureManager.changeFixtureProfile(fixtureManager.getFixtureById(fixture.getId()), fixture.getGroupId(), fixture.getCurrentProfile(), fixture.getOriginalProfileFrom());
        }
    ...
    public String assignFixtureTypeToFixtureDialog(Model model, @CookieValue(value = FacilityCookieHandler.selectedFacilityCookie, required = false) String cookie){
