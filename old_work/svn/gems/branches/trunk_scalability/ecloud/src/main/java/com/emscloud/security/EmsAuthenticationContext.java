...
public class EmsAuthenticationContext {
    ...
    public RoleType getCurrentUserRoleType() {
        ...
        else if(authUser.getUser().getRoleType().toString().equals(RoleType.ThirdPartySupportAdmin.toString()))
            return RoleType.ThirdPartySupportAdmin;
        else if(authUser.getUser().getRoleType().toString().equals(RoleType.SPPA.toString()))
            return RoleType.SPPA;
        return null;
    }
