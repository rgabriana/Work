    ...
    public SiteList getSitesByCustomerWithSpecificAttibute(Long id,String orderby,
        ...
        if (bSearch) {
            if (searchField.equals("name")) {
                ...
                oRowCount.add(Restrictions.like("site.geoLocation", "%"
                        + searchString + "%"));
                oCriteria.add(Restrictions.like("site.geoLocation", "%"
                        + searchString + "%"));
  ...
  public void addSiteAnomaly(SiteAnomaly anomaly) {
	...
	public SiteAnomalyList getAllAnamoliesListBySiteId(List<String> geoLocList,Date startDate,Date endDate,
		 ...
		 SiteAnomalyList  siteAnomalyList= new SiteAnomalyList();
    		...
    		if(startDate != null) {
    			oRowCount.add(Restrictions.ge("siteanomaly.reportDate", startDate));
    			oCriteria.add(Restrictions.ge("siteanomaly.reportDate", startDate));
    		}
    		if(endDate != null) {
    			oCriteria.add(Restrictions.le("siteanomaly.reportDate", endDate));
    			oRowCount.add(Restrictions.le("siteanomaly.reportDate", endDate));
    		}
	        if (orderby != null && !"".equals(orderby)) {
