...
function assignSelectedAreaToDevices(){
	if(SELECTED_SWITCHES_TO_ASSIGN_AREA.length == 0 && SELECTED_FIXTURES_TO_ASSIGN_AREA.length == 0 && SELECTED_WDS_TO_ASSIGN_AREA == 0){
		setSelectedDeviceMessage("Please select a switch,fixture or wds", "red");
		return false;
	}
	...
	$.ajax({
		...
		success: function(data){
			if(SELECTED_FIXTURES_TO_ASSIGN_AREA != ""){
				...
				setSelectedDeviceMessage("Assignment Successful 1.", "green");
			}
		},
		dataType:"xml",
	...
	$.ajax({
		...
		success: function(data){
			if(SELECTED_WDS_TO_ASSIGN_AREA != ""){
				...
				setSelectedDeviceMessage("Assignment Successful 2.", "green");
			}
		},
		dataType:"xml",
		contentType: "application/xml; charset=utf-8"
...
function assignSelectedAreaToWds(){
	...
	$.ajax({
		...
		data: postWdsData,
		success: function(data){
			setSelectedDeviceMessage("Assignment Successful 3.", "green");
		},
		dataType:"xml",
		contentType: "application/xml; charset=utf-8"
	});
