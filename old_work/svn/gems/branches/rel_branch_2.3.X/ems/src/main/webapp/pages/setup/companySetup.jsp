			...
			$().ready(function(){
				...
				$("#dhcp-submit").click(function() {
					...
					if(radioDhcpEnable.checked == true)
					{
						...
						{
							var ret = confirm("There are gateways already discovered/commissioned in the network. In order for the EC to communicate with the gateways, you will need to ensure that the gateways are connected via the building network port of the EC," + 
									" reboot the gateways and initiate discovery from the EC . Are you sure you want to proceed?");
					...
					else
					{
						...
						else if(gatewaysPresent == "true")
						{
							var ret = confirm("There are gateways already discovered/commissioned in the network." +  
									"In order for the EC to communicate with the gateways, you will need to reboot the gateways while connected to an alternate DHCP server on your network. You can refer to the instruction manual for details. Are you sure you want to proceed?");
