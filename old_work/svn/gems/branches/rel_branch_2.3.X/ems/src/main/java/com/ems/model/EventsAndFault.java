...
public class EventsAndFault implements Serializable {
    ...
    public static final String EWS_IMG_UP_STR = "EWS Upgrade";
    public static final String EWS_DISCOVERY = "EWS Discovery";
    public static final String EWS_COMISSION = "EWS Commissioning";
