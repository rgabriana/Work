...
<div class="outermostdiv">
	...
	<div class="general">
		...
		<ul>
			<li><b>Master EC Server:</b> Name/IP of the Master EC that this EC communicates to.</li>
			<li><b>Master EC Port:</b>Port number, on which EC will communicate with Master EC.</li>
			<li><b>EC Server:</b> Name/IP for this EC.</li>
			<li><b>EC Port:</b> Port number of this EC.</li>
		</ul>
	</div>
	</div>
