...
//	startPollFixturesTimer(); //UNCOMMENT ME (for testing)
    ...
    .append("<input type='button' value='Identify' style='float:right' onclick=\"identifyFixture();\"/>");
...
function setfixtureBasicInfo(fixture){
	...
	if(FX_DEFAULT_VAL_NO_OF_BALLASTS != ""){
		$("#nooffixtures").val(FX_DEFAULT_VAL_NO_OF_BALLASTS);
	} else {
		$("#nooffixtures").val(fixture.nooffixtures); //No. of ballast
	}
...
<body> 
 <table id="fxcd-main-box" style="width:100%; height:100%;">
	 ...
	 <tr height="18px">
		 ...
		 <div style="display: inline;padding-top: 2px;padding-left: 2px;padding-bottom: 2px;width: 30%;float: right;"><button id=unstrobeBtn onclick="unstrobeFixture()">Unstrobe</button></div></td>
