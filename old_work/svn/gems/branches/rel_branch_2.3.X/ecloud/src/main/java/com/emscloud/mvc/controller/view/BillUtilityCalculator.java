...
public class BillUtilityCalculator {
	...
	public static String getSavingInPercentage()
	{
		...
		if(getCustomerSppaBill().getBaselineEnergy().intValue()>0)
		{
	...
	public static String getPrevAmtDue() {
		usdCostFormat.setMaximumFractionDigits(2);
		CustomerSppaBill custSppaBill = getCustomerSppaBill();
		Double prevAmtDue = custSppaBill.getPrevAmtDue();				
		if(prevAmtDue!=null)
