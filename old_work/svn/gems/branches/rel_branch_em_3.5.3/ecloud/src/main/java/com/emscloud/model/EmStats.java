...
public class EmStats implements Serializable {
	...
	@Transient
	@XmlElement(name = "UtcCaptureAt")
	public String getUtcCaptureAt() {
		return UtcCaptureAt;
	}

	public void setUtcCaptureAt(String utcCaptureAt) {
		UtcCaptureAt = utcCaptureAt;
	}
