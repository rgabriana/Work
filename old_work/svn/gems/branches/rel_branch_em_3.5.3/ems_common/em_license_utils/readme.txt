...
2.execute the following command (example : java -jar target/em_license_utils.jar uuid=b3a03d8f-55c4-42ed-9faa-d908720cfb92 em_devices=2000 bacnet=false bacnet_devices=0 zoneSensorsEnabled=false noOfZoneSensors=0 hvac=false emProductId=EM-SW-1000 occupancySensorEnabled=false > filePath/licensefilename.license )
...
12.all the above nine parameters are mandatory.