...
public class PlugloadProfileHandler implements Serializable {
    ...
    public byte[] getProfileByteArray(PlugloadProfile mornProfile, PlugloadProfile dayProfile, PlugloadProfile evenProfile, PlugloadProfile nightProfile) {

        byte[] profileArray = new byte[72]; // morn, day, even, night * 6 profile attributes
        int index = 0;
        // morning
        profileArray[index++] = mornProfile.getMode();
        ServerUtil.fillShortInByteArray(mornProfile.getActiveMotion(), profileArray, index);
     	index += 2;
     	ServerUtil.fillShortInByteArray(mornProfile.getManualOverrideTime(), profileArray, index);
     	index += 2;
        // pad with 9 bytes
        for (int i = 0; i < 13; i++) {
        ...
        // day
        profileArray[index++] = dayProfile.getMode();
        ServerUtil.fillShortInByteArray(dayProfile.getActiveMotion(), profileArray, index);
     	index += 2;
     	ServerUtil.fillShortInByteArray(dayProfile.getManualOverrideTime(), profileArray, index);
     	index += 2;
        // pad with 9 bytes
        for (int i = 0; i < 13; i++) {
            profileArray[index++] = 0;
        ...
        // evening
        profileArray[index++] = evenProfile.getMode();
        ServerUtil.fillShortInByteArray(evenProfile.getActiveMotion(), profileArray, index);
     	index += 2;
     	ServerUtil.fillShortInByteArray(evenProfile.getManualOverrideTime(), profileArray, index);
     	index += 2;
        // pad with 9 bytes
        for (int i = 0; i < 13; i++) {
            profileArray[index++] = 0;
        ...
        // night
        profileArray[index++] = nightProfile.getMode();
        ServerUtil.fillShortInByteArray(nightProfile.getActiveMotion(), profileArray, index);
     	index += 2;
     	ServerUtil.fillShortInByteArray(nightProfile.getManualOverrideTime(), profileArray, index);
     	index += 2;
        // pad with 9 bytes
        for (int i = 0; i < 13; i++) {
            profileArray[index++] = 0;
