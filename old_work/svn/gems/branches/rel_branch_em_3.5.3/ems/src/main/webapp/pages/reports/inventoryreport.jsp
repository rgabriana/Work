	...
	<div class="outermostdiv">
		...
		<div class="innerdiv">
			...
			<div style="float:right;padding-bottom: 10px;padding-right: 10px;">	
				<button id="exportInventoryReportBtn" onclick="exportInventoryReport ();">Export CSV</button>
			</div>
					<div class="settingAccordionFormDiv">
							<fieldset  style="width:97.5%">
								<legend><span class="settingAccordionFormDivHeader"></span></legend>
					...
					<th class="fieldHeader" >
					<b>Count (${totalErcCount})</b>
					</th>
 					<c:forEach items='${totalErcAssociated}' var='ercObj'>
					<tr>
...
<form id='exportIRForm' action=<spring:url value='/services/inventoryreport/getexportdata'/> method='POST'></form>
</body>
</html>
<script type="text/javascript">
	$(function() {
