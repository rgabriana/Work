...
<div id="mForm" style="margin-left:50px;margin-top:20px;height:300px; overflow: auto;">		
			...
			<div class="fieldValue1" style="display:inline-block;padding-left: 10px;"><select id="fixtureClassBallasts" style="width:100%; height:100%;min-width:210px;"></select></div>
			...
			<div class="fieldValue1" style="display:inline-block;padding-left: 10px;"><select id="fixtureClassNoOfBallasts" name="fixtureClassNoOfBallasts" style="min-width:215px;"></select></div>
			<br style="clear:both;"/>			
			</div>	
			...
			<div class="fieldValue1" style="display:inline-block;padding-left: 10px;"><select id="fixtureClassBulbs" style="width:100%; height:100%;min-width:215px;"> </select></div>
			...
			<div class="fieldValue1" style="display:inline-block;padding-left: 10px;"><select id="fixtureClassVoltage" name="fixtureClassVoltage" style="min-width:215px;"></div>			
			<br style="clear:both;"/>					
			</div>			
