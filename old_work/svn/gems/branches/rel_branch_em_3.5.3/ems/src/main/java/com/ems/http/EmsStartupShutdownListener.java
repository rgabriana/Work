...
import com.ems.service.BacnetSchedulerManager;
...
public class EmsStartupShutdownListener implements ServletContextListener {
	...
	public void contextDestroyed(ServletContextEvent context) {
		...
		BacnetSchedulerManager bacnetSchedulerManager = (BacnetSchedulerManager) SpringContext
		.getBean("bacnetSchedulerManager");
		...
		try {
			EmailManager emailManager = (EmailManager) SpringContext.getBean("emailManager");
			emailManager.shutdownAndAwaitTermination();
		} catch (Exception e){
			e.printStackTrace();
		}
