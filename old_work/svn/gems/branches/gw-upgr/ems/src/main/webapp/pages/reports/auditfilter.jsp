...
<div class="innerContainer">
	<div class="formContainer">
		<form id="filterform" onsubmit="submitfilter(); return false;">
			...
			<div class="field">
				<div class="formPrompt"><span><spring:message code='audit.filter.ipAddress'/></span></div>
				<div class="formValue"><input id="ipAddressSearch" name="ipAddressSearch" type="text" /></div>
			</div>
			<div class="field">
...
function submitfilter() {
	...
	var userdata = '1' + "#" +
					...
					$('#startDatePicker').val() + "#" + 
					$('#endDatePicker').val() + "#" +
					encodeURIComponent($.trim($('#ipAddressSearch').val())) + "#" + "END";
	//alert(userdata);
