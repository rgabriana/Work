...
function ModifyGridDefaultStyles() {  
	   $('#' + "aggf-new-fixture-table" + ' tr').removeClass("ui-widget-content");
	   $('#' + "aggf-new-fixture-table" + ' tr:nth-child(even)').addClass("evenTableRow");
	   $('#' + "aggf-new-fixture-table" + ' tr:nth-child(odd)').addClass("oddTableRow");
}
