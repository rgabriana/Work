...
var confirmFixtureRmaMonoShotTimer;

function rmaDevice(fixtureId, fixtureName, fixtureVersion) {
	if(fixtureRmaTimerInProgress == 0){
		confirmFixtureRmaMonoShotTimer = setTimeout(rmaDeviceConfirm, 1000, fixtureId, fixtureName, fixtureVersion);
		fixtureRmaTimerInProgress = 1;
	}
}

function rmaDeviceConfirm(fixtureId, fixtureName, fixtureVersion){
	clearTimeout(confirmFixtureRmaMonoShotTimer);
	fixtureRmaTimerInProgress = 0;
	if(!validateFixtureForm()){
		return false;
	}
