   ...
   */
    ...
    private void startSSLServer() {
        ...
        try {
			...
			ssocket.setEnabledCipherSuites(SSLSessionManager.listIntersection(SSLConstants.TLS_CIPHER_SUITES, ssocket.getSupportedCipherSuites()));
			ssocket.setEnabledProtocols(SSLSessionManager.listIntersection(SSLConstants.TLS_PROTOCOL_VERSIONS, ssocket.getSupportedProtocols()));
