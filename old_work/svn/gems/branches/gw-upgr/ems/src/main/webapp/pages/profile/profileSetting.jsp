				...
				<table class="entable rhtinput" style="width: 100%; height: 100%;">
					<thead>
						<tr>
							...
							<th  align="left" title="The minimum level between 0 and 100 percent to set the light. Setting the value to 0 allows a light to be turned completely off when no occupant is present or there is an abundance of ambient light. Typically this should either be zero for a private office, or a value around 25 for an open office."><spring:message code="profile.settings.min.level"/></th>
							<th  align="left" title="The maximum level between 0 and 100 percent to set the light. This is the value to be reduced when there is too much illumination by the light. Typically the value would be 80, which would be reduced to no more than 25 or 30."><spring:message code="profile.settings.max.level"/></th>
							...
							<th  align="left" title="The length of time to hold a light on after no additional motion has been detected. During periods when it is expected that the lights should be on, such as during the day on week days, the value should be a longer length of time, such as 15 minutes. Other times, a short length, such as 3 minutes, should be used. When the occupants under the fixture are very still, the value may be increased to a larger value, such as 30 minutes."><spring:message code="profile.settings.active.motion.window"/></th>
