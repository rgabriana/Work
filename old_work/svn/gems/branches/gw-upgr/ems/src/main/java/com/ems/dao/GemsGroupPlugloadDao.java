...
public class GemsGroupPlugloadDao extends BaseDaoHibernate {
	...
	public void deleteGemsGroupPlugloadById(Long groupId) {
	...
	public void deleteGemsGroupsFromPlugload(Long plugloadId) {
		String hsql = "delete from GemsGroupPlugload where plugload.id=?";
        Query q = getSession().createQuery(hsql.toString());
