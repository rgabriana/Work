...
ALTER TABLE energy_consumption ALTER COLUMN avg_temperature TYPE numeric(7,2);
ALTER TABLE energy_consumption_hourly ALTER COLUMN avg_temperature TYPE numeric(7,2);
ALTER TABLE energy_consumption_daily ALTER COLUMN avg_temperature TYPE numeric(7,2);
