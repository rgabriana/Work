...
public class ReplicaServerManageService {
    ...
    public List<ReplicaServer> getReplicaServerList() {
    	List<ReplicaServer> replicaServers = emInstanceManager.getAllReplicaServerWithEMCount();//replicaServerManager.getAllReplicaServers();
    ...
    public void deleteReplicaServer(@PathParam("id") Long id) {
		...
		cloudAuditLoggerUtil.log("Deleted Replica server: "+replicaServer.getName()+" ( Mac Id :"+replicaServer.getMacId()+" )", CloudAuditActionType.Replica_Server_Deleted.getName());
