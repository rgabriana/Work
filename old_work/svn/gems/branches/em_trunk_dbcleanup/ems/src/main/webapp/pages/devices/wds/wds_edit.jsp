...
<div id = "wdseditboxButton" align="left" >
 <table id="wdsedit-wrapper-table" style="padding-left: 10px;">	
	<tr>		
		<td height=auto align="right">			
			<button id="wdsedit-apply-btn" onclick=apply_button_clicked()>Apply</button>
			<button id="wdsedit-done-btn" onclick=exitWindowDialog()>Cancel</button>
		</td>
	</tr>
</table> 
