...
public class DeviceInfo {
  ...
  private Fixture fixture = null;
  private FixtureCurrentData fixCurrData = null;
  ...
  public DeviceInfo(Fixture fixture) {
    ...
    this.fixCurrData = fixture.getCurrentData();
    if(fixCurrData != null) {
      this.lastStatsRcvdTime = fixCurrData.getLastStatsRcvdTime();
    } else {
  ...
  /*
  public DeviceInfo(Fixture fixture, FixtureCurrentData currData) {
    this.fixture = fixture;
    this.fixtureName = fixture.getFixtureName();
    this.dbId = fixture.getId();
    this.commType = fixture.getCommType();
    this.fixCurrData = currData;
    this.lastStatsRcvdTime = fixCurrData.getLastStatsRcvdTime();
    System.out.println("inside the device last stats time -- " + this.lastStatsRcvdTime);
  }
*/
