...
public class Fixture extends Device implements Serializable {
    ...
    private FixtureCurrentData currentData;
     ...
     *            the currData to set
     */
    public void setCurrentData(FixtureCurrentData currData) {
      if(currData != null) {
     ...
     * @return the currData
     */
    public FixtureCurrentData getCurrentData() {
        return currentData;
    }
	...
	private void copyCurrentData() {
	
	  lastConnectivityAt = currentData.getLastConnectivityAt();
	  lightLevel = currentData.getLightLevel();
	  dimmerControl = currentData.getDimmerControl(); 
	  wattage = currentData.getWattage();
	  lastStatsRcvdTime = currentData.getLastStatsRcvdTime();
	  lastOccupancySeen = currentData.getLastOccupancySeen();
	  profileChecksum = currentData.getProfileChecksum();
	  globalProfileChecksum = currentData.getGlobalProfileChecksum();
	  avgTemperature = currentData.getAvgTemperature();
	  currentState = currentData.getCurrentState();
	  currApp = currentData.getCurrApp();
	  baselinePower = currentData.getBaselinePower();
	  bulbLife = currentData.getBulbLife();
	      	      
	} //end of method copyCurrentData
