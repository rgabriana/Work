...
public class HvacDeviceStatusCache {
	...
	public DeviceResponse getFunctionResponseForDevice(String controllerId,String sDeviceId,
			String sFunctionId, String args) {
		String strDeviceAndFunctionId = controllerId+"_"+sDeviceId + "_" + sFunctionId + "_"
				+ args;
	...
	public void setFunctionResponseForDevice(String controllerId,String sDeviceId,
