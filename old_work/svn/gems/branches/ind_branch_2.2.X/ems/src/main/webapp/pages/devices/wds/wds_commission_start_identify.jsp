...
function setGatewayData(){
	...
	if(gw_cnt==0){
		displayFxInitialMessage("There is no commissioned Gateway in this floor. EWS cannot be commissioned without a commissioned Gateway.", COLOR_FAILURE);
...
<div id="fc-identify-wrapper" style="height:100%; width:100%;">
	<div class="fcsi-north">
		<textarea id="details-message-wds">Simultaneously, press and hold down the second and forth buttons until the green LED blinks. When done correctly, the LEDs will continue to slowly blink until 5 minutes has elapsed, the EWS has been commissioned, or another button is pressed.</textarea>
	</div>
<div class="fcsi-body">
