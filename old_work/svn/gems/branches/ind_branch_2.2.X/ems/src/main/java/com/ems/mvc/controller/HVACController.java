...
public class HVACController {
    ...
    public String loadHvacDetails(Model model,@RequestParam("controllerid") String controllerid,@RequestParam("hvacId") String hvacId) {
	...
	public String updateHvac(HVACDevice device) {
		...
		savedDevice.setControllerId(device.getControllerId());
