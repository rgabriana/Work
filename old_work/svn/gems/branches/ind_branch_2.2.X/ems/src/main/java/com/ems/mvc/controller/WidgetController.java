...
/*        if(switchGroup == null) {
    ...
    public String createNewSwitch(@RequestParam("switchName") String switchName, @RequestParam("fixtureVersion") String fixtureVersion, @CookieValue(FacilityCookieHandler.selectedFacilityCookie) String cookie) {
	...
	public String editAndApplyGroupChanges(@ModelAttribute("gemsGroup") MotionGroup motionGroup, @RequestParam("groupId") Long groupId, Locale local) {
    	...
    	if(motionGroup.getGemsGroup()!=null)
