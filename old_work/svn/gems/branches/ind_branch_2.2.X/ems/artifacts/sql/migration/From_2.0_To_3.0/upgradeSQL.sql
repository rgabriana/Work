...
INSERT INTO event_type (id, "type", description) VALUES ((select coalesce(max(id),0)+1 from event_type), 'EWS Discovery', NULL);
INSERT INTO event_type (id, "type", description) VALUES ((select coalesce(max(id),0)+1 from event_type), 'Commissioning', NULL);
INSERT INTO event_type (id, "type", description) VALUES ((select coalesce(max(id),0)+1 from event_type), 'EWS Commissioning', NULL);
...
INSERT INTO event_type (id, "type", description) VALUES ((select coalesce(max(id),0)+1 from event_type), 'EWS Upgrade', NULL);
...
ALTER TABLE hvac_devices ADD COLUMN controller_id character varying;