...
Fetch hvac devices
--------------------------------------------------------------------------------
curl --get -b cookie.tmp -k https://localhost:8443/ems/services/org/hvac/list/{property}/{pid}

--------------------------------------------------------------------------------
commission hvac devices
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @hvac.data -k https://localhost:8443/ems/services/org/hvac/commission

--------------------------------------------------------------------------------
Used by modbus module to update hvac devices response to its functions
--------------------------------------------------------------------------------
curl -v -X POST -H"Content-Type: application/xml" -d @hvacresponse.data -k https://localhost:8443/ems/services/org/hvac/status/device/{deviceid}/function/{functionid}

--------------------------------------------------------------------------------
control hvac devices from UI
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -k https://localhost:8443/ems/services/org/hvac/op/device/{deviceid}/function/{functionid}/{args:.*}

--------------------------------------------------------------------------------
get hvac devices function status - Used by UI to keep on updating the status screen
--------------------------------------------------------------------------------
curl --get -b cookie.tmp -k https://localhost:8443/ems/services/org/hvac/op/status/device/{deviceid}/function/{functionid}
