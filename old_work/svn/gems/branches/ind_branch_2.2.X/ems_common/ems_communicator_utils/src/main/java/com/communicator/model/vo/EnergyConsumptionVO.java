...
public class EnergyConsumptionVO implements IData {
    ...
    public EnergyConsumptionVO(Long id, BigDecimal powerUsed, Date captureAt) {
        this.id = id;
        this.powerUsed = powerUsed;
        this.captureAt = captureAt;
    }

    public EnergyConsumptionVO(Long id, String name, BigDecimal powerUsed) {
        this.id = id;
        this.powerUsed = powerUsed;
        this.name = name;
    }
    public EnergyConsumptionVO(Long id, Short minTemperature,
			Short maxTemperature, Short avgTemperature, Short lightOnSeconds,
			Short lightMinLevel, Short lightMaxLevel, Short lightAvgLevel,
			Short lightOn, Short lightOff, BigDecimal powerUsed, Short occIn,
			Short occOut, Short occCount, Short dimPercentage, Short dimOffset,
			Short brightPercentage, Short brightOffset, Date captureAt,
			long fixtureId, String name, Float cost, Float price,
			BigDecimal basePowerUsed, Float baseCost,
			BigDecimal savedPowerUsed, Float savedCost, BigDecimal occSaving,
			BigDecimal tuneupSaving, BigDecimal ambientSaving,
			BigDecimal manualSaving, Short zeroBucket, Short avgVolts,
			Short currState, Short powerCalc, Long motionBits, Long energyCum,
			Integer energyCalib, Short minVolts, Short maxVolts,
			Integer energyTicks, Short lastVolts, Short savingType,
			Integer cuStatus) {
		super();
		this.id = id;
