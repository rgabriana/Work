...
public class ApplicationEntryPointController {
	...
	public String createCompany(@RequestParam("newPassword")String password, @ModelAttribute("company") Company company) {

		if(!passwordValidator.validate(password)){
			final String err = "Password "+password+" does not meet the policy criteria";
			userAuditLoggerUtil.log(err,UserAuditActionType.Organization_Update.getName());
	...
	public String entryPoint(HttpServletRequest request, HttpServletResponse response) {
	   ...
	   isForgotPasswordLoginRequest = !StringUtils.isEmpty(user.getForgotPasswordIdentifier()); 
	   ...
	   if(systemConfiguration != null && "true".equalsIgnoreCase(systemConfiguration.getValue())){
