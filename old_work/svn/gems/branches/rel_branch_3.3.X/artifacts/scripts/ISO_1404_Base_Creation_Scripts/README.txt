...
1. First download Ubuntu 14.04 AMD-64 Server version ISO from a Ubuntu mirror closest to you.
...
4. Copy the preseed and scripts folders adjacent to this README.txt file into you home folder.
