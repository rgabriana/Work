...
function startBillSiteAnomolies(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#billanamoliesTable").jqGrid({
			...
			colNames: ["id", "Geo Location", "Report Date","Start Date", "End Date","Issue","Details","Action"],
		       ...
		       { name: "reportDate", index: 'reportDate',formatter: billanomaliesdateformatter, sortable:true,width:'6%'},
		       { name: "startDate", index: 'startDate',formatter: billanomaliesdateformatter, sortable:true,width:'6%'},
		       { name: "endDate", index: 'endDate',formatter: billanomaliesdateformatter, sortable:true,width:'6%'},
...
function billanomaliesdateformatter(cellvalue, options, rowObject)
{
