...
--------------------------------------------------------------------------------
Bulk Assignment of Profile to fixtures
assignprofile.data: Is a file: contents shown below
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @assignprofile.data -k https://localhost:8443/ems/services/org/profile/bulkassign/{currentprofile}/{groupid}
{
	@assignprofile.data = "<fixtures><fixture><id>1</id></fixture><fixture><id>2</id></fixture></fixtures>"
}
...
--------------------------------------------------------------------------------
Manage Motion Group Fixtures - Add / Remove with default values
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @gemsgroupfixture.data -k https://localhost:8443/ems/services/org/motiongroup/updatemotiongroupfixtures/{gemsgroupid}

--------------------------------------------------------------------------------
Update Motion Group Fixtures - 
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @gemsgroupfxdetails.data -k https://localhost:8443/ems/services/org/motiongroup/updatemotiongroupfixturesdetails/{gemsgroupid}

--------------------------------------------------------------------------------
Send details params to Motion Group Fixtures - 
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml"  -k https://localhost:8443/ems/services/org/motiongroup/applymotiondetailstofixtures/{gemsgroupid}
...
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @fixture.data -k https://localhost:8443/ems/services/org/fixture/op/hopper/{enabled}

--------------------------------------------------------------------------------
Unstrobe selected fixture(s)
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @fixture.data -k https://localhost:8443/ems/services/org/fixture/op/unstrobe/gateway/{gatewayId}

--------------------------------------------------------------------------------
Identify selected fixture
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -k https://localhost:8443/ems/services/org/fixture/op/identify/fixture/{fixtureId}

--------------------------------------------------------------------------------
Reboot gateway system
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -k https://localhost:8443/ems/services/org/gateway/reboot/{gwId}

--------------------------------------------------------------------------------
Upload fixture calibration info
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @fixturecalibrationinfo.data -k https://localhost:8443/ems/services/org/fixture/op/savecalibration

--------------------------------------------------------------------------------
Get Fixture Baseline (context Lamp calibration)
--------------------------------------------------------------------------------
curl -v -X POST -b cookie.tmp -H"Content-Type: application/xml" -d @fixture.data -k https://localhost:8443/ems/services/org/fixture/op/getbaseline/action/{calibration}
