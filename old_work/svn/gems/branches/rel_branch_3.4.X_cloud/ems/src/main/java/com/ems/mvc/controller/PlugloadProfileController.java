...
public class PlugloadProfileController {
	...
	@ResponseBody
	    public String uploadPlugloadProfile(HttpServletRequest request,@RequestParam("upload") MultipartFile file,Model model,Locale locale) throws JAXBException, XMLStreamException, IOException {
	        String content="";
	        String message="";
	        if(file!=null)
	        {
