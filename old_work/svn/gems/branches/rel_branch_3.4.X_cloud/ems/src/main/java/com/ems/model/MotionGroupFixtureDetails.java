...
public class MotionGroupFixtureDetails implements Serializable {
    ...
    @XmlElement(name = "id")
	private Long id;
	private GemsGroupFixture gemsGroupFixture;
	...
	public MotionGroupFixtureDetails() {
	...
	public GemsGroupFixture getGemsGroupFixture() {
		return gemsGroupFixture;
	}

	public void setGemsGroupFixture(GemsGroupFixture gemsGroupFixture) {
		this.gemsGroupFixture = gemsGroupFixture;
	}
	...
	public void copy(MotionGroupFixtureDetails mgfd) {
		this.type = mgfd.type;
