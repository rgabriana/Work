...
public class Communication {
	...
	public Communication(String url, String contentType) {
		int timeout = 60 * 1000;
		try {
	...
	public Communication(String url, String sessionId, String type, int timeout, String contentType, String acceptType) {
