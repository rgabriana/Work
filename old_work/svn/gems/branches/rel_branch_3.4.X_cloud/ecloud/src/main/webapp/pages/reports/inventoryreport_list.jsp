...
function start(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#inventorySummaryTable").jqGrid({
			...
			scrollOffset: 0,
			forceFit: true,
			colNames: ["id", "Name", "Geo Location","Fixture Count", "Sensor Count","Gateway Count","Ballast Count","Lamps Count","ERC Count","Action"],
		       colModel: [
		       ...
		       { name: "ercCount", index: 'ercCount',sortable:false,width:'6%',search:false,},
