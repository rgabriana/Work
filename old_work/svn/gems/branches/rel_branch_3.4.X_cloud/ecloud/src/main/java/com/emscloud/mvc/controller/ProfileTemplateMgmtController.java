...
public class ProfileTemplateMgmtController {
	...
	*/
	...
	public String manageProfileTemplate(Model model,@CookieValue(FacilityCookieHandler.selectedFacilityCookie) String cookie,@RequestParam("customerId") long customerId)
	{
