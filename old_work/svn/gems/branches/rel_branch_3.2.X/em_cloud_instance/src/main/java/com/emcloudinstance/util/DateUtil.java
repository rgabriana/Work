...
public class DateUtil {
    ...
    public static Date truncateToPrevSlotsXmin(Date truncateDate, final int interval) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(truncateDate);
        calendar.set(Calendar.SECOND, 0);
        calendar.set(Calendar.MILLISECOND, 0);
    ...
    public static Date truncateToFutureSlotsXmin(Date truncateDate, final int interval) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(truncateDate);
        calendar.set(Calendar.SECOND, 0);
        calendar.set(Calendar.MILLISECOND, 0);
