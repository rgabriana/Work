...
function loadPlugloadProfileTabs(){
	//console.log("In plugloadprofiletreenodeclick 1");
	if(plugloadProfilenodetype=='plugloadtemplate')
	{
		$("#liecplugload").hide();
		$("#liefplugload").hide();
		//console.log("In plugloadprofiletreenodeclick 2");
		...
		if(plugloadtemplatetabselected == "plugloadtemplatedevices"){
			//console.log("In plugloadprofiletreenodeclick 3");
			$("#plugloadtemplatedevices").click();
		}else if(plugloadtemplatetabselected == "plugloadtemplatesettings"){
			//console.log("In plugloadprofiletreenodeclick 4");
			$("#plugloadtemplateps").click();
		}else{
			//console.log("In plugloadprofiletreenodeclick 5");
			$("#plugloadtemplatedevices").click();
		}
	}else if(plugloadProfilenodetype=='plugloadgroup')
	{
		$("#liecplugload").show();
		$("#liefplugload").show();
		//console.log("In plugloadprofiletreenodeclick 6");
		$.cookie('em_plugload_profile_nodetype_selected', 'plugloadgroup',  {path: '/' });
		plugloadprofilenodetypeselected = "plugloadgroup";
		if(plugloadtemplatetabselected == "plugloadtemplatedevices"){
			//console.log("In plugloadprofiletreenodeclick 7");
			$("#plugloadtemplatedevices").click();
		}else if(plugloadtemplatetabselected == "plugloadtemplatesettings"){
			//console.log("In plugloadprofiletreenodeclick 8");
			$("#plugloadtemplateps").click();
		}else if(plugloadtemplatetabselected == "plugloadenergyconsumption"){
			//console.log("In plugloadprofiletreenodeclick 9");
			$("#ec_plugload").click();
		}else if(plugloadtemplatetabselected == "plugloadevents"){
			//console.log("In plugloadprofiletreenodeclick 10");
			$("#efplugload").click();
		}else{
			//console.log("In plugloadprofiletreenodeclick 11");
			$("#plugloadtemplatedevices").click();
		}
	}
	//console.log("In plugloadprofiletreenodeclick 12");
}
...
function assignProfileToPlugload(selPlugloads,role){
	//PLEASE CHANGE THIS METHOD W.R.T PLUGLOADS ACCORDINGLY
	if(selPlugloads != undefined) {
		SELECTED_FIXTURES_TO_UPDATE_PROFILE = eval("("+selPlugloads+")");	
	}
	var width;
	var height;
	var pageUrl;
	...
	$("#assignProfileToFixturesDailog").load(pageUrl+"?ts="+new Date().getTime(), function() {
		$("#assignProfileToFixturesDailog").dialog({
			modal:true,
			title: 'Assign profile to Plugloads',
			width :width,
			height : height,// Math.floor($('body').height() * .30),
			close: function(event, ui) {
				SELECTED_FIXTURES_TO_UPDATE_PROFILE = []; //Reset global variable 'SELECTED_FIXTURES_TO_UPDATE_PROFILE'
...
function showSwitchPrompt(selFixtures, swVersion, bulkConfigure){	
...
function showGroupPrompt(selFixtures, grVersion){	
