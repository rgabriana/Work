...
$(document).ready(
	function() {
		...
		localTemplateData.templateName = "template_"+"${template.nodeId}";
		...
		localProfileData.profileName = "group_"+"${profile.nodeId}";
		...
		INITIAL_PROFILE_FILTER_DATA = getFormValuesJSON("PlugloadTemplateProfileAssignmentForm");
