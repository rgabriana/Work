	...
	<div class="login">
		...
		<div class="loginForm">
			...
			<form method="post" name="loginForm"
				...
				<a id="forgotpassword" href="_new" ><span><spring:message	code="login.forgotpassword.label"/></span></a>
				</div>
				 -->
				<!--<div class="loginsignup"><input class="submitAction" type="submit" value='Signup'/></div>-->
			</form>
			<script type="text/javascript">
			var recoverylockout_url = location.protocol + '//' + location.host
			+ '/em_mgmt/recoverylockout/';
			
			$("#forgotpassword").attr("href", recoverylockout_url);
		</script>
		</div>
	</div>
