		...
		try {
			...
			if (gatewayIds != null && gatewayIds.length() > 0) {
				...
				if (gwImageFileName != null) {
					...
					gwJob.setNoOfRetries(ImageUpgradeSO.IMG_DEFAULT_FAIL_RETRIES);
					jobList.add(gwJob);
			...
			if (fixtureIds != null && fixtureIds.length() > 0) {
				...
				if (fxImageFileName != null) {
					...
					fixtureJob.setNoOfRetries(ImageUpgradeSO.IMG_DEFAULT_FAIL_RETRIES);
			...
			if (wdsIds != null && wdsIds.length() > 0) {
				...
				if (wdsImageFileName != null) {
					...
					wdsJob.setNoOfRetries(ImageUpgradeSO.IMG_DEFAULT_FAIL_RETRIES);
					jobList.add(wdsJob);
			...
			if (plugloadIds != null && plugloadIds.length() > 0) {
				...
				if (plugloadImageFileName != null) {
					...
					plugloadJob.setNoOfRetries(ImageUpgradeSO.IMG_DEFAULT_FAIL_RETRIES);
