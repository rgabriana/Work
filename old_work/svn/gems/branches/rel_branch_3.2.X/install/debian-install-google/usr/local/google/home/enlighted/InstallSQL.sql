	...
	IF $1 > 0 THEN
		...
		IF day_type = 'weekday'
		   THEN 
		    ...
		    ELSEIF quadrant_type = 'day' 
		       THEN  profile_id := day_profile_id from  plugload p, plugload_groups g, plugload_profile_handler pr where g.profile_handler_id = pr.id and .group_id = g.id and p.id = $1;
		    ELSEIF quadrant_type = 'evening' 
