...
cd debian_orc
cp  ../install/google/debs/oracle-java8-installer_8u25+8u6arm-1~webupd8~1_all.deb .
cp ../artifacts/scripts/glem_installer.sh .
tar cvzf ${GEMS_REV}_orchestrator.tgz ${GEMS_REV}_orchestrator.deb oracle-java8-installer_8u25+8u6arm-1~webupd8~1_all.deb glem_installer.sh
rm oracle-java8-installer_8u25+8u6arm-1~webupd8~1_all.deb
rm glem_installer.sh
cd ..
