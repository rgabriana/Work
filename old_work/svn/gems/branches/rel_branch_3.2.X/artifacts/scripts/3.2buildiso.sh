...
sudo chown -R jenkins:nogroup $ROOTDIR
#cp /opt/enlighted/EnlightedServer1404_Base.iso $ROOTDIR/$LIVEDIR
...
mkdir mnt
sudo mount -o loop /opt/enLighted/EnlightedServer1404_Base.iso mnt
mkdir extract-cd
...
sudo chroot edit /tmp/3.2buildiso2.sh
