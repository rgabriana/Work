...
$().ready(function() {
	...
	//if(isBacnetEnabled == "false"){
		//$('#isBACnetEnabled').val("Stopped");
	//} else {
		//$('#isBACnetEnabled').val("Running");
	//}
	...
	<div class="innerContainer">
		<div class="formContainer">
			...
			<form:form id="bacnetConfig" commandName="bacnet" method="post"  onsubmit="return beforeSavingBacnetConfig();" action="${submit}">
				...
				<div class="field">
					<div class="formPrompt"><span>Status</span></div>
					<div class="formValue"><input id="isBACnetEnabled" value="" disabled="disabled" /></div>
				</div>
				<%-- <div class="field">
					...
					<span style="font-weight: normal;">&nbsp;&nbsp;Enabling detailed mode will introduce all sensors/plugloads into the BACnet network.</span>
				</div> --%>
				<div class="field">
