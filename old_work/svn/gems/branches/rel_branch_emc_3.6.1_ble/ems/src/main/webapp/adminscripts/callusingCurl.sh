...
source /etc/environment
        ...
        then
                ...
                echo "************************ OR *******************************************************"
                echo "callusingCurl admin -H \"Content-Type:multipart/form-data\" -X POST https://localhost/ems/api/org/email/v1/send -F \"recipient=dhanesh.rightedinc.com\" -F \"subject=HI\" -F \"message=MSG_HERE\" -F \"from=dhanesh.rote@enlightedinc.com\" -F \"file=@$ENLIGHTED_HOME/em_public.key\" "
               echo "callusingCurl admin  GET https://192.168.137.193/ems/api/org/user/list/admin"
                echo "callusingCurl admin -H \"Content-Type:application/xml\" -X POST https://192.168.137.222/ems/api/org/networksettings/apply/settings -d @$ENLIGHTED_HOMEpost.file"
        echo "for ((i=1; i <= 5 ; i++))do callusingCurl admin -H \"Content-Type:application/xml\" -X POST https://192.168.137.222/ems/api/org/networksettings/apply/settings -d @$ENLIGHTED_HOME/post.file;done;"
                echo "Exiting now....................................................."
                exit 1
        fi
