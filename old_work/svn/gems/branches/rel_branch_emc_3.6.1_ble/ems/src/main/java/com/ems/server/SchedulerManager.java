...
public class SchedulerManager {
    ...
    private SchedulerManager()
	{
        try 
        {
            ...
            eventMgr.addEvent("Started the Quartz scheduler with name " + quartzScheduler.getSchedulerName(), EventsAndFault.SCHEDULER_EVENT, EventsAndFault.INFO_SEV_STR);
    ...
    public void shutdownScheduler() {
    	try {
            ...
            eventMgr.addEvent("Quartz scheduler stopped", EventsAndFault.SCHEDULER_EVENT, EventsAndFault.INFO_SEV_STR);
