...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.validator.addMethod("fnameregx", function(value, element, regexpr) {          
			if (value != "") {
		...
		$.validator.addMethod("lnameregx", function(value, element, regexpr) {          
			if (value != "") {
				return regexpr.test(value);
			}
			return true;
...
<script type="text/javascript">
	...
	createUserValidatorObj.rules.firstName={fnameregx: /^[^|\:!?^<>~$%&*()\+=[\]{}`\'\":;]+$/},
	createUserValidatorObj.rules.lastName={lnameregx: /^[^|\:!?^<>~$%&*()\+=[\]{}`\'\":;]+$/},
	createUserValidatorObj.rules.contact={contactregx: /^[A-Za-z0-9\.\s\@\-\:\(\)\?]+$/}
