...
<spring:url value="/devices/fixtures/assignblemodetofixtures.ems" var="assignBleModeToFixturesDialogUrl" scope="request" />
...
function assignBleModeToFixtures(selFixtures){
	...
	$("#assignBleModeToFixturesDialog").load("${assignBleModeToFixturesDialogUrl}"+"?ts="+new Date().getTime(), function() {
		$("#assignBleModeToFixturesDialog").dialog({
			modal:true,
...
<div id="assignBleModeToFixturesDialog"></div>
