...
var PAGE = "${page}";
		...
		jQuery("#plugloadTable").jqGrid({
			...
			formatter: {
		   	...
		   	colModel:[
				...
				{name:'plugloadName', index:'plugloadName', sortable:true, width:"15%", formatter: plugloadNameRenderer, searchoptions:{sopt:['cn']}},
				...
				{name:'currentProfile', index:'currentProfile', sortable:true, width:"12%", searchoptions:{sopt:['cn']},formatter: profileNameRenderer},
		   		...
		   		{name:'state', index:'state', align:"right", hidden:(PAGE!="floor"),sortable:true , width:"12%", searchoptions:{sopt:['cn']}, formatter: plactionImageRenderer}
		   	],
		   	jsonReader: { 
		        root:"plugload", 
		        page:"page", 
	...
	function plactionImageRenderer(cellvalue, options, rowObject){
	 	var source = "";
