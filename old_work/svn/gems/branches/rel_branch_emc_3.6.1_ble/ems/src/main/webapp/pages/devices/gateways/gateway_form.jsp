...
// 	$("#lastConnectivityAt").val(getLastCommunicationsString(lastCommunicationDiffInMillis));
	...
	if("${dhcpenable}"=='true')			
	{			
		$("#gw_info_ipAddress").attr('disabled',true);
	}else{
		$("#gw_info_ipAddress").attr('disabled',false);
	}
...
<!--<div id="gateway_message" class="server_message" style="background-color: #EEEEEE; border: thin solid #AAAAAA; left: 494px; margin: auto; position: absolute; top: 200px; padding:2px;">
	...
	<fieldset class="column">
		...
		<form:input class="text" id="gw_info_ipAddress" name="ipAddress" size="40" path="ipAddress"/>
		...
		<label for="gw_info_modelNo"><spring:message code="gatewayForm.label.ModelNo"/></label>
		<form:input class="text readonly" id="gw_info_modelNo" name="modelNo" size="40" path="modelNo"/>
