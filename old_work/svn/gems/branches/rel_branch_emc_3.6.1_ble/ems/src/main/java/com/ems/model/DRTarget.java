...
public class DRTarget implements Serializable {
    ...
    //private Set<OverrideSchedulesFacility> overrideSchedulesFacility;
	...
	/*public void setOverrideSchedulesFacility(
			Set<OverrideSchedulesFacility> overrideSchedulesFacility) {
		this.overrideSchedulesFacility = overrideSchedulesFacility;
	}

	public Set<OverrideSchedulesFacility> getOverrideSchedulesFacility() {
		return overrideSchedulesFacility;
	}*/
}
