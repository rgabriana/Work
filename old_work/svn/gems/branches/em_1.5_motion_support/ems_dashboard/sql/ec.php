<?php
	...
	function addHeader()
	{
		echo "\ninsert into energy_consumption (id, gems_id, tenants_id, power_used, base_power_used, cost, base_cost, occ_saving, tuneup_saving, ambient_saving, manual_saving,totalfixturecontributed,price,saved_power_used,saved_cost,capture_at) values ";
	}
	...
	function Insert_energy_consumption($capture_date, $uid, $hour, $fid)
	{
		...
		echo "("   .  $uid . "," .  $gems_id . ","  .  $tenants_id . "," .  $power_used . "," .  $base_power_used . "," .  $cost . "," .  $basecost . "," .  $occ_saving . "," .  $tuneup_saving . "," .  $ambinet_saving . "," .  $manual_saving .  "," .  $totalfixturecontributed .  "," .  $price .  "," .  $saved_power_used .  "," .  $saved_cost . ",'". $capture_date ."')";
	...
	function help()
	{
		...
		echo "php ec.php year 2010 months 1 fixture 1 > ecdata"; 
