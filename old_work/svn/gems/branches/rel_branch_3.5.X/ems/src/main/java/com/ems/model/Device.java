...
/**
 * @param pcbaPartNo the pcbaPartNo to set
 */
...
/**
 * @param pcbaSerialNo the pcbaSerialNo to set
 */
public void setPcbaSerialNo(String pcbaSerialNo) {
	if(pcbaSerialNo != null && pcbaSerialNo.matches(regExprValidation) == true)
...
/**
 * @param hlaPartNo the hlaPartNo to set
 */
...
/**
 * @param hlaSerialNo the hlaSerialNo to set
 */
public void setHlaSerialNo(String hlaSerialNo) {
	if(hlaSerialNo != null && hlaSerialNo.matches(regExprValidation) == true)
