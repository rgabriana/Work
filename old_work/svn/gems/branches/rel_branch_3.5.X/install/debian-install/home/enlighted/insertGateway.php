...
function updateGateway($ipAddress, $macAddress) {
  ...
  if( $ip_prev !== $ipAddress ){
        ...
        $link = "sh /var/lib/tomcat6/webapps/ems/adminscripts/callusingCurl.sh admin  -H \"Content-Type:application/xml\" -X POST https://localhost/ems/api/org/gateway/updateGatewayIP/macaddr/$macAddress/ipaddr/$ipAddress";
