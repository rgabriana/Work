...
sudo sed -i s/GRUB_CMDLINE_LINUX_DEFAULT=\"quiet\ splash\"/GRUB_CMDLINE_LINUX_DEFAULT=\"net.ifnames=1\ biosdevname=0\ quiet\ splash\"/g /etc/default/grub
sudo grub-mkconfig > test
sudo mv test /etc/default/grub.cfg
