...
<style>
#wds-details-wrapper .fieldWrapper{padding-bottom:4px;width:100%;}
#wds-details-wrapper .fieldlabel{float:left; height:22px; width: 14%; font-weight: bold;}
</style>
...
<body id="wdsdetails-main-box" >

<div id = "wdsdetailsbox" align="left" >

<div id = "wds-details-wrapper" style="height:100%; width:95%;padding-left: 10px;">
<div style="height:3px;"></div>

<div class="fieldWrapper" >
			<div class="fieldlabel" >Name : </div>
			<div class="fieldlabel"><c:out value="${wds.name}"></c:out></div>			
			<br style="clear:both;"/>			
</div>

<div class="fieldWrapper">
			<div class="fieldlabel" >Model : </div>
			<div class="fieldlabel"><c:out value="${wds.modelNo}"></c:out></div>			
			<br style="clear:both;"/>
</div>
</div>
...
<table id="wdsdetailsTable" class="entable" style="width: 95%; height: 100%;">
<thead>
