...
function billpaymentlistcustomdateformatter(cellvalue, options, rowObject)
{
...
function start(pageNum, orderWay) {
		jQuery("#billingPaymentTable").jqGrid({
			...
			colNames: ["id", "Customer ID", "Payment Date","Bill Paid Amount ($)"],
		       ...
		       { name: "paymentDate", index: 'paymentDate', width:'10%',formatter:billpaymentlistcustomdateformatter,align: "center" },
