...
public class ProfileHandler implements Serializable, Cloneable {
     ...
     */
    public Byte getProfileGroupId() {
        return profileGroupId;
    }

    public void setProfileGroupId(Byte profileGroupId) {
    ...
    private short convertProfileTimeToShort(String time) {
        ...
        boolean night = true;
        if (time.subSequence(time.length() - 2, time.length()).equals("AM")) {
            night = false;
        }
