...
public class LocatorDeviceService {
     ...
     */
    @Path("add/name/{name}/locatorDeviceType/{locatorDeviceType}/floorId/{floorId}/xaxis/{xaxis}/yaxis/{yaxis}")
    @POST
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public Response addLocatorDevice(@PathParam("name") String name,
            @PathParam("locatorDeviceType") String locatorDeviceType, @PathParam("floorId") String floorId , @PathParam("xaxis") String xaxis,@PathParam("yaxis") String yaxis) {
        Response resp = new Response();
        locatorDeviceManager.addLocatorDevice(name, locatorDeviceType, floorId,xaxis,yaxis); 
     ...
     * @return Response status
     */
    @Path("update/name/{name}/id/{id}")
    @POST
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public Response updateLocatorDevice(@PathParam("name") String name,
            @PathParam("id") String id) {
        Response resp = new Response();
        locatorDeviceManager.updateLocatorDevice(id,name); 
