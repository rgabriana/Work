				...
				<td align="right" style="padding-right:5px;width:25%;">					
					<div>
						<form id="user-details" method="post" onsubmit="return beforeDeleteUser();" action="${actionURL}">
							...
							<input type="button" id="${user.email}_assignFacilityBtn" onclick="return assignFacility('${assignFacilityUserUrl}/${user.id}/assignFacilityUser.ems');" value="Assign Facility"/>
