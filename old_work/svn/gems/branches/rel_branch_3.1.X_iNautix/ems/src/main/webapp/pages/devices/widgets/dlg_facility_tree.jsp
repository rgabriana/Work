...
<script type="text/javascript">
    ...
    function loadTreeDlg() {
    	...
    	function startSwitchValidation(){
    		...
    		var yesorno = confirm("Are you sure you want to apply the changes to the fixtures and/or ERC?");
    		 if(yesorno == false)
    			 return;
...
<div style="padding-top: 5px;padding-left: 5px;border-style:solid;border-width:2px;" class="appbg">
