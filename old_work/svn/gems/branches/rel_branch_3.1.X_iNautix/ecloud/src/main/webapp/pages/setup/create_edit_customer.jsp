...
function viewGmbReportFormatter(cellvalue, options, rowObject) {
	 var rowId = rowObject.id;
	 return "<security:authorize access="hasAnyRole('Admin','SystemAdmin','SupportAdmin')"><button onclick=\"javascript:openGmbInvoicePrompt('"+rowId+"');\">Report</button></security:authorize>";
}
