...
public class ProfileManager {
    ...
    public ProfileHandler createProfile(String strParamPrefix, int profileGroupId, boolean bSave) {
        HashMap<String, String> scMap = profileDefaultConfigurationManager.loadAllConfigMap();
        ...
        profileHandler.setDrSpecialLevel(Byte.valueOf(getConfigurationValue(scMap, sParamPrefix,
                "pfh.dr_special")));
        profileHandler.setHolidayLevel(Byte.valueOf("0"));
...
//			}
    ...
    public void saveDefaultGroups(final ProfileHandler profileHandler) {
        HashMap<String, String> scMap = profileDefaultConfigurationManager.loadAllConfigMap();
