 ...
 * 
 */
public class WDSAckFrame implements ICommandPktFrame {
    private Logger oLogger = Logger.getLogger(WDSAckFrame.class.getName());
    ...
    public WDSAckFrame(long ackTxId, char ackMsg) {
        msg_type = ackMsg;
