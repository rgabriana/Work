...
<spring:url value="/settings/emailconfig.ems" var="emailconfig" />
...
function loadEmailClass() {
	tabselected = 'masteremailclass';
	$("#tab_masteremailclass").show();		
	$("#tab_cup").hide();
	$("#tab_group").hide();
	$("#tab_rest").hide();
	$("#tab_masterfixtureclass").hide();
    ...
    var ifr;
    ifr = document.getElementById("masteremailclassFrame");
    ifr.contentWindow.document.body.innerHTML = "&nbsp;<spring:message code='action.loading'/>";
    ifr.src = "${emailconfig}";
    return false;
}
...
<div id="innercenter" class="ui-layout-center outermostdiv outerContainer" >
	<ul>		
		...
		<security:authorize access="hasAnyRole('Admin')">
			<li id="limasteremailclass" style="display:none"><a id="masteremailclass" href="#tab_masteremailclass" onclick="loadEmailClass();"><span>Email Configuration</span></a></li>
		</security:authorize>				
	</ul>
	<div class="ui-layout-content ui-widget-content ui-corner-bottom" style="border-left: 0; border-top: 0; padding: 0px; width: 100%; height: 100%;">
		...
		<security:authorize access="hasAnyRole('Admin','FacilitiesAdmin')">
			<div id="tab_cup" class="pnl_rht"><iframe frameborder="0" id="cupFrame" style="width: 100%; height: 95%;"></iframe></div>
		</security:authorize>
		...
		<security:authorize access="hasAnyRole('Admin')">
			<div id="tab_masteremailclass" class="pnl_rht"><iframe frameborder="0" id="masteremailclassFrame" style="width: 100%; height: 100%;"></iframe></div>
		</security:authorize>				
