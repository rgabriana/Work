...
public class PlugloadProfileManager {
	...
	public PlugloadProfileHandler createPlugloadProfiles(
		...
		for (int i = 0; i < 12; i++) {
			...
			case 0:
				...
				plugloadProfile.setActiveMotion(fromPlugloadProfile
						.getActiveMotion());
				plugloadProfile.setManualOverrideTime(fromPlugloadProfile.getManualOverrideTime());
        ...
        plugloadProfile = new PlugloadProfile();
        fromPlugloadProfile = ph.getOverride5();
        plugloadProfile.setActiveMotion(fromPlugloadProfile.getActiveMotion());
        plugloadProfile.setMode(fromPlugloadProfile.getMode());
        plugloadProfile.setManualOverrideTime(fromPlugloadProfile.getManualOverrideTime());
        plugloadProfileHandler.setOverride5(plugloadProfile);
        saveProfile(plugloadProfile);
        
        plugloadProfile = new PlugloadProfile();
        fromPlugloadProfile = ph.getOverride6();
        plugloadProfile.setActiveMotion(fromPlugloadProfile.getActiveMotion());
        plugloadProfile.setMode(fromPlugloadProfile.getMode());
        plugloadProfile.setManualOverrideTime(fromPlugloadProfile.getManualOverrideTime());
        plugloadProfileHandler.setOverride6(plugloadProfile);
        saveProfile(plugloadProfile);
        
        plugloadProfile = new PlugloadProfile();
        fromPlugloadProfile = ph.getOverride7();
        plugloadProfile.setActiveMotion(fromPlugloadProfile.getActiveMotion());
        plugloadProfile.setMode(fromPlugloadProfile.getMode());
        plugloadProfile.setManualOverrideTime(fromPlugloadProfile.getManualOverrideTime());
        plugloadProfileHandler.setOverride7(plugloadProfile);
        saveProfile(plugloadProfile);
         
        plugloadProfile = new PlugloadProfile();
        fromPlugloadProfile = ph.getOverride8();
        plugloadProfile.setActiveMotion(fromPlugloadProfile.getActiveMotion());
        plugloadProfile.setMode(fromPlugloadProfile.getMode());
        plugloadProfile.setManualOverrideTime(fromPlugloadProfile.getManualOverrideTime());
        plugloadProfileHandler.setOverride8(plugloadProfile);
        saveProfile(plugloadProfile);
		...
		plugloadProfileHandler.setProfileGroupId(ph.getProfileGroupId());
	...
	public PlugloadProfileHandler createPlugloadProfile(String strParamPrefix, int plugloadProfileGroupId, boolean bSave) {
        ...
        plugloadProfileHandler.setInitialOnLevel(Byte.valueOf(getConfigurationValue(scMap, sParamPrefix, "plpfh.initial_on_level")));
        ...
        PlugloadProfile override5 = new PlugloadProfile();
        override5.setActiveMotion(30);
        override5.setMode((byte) 2);
        override5.setManualOverrideTime(60);
        plugloadProfileHandler.setOverride5(override5);
        savePlugloadProfile(override5);
        
        PlugloadProfile override6 = new PlugloadProfile();
        override6.setActiveMotion(30);
        override6.setMode((byte) 2);
        override6.setManualOverrideTime(60);
        plugloadProfileHandler.setOverride6(override6);
        savePlugloadProfile(override6);
                
        PlugloadProfile override7 = new PlugloadProfile();
        override7.setActiveMotion(30);
        override7.setMode((byte) 2);
        override7.setManualOverrideTime(60);
        plugloadProfileHandler.setOverride7(override7);
        savePlugloadProfile(override7);
        
        PlugloadProfile override8 = new PlugloadProfile();
        override8.setActiveMotion(30);
        override8.setMode((byte) 2);
        override8.setManualOverrideTime(60);
        plugloadProfileHandler.setOverride8(override8);
        savePlugloadProfile(override8);
