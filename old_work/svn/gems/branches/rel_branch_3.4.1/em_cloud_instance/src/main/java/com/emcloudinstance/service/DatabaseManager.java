...
public class DatabaseManager {
	...
	public boolean synchTableData(String macId, String tableName,
		...
		return this.utilDao.synchTableData(macId, tableName, otherDataStream, remigration);
	}
	...
	public Long getLastMaxTableDataSynched(String macId, String tableName) {
		return this.utilDao.getLastMaxTableDataSynched(macId, tableName);
	}
