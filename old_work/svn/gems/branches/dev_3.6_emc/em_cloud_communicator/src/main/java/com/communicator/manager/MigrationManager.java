...
public class MigrationManager {
	...
	public void runMigrationOrSync() throws SchedulerException
	{
		...
		if(replicaServerInfoManager.getCurrentEmStatus()== EmStatus.SPPA)
		{
			...
			case RESTRICTED_REMIGRATION_READY:
				cloudManager.doRestrictedReMigration() ;
				break;
			...
			case ENERGY_CONSUMPTION_DAILY_START:
				...
				createAndFireBulkJob(jobName ,nextState, false) ;
				break;
			...
			case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
				jobName = CommonStateUtils.plugloadEnergyDailyTableName ;
				 nextState = DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
				break;
			case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
				jobName = CommonStateUtils.plugloadEnergyHourlyTableName;
				nextState = DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
				break;
			case PLUGLOAD_ENERGY_CONSUMPTION_START:
				jobName = CommonStateUtils.plugloadEnergyTableName;
				nextState= DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
				break;
			...
			case RESTRICTED_ENERGY_CONSUMPTION_DAILY_START:
				jobName = CommonStateUtils.energyDailyTableName ;
				 nextState = DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_ENERGY_CONSUMPTION_HOURLY_START:
				jobName = CommonStateUtils.energyHourlyTableName;
				nextState = DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_ENERGY_CONSUMPTION_START:
				jobName = CommonStateUtils.energyTableName;
				nextState= DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START:
				jobName = CommonStateUtils.plugloadEnergyDailyTableName ;
				 nextState = DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START:
				jobName = CommonStateUtils.plugloadEnergyHourlyTableName;
				nextState = DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_START:
				jobName = CommonStateUtils.plugloadEnergyTableName;
				nextState= DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;
			case RESTRICTED_MOTION_BIT_START:
				jobName = CommonStateUtils.motionBitTableName;
				nextState = DatabaseState.RESTRICTED_MOTION_BIT_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, true) ;
				break;	
			...
			case ENERGY_CONSUMPTION_DAILY_SUCCESS:
				...
				setReplicaMigrationFlagOnCloud(DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_START.getName()) ;	
				break;
			...
			case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
				logger.info("Daily plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.MOTION_BIT_START.getName()) ;	
				break;
			case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
				logger.info("Hourly plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START.getName()) ;	
				break;		
			case PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
				logger.info("Minutes plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START.getName()) ;	
				break;	
			...
			case RESTRICTED_ENERGY_CONSUMPTION_DAILY_SUCCESS:
				logger.info("Daily energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_START.getName()) ;	
				break;
			case RESTRICTED_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
				logger.info("Hourly energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_DAILY_START.getName()) ;	
				break;		
			case RESTRICTED_ENERGY_CONSUMPTION_SUCCESS:
				logger.info("Minutes energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_HOURLY_START.getName()) ;	
				break;	
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_SUCCESS:
				logger.info("Daily plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_MOTION_BIT_START.getName()) ;	
				break;
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_SUCCESS:
				logger.info("Hourly plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_DAILY_START.getName()) ;	
				break;		
			case RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_SUCCESS:
				logger.info("Minutes plugload energy data Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_START.getName()) ;	
				break;	
			...
			case RESTRICTED_REMIGRATION_SUCCESS:
				logger.info("Restricted  Re-Migration successfull.") ;
				setReplicaMigrationFlagOnCloud(DatabaseState.RESTRICTED_ENERGY_CONSUMPTION_START.getName()) ;
				break;	
			...
			case PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS:
				logger.info("Daily plugload Energy data" +IN_PROGRESS_LOG) ;
				//check if running or not. if not start again
				jobName = CommonStateUtils.plugloadEnergyDailyTableName ;
				 nextState = DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_DAILY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
			...
			case PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS:
				logger.info("Minutes plugload Energy data" +IN_PROGRESS_LOG) ;
				//check if running or not. if not start again
				jobName = CommonStateUtils.plugloadEnergyTableName;
				nextState= DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
			...
			case PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS:
				logger.info("Hourly plugload Energy data" +IN_PROGRESS_LOG) ;
				//check if running or not. if not start again
				jobName = CommonStateUtils.plugloadEnergyHourlyTableName;
				nextState = DatabaseState.PLUGLOAD_ENERGY_CONSUMPTION_HOURLY_IN_PROGRESS.getName() ;
				createAndFireBulkJob(jobName ,nextState, false) ;
			...
			case MIGRATION_FAIL:
				...
				break;
			case RESTRICTED_REMIGRATION_FAIL:
				logger.info("Re-Migration step have failed due to some reason. Please contact Admin.") ;
				break;
	...
	private void createNewBulkSyncUpJob(String tableName, Boolean remigration) throws SchedulerException {
		JobDetail BulkJob = newJob(BulkSyncUpJob.class)
				...
				.usingJobData("remigration", remigration)
				.build();
	...
	private void createAndFireBulkJob(String jobName , String state, Boolean remigration)
	{
		sched = SchedulerManager.getInstance().getScheduler();
		try {
			if (!sched.checkExists(new JobKey(jobName, sched.getSchedulerName()))) {
				setReplicaMigrationFlagOnCloud(state) ;
				createNewBulkSyncUpJob(jobName,remigration);	
			}
