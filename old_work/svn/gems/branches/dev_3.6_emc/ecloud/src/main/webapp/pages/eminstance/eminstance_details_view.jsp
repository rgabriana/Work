...
html,body {
    background-color: #FFFFFF !important;
		...
		<div style="width: 100%; height: 100%; background: #fff; padding: 10px 10px 20px 10px" id="detailsDiv">
			...
			<div class="field">
				<div class="formPrompt"><span>EM OS Version:</span></div>
				<div class="formValue">${emInstanceDetailsView.osVersion}</div>
			</div>
			<div class="field">
				<div class="formPrompt"><span>EM OS Architecture:</span></div>
				<div class="formValue">${emInstanceDetailsView.osArch} bit</div>
			</div>
			<div class="field">
