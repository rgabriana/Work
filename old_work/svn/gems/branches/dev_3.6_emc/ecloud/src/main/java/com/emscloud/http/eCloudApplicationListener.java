...
public class eCloudApplicationListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    class Init implements Runnable {
        ...
        public void run() {
            ...
            DataPullRequestManager dataPullRequestManager = (DataPullRequestManager) SpringContext.getBean("dataPullRequestManager");
            dataPullRequestManager.startCleanUpJob();
