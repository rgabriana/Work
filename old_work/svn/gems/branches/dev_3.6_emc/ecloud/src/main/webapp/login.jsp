...
<spring:url value="/themes/default/images/enlighted-logo.png" var="logo"></spring:url>
...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="5">
		...
		<tr>
			<td>1451 Grant Road, Suite 200<br />
				Mountain View, CA 94040<br /> Phone: 650.964.1094<br /> Fax:
		...
		/*
			if (!FlashDetect.installed) {
				$('#flash_detection').html(
						'Flash is required to work with this application.Please <a href="http://www.adobe.com/products/flashplayer.html">Install</a>');
			} else {
				if (!FlashDetect.versionAtLeast(10,3,183)) {
					$('#flash_detection').html(
							'Flash player of version 10.3.183 is required to work with the application.Please <a href="http://www.adobe.com/products/flashplayer.html">Update</a>');
				}
			}
		*/
		</script>
		...
		<div class="loginForm">
			...
			<form method="post" name="loginForm" autocomplete="off"
				onsubmit="return validateForm();" action="${login_url}">
				<div>
					<span class="loginPrompt"><spring:message
							code="login.user.id.label" /></span> <input type="text" autocomplete="off" 
						id="userNameTextBox" class="loginField" name="j_username"></input>
				</div>
				<div>
					<span class="loginPrompt dvpwd"><spring:message
							code="login.password.label" /></span> <input type="password" autocomplete="off" 
