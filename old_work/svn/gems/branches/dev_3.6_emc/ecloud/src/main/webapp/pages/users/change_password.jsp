...
<spring:url value="/services/org/users/changepassword" var="changePasswordUrl" scope="request" />
...
$(document).ready(function() {
	...
	var changePasswordValidatorObj = {
			rules: {
				...
				newPassword: {required: true,minlength : 8, passwordValidate:true, notEqualTo: "#oldPassword1"},
				confirmPassword: {required: true, equalTo: "#newPassword1"}
			},
			messages: {
				oldPassword: {required: requiredErr},
				newPassword: {required: requiredErr, minlength: '<spring:message code="error.password.length"/>', passwordValidate: '<spring:message code="error.passwords.policy"/>'},
...
<table id="ucp-form-container">
	...
	<tr>
		...
		<td class="field-input"><input id="oldPassword1" type="password" autocomplete="off" name="oldPassword" type="text"/></td>
	</tr>
	<tr>
		<td class="field-label">New Password* :</td>
		<td class="field-input"><input id="newPassword1" type="password" autocomplete="off" name="newPassword" type="text"/><span id="np_error_msg" class="error"></span></td>
	</tr>
	<tr>
		<td class="field-label">Confirm Password* :</td>
		<td class="field-input"><input id="confirmPassword1" type="password" autocomplete="off" name="confirmPassword" type="text"/><span id="cp_error_msg" class="error"></span></td>
	</tr>
	<tr>
