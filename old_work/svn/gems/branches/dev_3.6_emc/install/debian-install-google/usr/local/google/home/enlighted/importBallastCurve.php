<?php
/********************************************************************************/
// php insertBallastCurve.php --ballastid=10 --map="/usr/local/google$ENLIGHTED_HOME/88_voltmap.csv"
/********************************************************************************/
...
function showHelp() {
	$help = "Usage:\r\n";
	$help .="php insertBallastCurve.php --ballastid=<ballastid> --map=\"".$GLOBALS['env_arr']['ENL_APP_HOME']."/voltmap.csv\"";
	print($help);
}
?>
