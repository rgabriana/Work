...
INSERT INTO system_configuration (id, name, value) values ((select coalesce(max(id),0)+1 from system_configuration), 'iptables.rules.static.ports', '22,8085,7,443,8443,80,389,12302,9191,2332');
