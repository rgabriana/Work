...
{		 
		 $("#wdserrorMsg").text("");
		 $("#editwdsname").removeClass("invalidField");
}

function saveTemplate()
{	
	var id = $.trim(wdsid);
	var newname = $.trim($('#editwdsname').val());
	$.ajax({
		type: "POST",
		cache: false,
...
<div class="fieldWrapper" >
			...
			<div class="fieldInput"><input class="text" id="editwdsname" name="editwdsname" value="${wds.name}"/></div>			
			<br style="clear:both;"/>
