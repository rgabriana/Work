...
public class GroupECRecord {
    ...
    @XmlElement(name="totalplugloads")
    private Integer totalPlugloads;
	...
	public Integer getTotalPlugloads() {
		return totalPlugloads;
	}

	public void setTotalPlugloads(Integer totalPlugloads) {
		this.totalPlugloads = totalPlugloads;
	}
