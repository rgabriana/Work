...
public class PlugloadManager {
  ...
  public void updatePlugloadSecGw(List<Plugload> plugloads, Gateway gw) {
	...
	public List<Device> getDeviceById(long id) {
		return plugloadDao.loadDeviceById(id);
  ...
  public void enableHopper(long plugloadId, boolean enable) {
	...
	public PlugloadProfileHandler getProfileHandlerByGroupId(Long groupId) {
		...
		return plugloadDao.getProfileHandlerByGroupId(groupId);
	...
	public int deletePlugloadWithoutAck(Long id) {
        int iStatus = 1;
        try {
  ...
  public List<Plugload> loadPlacedAndCommissionedPlugloadsByFloorId(Long id) {
    ...
    /**
     * update Plugload details.
     */
    public Plugload updatePlugload(Plugload plugload, boolean duringCommissioning) {
        ...
        PlugloadCache.getInstance().invalidateDeviceCache(plugload.getId());
        return plugloadDao.update(plugload);
    }

	public Plugload updateAreaID(Plugload oPlugload) {
		 try {
	            return (Plugload) plugloadDao.updateAreaID(oPlugload);
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	        return null;
