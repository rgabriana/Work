...
var status="";
      $(document).ready(function() {
		...
		if(deleteStatus)
		{
			if(deleteStatus==1)
			{
				displayLabelMessage('<spring:message code="sweeptimers.delete.fail"/>',COLOR_FAULT);
			}else if(deleteStatus==0)
			{
				displayLabelMessage('<spring:message code="sweeptimers.delete.success"/>',COLOR_SUCCESS);
			}
		...
		if(assignStatus)
		{
			if(assignStatus==1)
			{
				displayLabelMessage('<spring:message code="sweeptimers.assign.fail"/>',COLOR_FAULT);
			}else if(assignStatus==0)
			{
				displayLabelMessage('<spring:message code="sweeptimers.assign.success"/>',COLOR_SUCCESS);
			}
     ...
     var editSweepTimer = function(id){
  	...
  	function closeDialog(statusType){
      	...
      	window.top.location = "${sweeptimerList}?status="+statusType;      	
      }
