...
IS_LOADED_PLOVERVIEW = false;
IS_LOADED_PLPROFILE = false;
IS_LOADED_PLENERGY = false;
...
var flash_plugload_ec = function(nodetype, nodeid) {
	...
	if ($.browser.msie) {
		...
		EC_data +=  "<param name='flashvars' value='orgType=plugload" + "&orgId=" + plugloadId + "&contextRoot=" + '${contextPath}'+ "'/>";
		...
		EC_data +=  " flashvars='orgType=plugload" + "&orgId=" + plugloadId + "&contextRoot=" + '${contextPath}'+ "'/>";
		EC_data +=  "</object>";
	} else {
		EC_data = "<embed id='plugload-energy-summary' name='plugload-energy-summary' src='"+fixtureEnergySummaryUrlString+"' pluginspage='http://www.adobe.com/go/getflashplayer'";
		EC_data +=  " height='100%'";
