...
<spring:url value="/scripts/jquery/jqgrid/jquery.jqgrid.4.4.1.min.js" var="jqueryJqGrid"></spring:url>
...
/* style class for fixing the submenu flickering issue in ie8 browser */
.ie8SubMenu{
