...
function startAnalyseSiteAnomolies(inputdata, pageNum, orderBy, orderWay) {
		jQuery("#analysesiteanamoliesTable").jqGrid({
			...
			colNames: ["id", "Geo Location", "Report Date","Start Date", "End Date","Issue","Details"],
		       ...
		       { name: "reportDate", index: 'reportDate',formatter: analysesiteanomaliesdateformatter, sortable:true,width:'6%'},
		       { name: "startDate", index: 'startDate',formatter: analysesiteanomaliesdateformatter, sortable:true,width:'6%'},
		       { name: "endDate", index: 'endDate',formatter: analysesiteanomaliesdateformatter, sortable:true,width:'6%'},
	...
	function analysesiteanomaliesdateformatter(cellvalue, options, rowObject)
	{
