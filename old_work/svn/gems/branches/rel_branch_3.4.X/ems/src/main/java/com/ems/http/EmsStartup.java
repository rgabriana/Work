	...
	private void process(ServletContext context) {
		...
		try {
            ...
            if (enablePlugloadProfileFeature != null && "true".equalsIgnoreCase(enablePlugloadProfileFeature.getValue())) {
            	 ...
            	 PlugloadGroupManager plugloadGroupManager = (PlugloadGroupManager) SpringContext.getBean("plugloadGroupManager");
            	 if(plugloadGroupManager.getPlugloadGroupByName("Default") == null){
            		 PlugloadProfileManager plugloadProfileManager = (PlugloadProfileManager) SpringContext.getBean("plugloadProfileManager");
