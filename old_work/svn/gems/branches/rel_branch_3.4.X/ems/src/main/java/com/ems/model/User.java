...
public class User implements Serializable {
	...
	public boolean isUserLocked() {
		if(( isAdmin())){
			...
			userLocked = this.getNoOfLoginAttempts() >= (Constants.MAX_LOGIN_ATTEMPTS_ADMINS) && isLocked;
		}else{
			userLocked = !( isAdmin()) &&  this.getNoOfLoginAttempts() >= (Constants.MAX_LOGIN_ATTEMPTS);
		}
		return userLocked;
	}
	...
	public boolean isActive() {
		isActive = this.getStatus() == UserStatus.ACTIVE;
		return isActive;
	}
