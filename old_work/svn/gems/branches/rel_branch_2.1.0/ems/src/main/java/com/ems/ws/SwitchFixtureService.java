...
public class SwitchFixtureService {
	 ...
	 * @return
	 */
	@Path("reassignswitchfixture")
	@POST
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response reassignSwitchFixtures(List<SwitchFixtures> switchFixtures) {
		switchManager.reassignSwitchFixturesList(switchFixtures);
