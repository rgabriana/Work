...
public class Area implements Serializable {
    ...
    private Integer occupancyState = 0;

    //@XmlElement(name = "sensorFaultyTime")
    private Integer sensorFaultyTime = 15;
    //@XmlElement(name = "percentageSensorsFaulty")
    private Integer percentageSensorsFaulty = 75;
	...
	/**
	 * @return the sensorFaultyTime
	 */
	public Integer getSensorFaultyTime() {
		return sensorFaultyTime;
	}

	/**
	 * @param sensorFaultyTime the sensorFaultyTime to set
	 */
	public void setSensorFaultyTime(Integer sensorFaultyTime) {
		this.sensorFaultyTime = sensorFaultyTime;
	}

	/**
	 * @return the percentageSensorsFaulty
	 */
	public Integer getPercentageSensorsFaulty() {
		return percentageSensorsFaulty;
	}

	/**
	 * @param percentageSensorsFaulty the percentageSensorsFaulty to set
	 */
	public void setPercentageSensorsFaulty(Integer percentageSensorsFaulty) {
		this.percentageSensorsFaulty = percentageSensorsFaulty;
	}
