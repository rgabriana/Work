...
public class WdsManager {
    ...
    public boolean rmaWds(Long fromWdsId, Long toWdsId) {
        ...
        wdsDao.replaceWdS(toWdsId, newWdsName, newMacAddr + "_rma",newModelNo,
        		ServerConstants.WDS_STATE_DELETED_STR,newHlaSerialNo,newHlaPartNo,newPcbaPartNo,newPcbaSerialNo);        
        ...
        wdsDao.replaceWdS(fromWdsId, wdsName, newMacAddr,newModelNo,
                ServerConstants.WDS_STATE_COMMISSIONED_STR,newHlaSerialNo,newHlaPartNo,newPcbaPartNo,newPcbaSerialNo);
        if (logger.isDebugEnabled()) {
