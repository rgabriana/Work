...
sleep 10
echo "save-energy" | sudo ifconfig eth0:2 169.254.0.101 netmask 255.255.0.0
sleep 10
echo "save-energy" | php ~/insertGateway.php --ip=169.254.0.101 --mac=68:54:f6:00:01:00 --mask=255.255.0.0
sleep 10
echo "save-energy" | sudo ifconfig eth0:3 169.254.0.102 netmask 255.255.0.0
sleep 10
echo "save-energy" | php ~/insertGateway.php --ip=169.254.0.102 --mac=68:54:f7:00:01:00 --mask=255.255.0.0