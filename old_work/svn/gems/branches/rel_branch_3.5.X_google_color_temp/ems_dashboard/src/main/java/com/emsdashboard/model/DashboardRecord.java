...
public class DashboardRecord {
    ...
    private Double powersaving = 0.0;
	...
	public String toString() {
		return "DashboardRecord [powerused=" + powerused + ", basePowerUsed="
				+ basePowerUsed + ", savedPower=" + savedPower + ", price="
				+ price + ", cost=" + cost + ", savedCost=" + savedCost
				+ ", powersaving=" + powersaving + ", occsaving=" + occsaving
				+ ", tasktuneupsaving=" + tasktuneupsaving + ", ambientsaving="
				+ ambientsaving + ", manualsaving=" + manualsaving
				+ ", avgLoad=" + avgLoad + ", peakLoad=" + peakLoad
				+ ", minLoad=" + minLoad + ", baseCost=" + baseCost + ", captureOn=" + captureOn + "]";
	}
	/**
     * @return the baseCost
     */
