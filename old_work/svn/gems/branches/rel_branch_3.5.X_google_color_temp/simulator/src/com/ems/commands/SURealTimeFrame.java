...
public class SURealTimeFrame implements ICommandPktFrame {
    private Logger oLogger = Logger.getLogger(SURealTimeFrame.class.getName());
    ...
    int localMinutes = ((Long) Calendar.getInstance().getTimeInMillis()).intValue()/60; // 11-14
    int upTme = 456; // 15-18
    ...
    int utcTime = ((Long) Calendar.getInstance().getTimeInMillis()).intValue(); // 25-28
    ...
    private SURealTimeFrame() {
    }
    
    public SURealTimeFrame(byte msgType, Profile profile, String sName) {
    ...
    public byte[] toByte(String nodeName) {
        ...
        try {
            ...
            output.write(Utils.intToByteArray(localMinutes));
            ...
            output.write(Utils.intToByteArray(utcTime));
    ...
    public void setLocalMinutes(int localMins) {
    	this.localMinutes = localMins;
    }
    
    public void setUTC(int utc_time) {
