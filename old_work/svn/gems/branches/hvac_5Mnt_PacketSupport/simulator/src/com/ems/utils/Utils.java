...
public final class Utils {
    ...
    private static HashMap<String, PlugloadUnit> plUnits = new HashMap<String, PlugloadUnit>();
    private static int iNoOfSensors = 0;
    private static int iNoOfWDS = 0;
    private static int iNoOfPlugloads = 0;
    ...
    public static void setPlugloadUnits(ArrayList plUnit) {
        Iterator<PlugloadUnit> i = plUnit.iterator();
        while (i.hasNext()) {
            PlugloadUnit pl = (PlugloadUnit) i.next();
            plUnits.put(pl.getsName(), pl);
        }
        iNoOfPlugloads = plUnit.size();
    }


    public static int getiNoOfPlugloads() {
        return iNoOfPlugloads;
    }
    ...
    public static HashMap<String, PlugloadUnit> getPlugLoadUnits() {
        return plUnits;
    } 
}
