...
public class InventoryReportsController {
    ...
    static Logger logger = Logger.getLogger(InventoryReportsController.class.getName());
    ...
    public String loadInventoryReportDetail(Model model, @RequestParam("siteId") long siteId){
        ...
        model.addAttribute("totalCommissionedErcCount", IRUtil.totalCommissionedErcCount);
        ...
        model.addAttribute("totalCommissionedErc", IRUtil.totalCommissionedErc);
