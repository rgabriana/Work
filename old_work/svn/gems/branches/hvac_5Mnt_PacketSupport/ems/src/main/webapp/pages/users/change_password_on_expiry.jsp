...
<spring:url value="/changepasswordsuccess.ems" var="changePasswordSuccessUrl" scope="request" />
	...
	if($("#ucp-form").valid()){
		$.ajax({
			...
			success: function(data){
				...
				if(data.status == 0)$("#ucp-form1").submit();
			},
			error : function(xhr, textStatus, errorThrown) {
				setChangePasswordMessage(xhr.statusText, "red" );
			},
			dataType:"json",
...
<form id="ucp-form1" method="post" action="${changePasswordSuccessUrl}" ></form>
<form id="ucp-form" method="post" action="" >
<h2>Your password has expired. You are required to change it every 6 months.</h2>
