...
// 		   	pager: '#groupPagingDiv',
		...
		<c:forEach items="${groups}" var="group">
			...
			localData.action += "&nbsp;<button onclick=\"javascript: deleteObsoleteGroup(${group.id}, '${group.groupName}');\">Delete</button>";
	...
	function deleteObsoleteGroup(groupID, groupName){
	...
	function reloadGroupsListFrame(){
		var ifr = parent.document.getElementById('groupFrame');
