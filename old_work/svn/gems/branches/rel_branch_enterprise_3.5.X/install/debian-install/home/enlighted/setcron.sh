...
then
	...
	echo "50 0,3 * * * $ENLIGHTED_HOME/scripts/ems_ntp.sh" >> /var/spool/cron/crontabs/root
...
then
	...
	echo "30 0,3 * * * sh $ENLIGHTED_HOME/scripts/dailyconfigbackup.sh " >> /var/spool/cron/crontabs/root
