...
public class BACnetConfig {
	...
	private String fixtureOccupancySensor;
	...
	public void setFixtureOccupancySensor(String fixtureOccupancySensor) {
		this.fixtureOccupancySensor = fixtureOccupancySensor;
	}
	public String getFixtureOccupancySensor() {
		return fixtureOccupancySensor;
	}
