...
public class EMManager {
	...
	public void setEmergencyOnBySwitchId(Long switchId, Integer time) {
        ...
        if(oGGFxList != null && oGGFxList.size() > 0){
            ...
            fixtureManager.absoluteDimFixtures(fixtureArr, 100, time);
        }        
        ...
        if(oGGPgList != null && oGGPgList.size() > 0){
            ...
            plugloadManager.turnOnOffPlugloads(plugloadArr, 100, time);
        }
