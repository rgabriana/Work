...
public class LogUploadJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		try{
			...
			{	fileList = CommunicatorConstant.SYS_ENV.get(fileName); //CommonUtils.getPropertyWithName(fileName, CommunicatorConstant.fileBasePathDir);
			...
			}else
			{
				 ...
				 pro.putAll(CommunicatorConstant.SYS_ENV);
