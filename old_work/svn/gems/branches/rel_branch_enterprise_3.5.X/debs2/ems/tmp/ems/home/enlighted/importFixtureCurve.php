<?php
/********************************************************************************/
// php insertBallastCurve.php --ballastid=10 --map="/home/enlighted/88_voltmap.csv"
/********************************************************************************/
...
function showHelp() {
	$help = "Usage:\r\n";
	$help .="php insertBallastCurve.php --ballastid=<ballastid> --map=\"/home/enlighted/voltmap.csv\"";
	print($help);
}
?>
