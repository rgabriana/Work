...
public class EmStateService {
    ...
    public EmStateList getEmStateListByEmInstanceId(
		...
		EmStateList oEmStateList = emStateManager.getLatestEmStateListByEmInstanceId(orderway, (page - 1) * EmTasksList.DEFAULT_ROWS, EmTasksList.DEFAULT_ROWS,emInstanceId);
