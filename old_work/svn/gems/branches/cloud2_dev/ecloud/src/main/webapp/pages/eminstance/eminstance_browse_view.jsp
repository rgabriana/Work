...
$(document).ready(function() {
	...
	{
		$('#tunnelbuttonMessage').text(InProgressMsg);
	}
	getbrowsableLink();
    ...
    background-color: #FFFFFF !important;
		...
		<div style="width: 100%; height: 100%; background: #fff; padding: 10px 10px 20px 10px" id="detailsDiv">
			...
			<div class="field">
				...
				<button id="emTunnelButton"> <span id="tunnelbuttonMessage"></span></button><br></br> <span id="tunnelMsg" class="success"></span> <span id="tunnelerrorMsg" class="error"></span>
			</div>
			<div class="field">
				<div class="formPrompt"><span>Browse Link:</span></div>
				<div class="formValue"><span id="browseLink" class="success"></div>
			</div>
