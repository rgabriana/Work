 ...
 */
@Entity
@Table(name = "floor_Energy_consumption_daily", schema = "public")
@XmlRootElement
@XmlAccessorType(XmlAccessType.NONE)
public class FloorEnergyConsumptionDaily implements Serializable {
	...
	public FloorEnergyConsumptionDaily() {
	}
