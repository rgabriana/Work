...
public class CustomerController {
	...
	public String gmbCustomerInvoice(@RequestParam("customerId") Long customerId,@RequestParam("startDate") String startDateStr,
		...
		CustomerDetailedBill customerBill = sppaManager.getBillReportCustomer(customerId,startDate,endDate, false, null);
		...
		model.addAttribute("noOfEmInstances",customer.getEmInstances().size());
	...
	@PreAuthorize("hasAnyRole('Admin','SystemAdmin')")
