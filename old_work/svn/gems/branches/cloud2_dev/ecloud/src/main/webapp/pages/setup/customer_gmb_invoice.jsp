	...
	$(document).ready(
			function() {
				...
				<c:forEach items="${sppaBill}" var="sppabill">
					...
					localData.name =  "${sppabill.emInstance.name}";
					...
					localData.sppaPrice =  "${sppabill.emInstance.sppaPrice}";
		...
		<div>
			...
			<table id="tblinvoice2" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td><fmt:formatNumber type="currency" currencySymbol="$" value="${customerBill.sppaCost + customerBill.tax}"/></td>
					<td></td>
				</tr>
				<tr>
