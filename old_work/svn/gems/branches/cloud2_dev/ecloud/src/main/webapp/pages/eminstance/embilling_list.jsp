...
<spring:url value="/reGenerateCustomerBill.ems" var="reGenerateCustomerBill" scope="request" />
<spring:url value="/customerBilling.ems" var="newBillPromptDialogUrl" />
<spring:url value="/generateCustomerReport.ems" var="customerReportUrl" />
<spring:url value="/bills/downloadCustomerBill.ems" var="downloadCustomerBillUrl" />
...
$(document).ready(function() {
    ...
    $('#generateNewBillButton').click(function() {
    	...
    	if(lastBillDate!=null)
   		{
    		var billdateStr = getCustomDateFormat(lastBillDate);
   		}
...
function downloadBill(rowId,startDate,endDate)
{
	...
	var startDateStr = getCustomDateFormat(startDate);
	var endDateStr = getCustomDateFormat(endDate);
...
//function for pagination
	...
	function forceFitEmInstanceTableWidth(){
		...
		var gridFooterHeight = $("#emInstanceBillPagingDiv").height();
...
<div style="width: 100%; height: 100%; background: #fff; padding: 0px 5px 0px 0px" >
	<div id="outerDiv" style="padding: 5px 5px 5px 5px">
			<div style="font-weight: bolder;padding-top: 5px;padding-bottom: 5px;"><spring:message code="eminstance.bill.header"/>${customerName}</div>
