...
function IsNumeric(sText)
{
	...
	function checksize(obj) { 
		...
		if(obj.files[0].size > 3145728) {
			$('#imgName').val('');
			displayImageUpgradeMessage("Upload file size should be less than 3 MB.", COLOR_FAILURE);
		}
    }
	...
	<fieldset>
			...
			<div class="messageDiv" id="image_upload_message" value="Hi Chetan here"></div>
