...
function ModifyGridDefaultStyles() {  
	   $('#' + "asu-user-table" + ' tr').removeClass("ui-widget-content");
	   $('#' + "asu-user-table" + ' tr:nth-child(even)').addClass("evenTableRow");
	   $('#' + "asu-user-table" + ' tr:nth-child(odd)').addClass("oddTableRow");
}
