...
<div id="licenseSupportDiv" style="width: 100%;background: #fff; padding: 0px 5px 0px 0px" >
			...
			<tr>
			 ...
			 <tr>
				 <table cellpadding="0" cellspacing="10" style="padding-top:5px;padding-bottom:15px;width: 100%;border-collapse: collapse;">
					...
					<c:if test="${totalNoOfEmBaseLicenses gt 0}">
					<c:forEach items='${licenses.bacnet.bacnetLicenseInstanceList}' var='bacnetLicenseInstance'>
					<c:if test="${bacnetLicenseInstance.noOfEmBaseLicenses gt 0}">
					<tr style="border: 1px solid black;">
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.emBaseLicenseProductId}</td>
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.noOfEmBaseLicenses}</td>
					</tr>
					</c:if>
					</c:forEach>
					</c:if>
					<c:if test="${totalNoOfEmGroupPointBaseLicenses gt 0}">
					<c:forEach items='${licenses.bacnet.bacnetLicenseInstanceList}' var='bacnetLicenseInstance'>
					<c:if test="${bacnetLicenseInstance.noOfEmGroupPointBaseLicenses gt 0}">
					<tr style="border: 1px solid black;">
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.emGroupPointLicenseProductId}</td>
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.noOfEmGroupPointBaseLicenses}</td>
					</tr>
					</c:if>
					</c:forEach>
					</c:if>
					<c:if test="${totalNoOfEmSensorPointBaseLicenses gt 0}">
					<c:forEach items='${licenses.bacnet.bacnetLicenseInstanceList}' var='bacnetLicenseInstance'>
					<c:if test="${bacnetLicenseInstance.noOfEmSensorPointBaseLicenses gt 0}">
					<tr style="border: 1px solid black;">
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.emSensorPointLicenseProductId}</td>
						<td style="padding:5px 15px 5px 5px;border: 1px solid #e5e5e5 !important;">${bacnetLicenseInstance.noOfEmSensorPointBaseLicenses}</td>
					</tr>
					</c:if>
					</c:forEach>
					</c:if>
