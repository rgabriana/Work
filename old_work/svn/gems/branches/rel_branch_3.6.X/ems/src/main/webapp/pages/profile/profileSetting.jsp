...
<c:choose>
  <c:when test="${TITLE24FLAG}">
    <c:set var="amwmax" value="20"/>
    <c:set var="llmin" value="50"/>
    <c:set var="llmax" value="30"/>
  </c:when>
  <c:otherwise>
    <c:set var="amwmax" value="200"/>
    <c:set var="llmin" value="100"/>
    <c:set var="llmax" value="0"/>
  </c:otherwise>
</c:choose>
...
var OriprofileName="";
	$(document).ready(function() {		
		...
		}else if(manageType=='readonly')
		{
			...
			//$("#pwmBehaviour_combo").attr('disabled',true);
			...
			//$("#pwmBehaviour_combo").attr('disabled',false);
...
<!-- 			<div id="profile_rename_message" style="font-weight: bold; padding: 0px 5px; display: inline;"></div> -->
					...
					<div class="settingProfileNameFieldLabel">
							<span>Created From: </span>
								<c:if test="${management=='new'}">
									<select id=derivedProfile name="derivedProfile" onchange="javascript: changeProfile()">
				...
				<table class="entable rhtinput" style="width: 100%; height: 100%;">
					<thead>
						<tr>
							...
							<c:choose>
							  <c:when test="${TITLE24FLAG}">
							  	<th  align="left" title="The minimum level between 0 and 50 percent to set the light. Setting the value to 0 allows a light to be turned completely off when no occupant is present or there is an abundance of ambient light. Typically this should either be zero for a private office, or a value around 25 for an open office.">
									<spring:message code="profile.settings.min.level.title24"/>
								</th>
							  </c:when>
							  <c:otherwise>
								<th  align="left" title="The minimum level between 0 and 100 percent to set the light. Setting the value to 0 allows a light to be turned completely off when no occupant is present or there is an abundance of ambient light. Typically this should either be zero for a private office, or a value around 25 for an open office.">
									<spring:message code="profile.settings.min.level"/>
								</th>    
							  </c:otherwise>
							</c:choose>
							...
							<c:choose>
							  <c:when test="${TITLE24FLAG}">
							  	<th  align="left" title="The maximum level between 30 and 100 percent to set the light. This is the value to be reduced when there is too much illumination by the light. Typically the value would be 80, which would be reduced to no more than 25 or 30.">
									<spring:message code="profile.settings.max.level.title24"/>
								</th>
							  </c:when>
							  <c:otherwise>
							  	<th  align="left" title="The maximum level between 0 and 100 percent to set the light. This is the value to be reduced when there is too much illumination by the light. Typically the value would be 80, which would be reduced to no more than 25 or 30.">
									<spring:message code="profile.settings.max.level"/>
								</th>
							  </c:otherwise>
							</c:choose>
							...
							<th  align="left" title="The length of time to change a light that is off to its computed on value. For example, when the value is 10, a light that is off will be brought up to the computed light level over 10 seconds when it is turned on."><spring:message code="profile.settings.rampup"/></th>
							<th  align="left" title="The length of time to hold a light on after no additional motion has been detected. During periods when it is expected that the lights should be on, such as during the day on week days, the value should be a longer length of time, such as 15 minutes. Other times, a short length, such as 3 minutes, should be used. When the occupants under the fixture are very still, the value may be increased to a larger value, such as 30 minutes.">
							
							<c:choose>
							  <c:when test="${TITLE24FLAG}">
							    <spring:message code="profile.settings.active.motion.window.title24"/>
							  </c:when>
							  <c:otherwise>
								<spring:message code="profile.settings.active.motion.window"/>    
							  </c:otherwise>
							</c:choose>
							
							</th>
							<th  align="left" title="The sensitivity of continuous motion to recognize that occupancy has occurred. Setting the value to 0 will cause the fixture to behavior as if an occupant is always present, such as an area that needs to be continuously lit at night. The default value of 1 is for a fast reaction. A higher value might be used for fixtures in open offices to ignore passersby in corridors."><spring:message code="profile.settings.motion.sensitivity"/></th>
							<th  align="left" title="Determines if the light will be dimmed due to ambient light. The value 0 means that the light will not be dimmed. The value 10 means that the light is most sensitive to ambient light."><spring:message code="profile.settings.ambient.sensitivity"/></th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfile.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="morningProfile.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfile.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="morningProfile.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input' path="morningProfile.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfile.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="dayProfile.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfile.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="dayProfile.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="dayProfile.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfile.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="eveningProfile.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfile.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="eveningProfile.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="eveningProfile.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfile.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="nightProfile.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfile.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="nightProfile.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="nightProfile.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfileWeekEnd.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="morningProfileWeekEnd.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfileWeekEnd.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="morningProfileWeekEnd.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="morningProfileWeekEnd.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfileWeekEnd.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="dayProfileWeekEnd.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfileWeekEnd.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="dayProfileWeekEnd.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="dayProfileWeekEnd.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfileWeekEnd.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="eveningProfileWeekEnd.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfileWeekEnd.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="eveningProfileWeekEnd.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="eveningProfileWeekEnd.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfileWeekEnd.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="nightProfileWeekEnd.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfileWeekEnd.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="nightProfileWeekEnd.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="nightProfileWeekEnd.motionDetectDuration"/></div></td>
				...
				<table class="entable rhtinput" style="width: 100%; height: 100%;">
					...
					<tbody>
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfileHoliday.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="morningProfileHoliday.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.morningProfileHoliday.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="morningProfileHoliday.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input' path="morningProfileHoliday.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfileHoliday.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="dayProfileHoliday.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.dayProfileHoliday.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="dayProfileHoliday.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="dayProfileHoliday.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfileHoliday.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="eveningProfileHoliday.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.eveningProfileHoliday.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="eveningProfileHoliday.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="eveningProfileHoliday.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfileHoliday.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="nightProfileHoliday.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.nightProfileHoliday.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="nightProfileHoliday.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="nightProfileHoliday.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override5.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="override5.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override5.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="override5.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="override5.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override6.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="override6.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override6.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="override6.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="override6.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override7.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="override7.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override7.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="override7.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="override7.motionDetectDuration"/></div></td>
						...
						<tr>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override8.id}min" class='validate[required,custom[integer],min[0],max[${llmin}],funcCall[validateLevel]] text-input' path="override8.minLevel"/></div></td>
							<td><div class="settingInlineFieldValue"><form:input size="3" id="${profilehandler.override8.id}max" class='validate[required,custom[integer],min[${llmax}],max[100],funcCall[validateLevel]] text-input' path="override8.onLevel"/></div></td>
							...
							<td><div class="settingInlineFieldValue"><form:input size="3" class='validate[required,custom[integer],min[1],max[${amwmax}]] text-input'  path="override8.motionDetectDuration"/></div></td>
	...
	$(document).ready(function(){
		...
		$("#dclColorFixtureInputCheckbox").change(function(event){changeGenericCheckBoxVal(event.target,"#dclColorFixtureInput");});
		setGenericCheckBoxValue("#dclColorFixtureInputCheckbox",$("#dclColorFixtureInput").val());
		
		$("#dclCircadianFixtureInputCheckbox").change(function(event){changeGenericCheckBoxVal(event.target,"#dclCircadianFixtureInput");});
		setGenericCheckBoxValue("#dclCircadianFixtureInputCheckbox",$("#dclCircadianFixtureInput").val());
...
<%-- 						<form:hidden id="profileid" path="id"/> --%>
						<div class="settingAccordionFormDiv">							
							<fieldset>
								...
								<div class="settingAccordionFormField" title="Drop(%) - The percentage that the ambient light level must drop before fixture light level adjustment.&#10;Rise(%) - The percentage that the ambient light level must rise before fixture light level adjustment.
									">
									<span>
									 <spring:message code='profile.advanced.general.1.1'/></span>
								...
								<div class="settingAccordionFormField" title="Time in seconds to evaluate changes in ambient light before changing the light level. A typical value is 10. Larger values slow down the reaction to changes in ambient light.
								">
								...
								<div class="settingAccordionFormField" title="Length of time in minutes that must pass before the fixture light level can be changed due to a change in the ambient light level to avoid rapid cycling in fixture light level due to passing clouds, which irritates occupants. A typical value is 10 minutes.
								">
								...
								<div class="settingAccordionFormField" title="Linger light level before off(%) - The light level for the fixture before turning off. When turning a light off due to lack of occupancy, the light fixture will first be set at this level for the length of time specified by field Linger time before off and then turned off.&#10;Linger time before off(sec) - The time in seconds to hold on the fixture before turning off. This field is used with field Linger light level before off to specify the behavior before turning off a light due to lack of occupancy.">
								...
								<div class="settingAccordionFormField" title="Initial on level (0 - 100)(%) - The minimum light level when a luminaire is turned on. The value is a property of the combination of the ballast and bulbs of a luminaire. Fluorescent luminaires typically need to turn on with the light level set to at least 50%. &#10;Initial on time (1 - 14400)(sec) - The time that the light level must be held at or above the initial on level when a luminaire is turned on.">
								...
								<div class="settingAccordionFormField" title="Provides additional interpretation to the motion detection (0 = disabled, 1 = enabled) due to height of the sensor, such as above 25 feet.">
								...
								<div class="settingAccordionFormField">
									<span title="The threshold between 1 (minimal) and 255 (maximal) for detecting motion. When set to zero, the default value is used. The recommended values are between 1 and 10. This value should be increased if there are false triggers of motion, such as heat from a printer located beneath the fixture, or air from a vent."><spring:message code='profile.advanced.general.6.2'/></span>
								...
								<!-- 
								<div class="settingAccordionFormField">
									<span title="Override profile during holidays"><spring:message code='profile.advanced.blemode.9.1'/></span>
									<div class="settingAccordionFormInputField">
										<form:select path="bleMode" id="bleMode">
										
											<c:choose>
												<c:when test="${profilehandler.bleMode==0}">
													<form:option selected="selected" value="0" label='Off' />
													<form:option value="1" label='On' />
												</c:when>
												<c:otherwise>
													<form:option value="0" label='Off' />
													<form:option selected="selected" value="1" label='On' />
												</c:otherwise>
											</c:choose>
						...
						<div class="settingAccordionFormDiv">
							<fieldset>
								...
								<div class="settingAccordionFormField" title="DR response level (0 - 10) - The sensitivity between 0 (none) and 10 (most) for responding to a DR event. To disable response to a DR event, the value must be set to zero. To most aggressively respond to a DR event (that is to maximally reduce energy consumption), the value must be set to 10.">									
						...
						<div class="settingAccordionFormDiv">
							<fieldset>
								...
								<div class="settingAccordionFormField" title="Enable level (0 -100) (lux) - The ambient light level in lux below which to turn on envelope lighting. For example, when the ambient light is below this level, the motion sensitivity attribute (set on the Schedule tab) behaves as if the value was set to 1. It is also used in determining whether corridor and envelop lighting behavior should be applied. A typical value is 30.&#10;Neighbor level (10 - 250) (lux) - Used to affect corridor and envelop lighting behavior. A typical value is 40. A lower value is conservative, causing neighbors to come on aggressively. A higher value is energy efficient, but may stop the envelope lighting behavior.">
								...
								<div class="settingAccordionFormField" title="Envelope on level (0 - 100) (%) - The light level which to turn on a light during envelope lighting. For corridors, the value should be 100 to light up the entire corridor, or 50 for just ahead lighting.">
						...
						<div class="settingAccordionFormDiv">
							<fieldset>
								<legend><span class="settingAccordionFormDivHeader"><spring:message code='profile.advanced.dualchannel.properties'/></span></legend>
								
								<div class="settingAccordionFormField">
									<span title="Is color Fixture"><spring:message code='profile.advanced.dualled.colorfixture'/></span>
									<div class="settingAccordionFormInputField"><input  id="dclColorFixtureInputCheckbox" type="checkbox" /></div>
									<div class="settingAccordionFormInputField"><form:input  id="dclColorFixtureInput" type="hidden" path="colorFixture" /></div>
									<div id="daylightHarvestingDialog"></div>
								</div>
								
								<div class="settingAccordionFormField">
									<span title="Is Circadian"><spring:message code='profile.advanced.dualled.circadian'/></span>
									<div class="settingAccordionFormInputField"><input  id="dclCircadianFixtureInputCheckbox" type="checkbox" /></div>
									<div class="settingAccordionFormInputField"><form:input  id="dclCircadianFixtureInput" type="hidden" path="circadianOption" /></div>
									<div id="daylightHarvestingDialog"></div>
								</div>
								
								<div class="settingAccordionFormField">
								<!-- 
									<span title="PWM Behaviour"><spring:message code='profile.advanced.dualled.pwmbehaviour'/></span>
									<div class="settingAccordionFormInputField">
										<form:select path="pwmBehaviour" id="pwmBehaviour_combo">
											<form:option selected="selected" value="1" label='1' />
											<form:option value="2" label='2' />
										</form:select>
									</div>
								-->
								<input type="hidden" name="pwmBehaviour" value="0"/>
								</div>
								<legend><span class="settingAccordionFormDivHeader"><spring:message code='profile.advanced.dualled.circoptheadline.sub'/></span></legend>
								<div class="settingAccordionFormField" title="Sunrise">
									<span><spring:message code='profile.advanced.dualled.general.1.1'/></span>
									<div class="settingAccordionFormInputField"><form:input  class='validate[required,custom[integer],min[0],max[100]] text-input'  path="sunriseTemperatureRatio" size="2"/></div>
									<span><spring:message code='profile.advanced.dualled.general.1.2'/></span>
								</div>
								
								<div class="settingAccordionFormField" title="Noon">
									<span><spring:message code='profile.advanced.dualled.general.2.1'/></span>
									<div class="settingAccordionFormInputField"><form:input  class='validate[required,custom[integer],min[0],max[100]] text-input'  path="noonTemperatureRatio" size="2"/></div>
									<span><spring:message code='profile.advanced.dualled.general.2.2'/></span>
								</div>
								<div class="settingAccordionFormField" title="Sunset">
									<span><spring:message code='profile.advanced.dualled.general.3.1'/></span>
									<div class="settingAccordionFormInputField"><form:input  class='validate[required,custom[integer],min[0],max[100]] text-input'  path="sunsetTemperatureRatio" size="2"/></div>
									<span><spring:message code='profile.advanced.dualled.general.3.2'/></span>
								</div>
								
								<div class="settingAccordionFormField" title="Night">
									<span><spring:message code='profile.advanced.dualled.general.4.1'/></span>
									<div class="settingAccordionFormInputField"><form:input  class='validate[required,custom[integer],min[0],max[100]] text-input'  path="nightTemperatureRatio" size="2"/></div>
									<span><spring:message code='profile.advanced.dualled.general.4.2'/></span>
								</div>
							</fieldset>
						</div>
				</div>
					...
					$.post(
							...
							function(data){
								...
								if(response.success==1){ //Success
									...
									displayBasicMessage(response.message, "green");
									if($.cookie('em_profile_tab_selected') == "profile"){
