...
function setSelectedDevices(selFixtures, selGateways, selWds, selPlugload) {
	...
	for(var i = 0 ; i < gwNum; i++){
		...
		if((isVersionOneImage && (gateway.app2version.match("^1.") != null)) || (!isVersionOneImage && ( gateway.app2version.match("^2.") != null || gateway.app2version.match("^3.") != null )) )
	...
	for(var i = 0 ; i < fixNum; i++){
		...
		// Make sure that only devices with the appropriate version get selected
		if((isVersionOneImage && fixture.version.match("^1.") != null) || ( !isVersionOneImage && ( fixture.version.match("^2.") != null || fixture.version.match("^3.") != null )) )
