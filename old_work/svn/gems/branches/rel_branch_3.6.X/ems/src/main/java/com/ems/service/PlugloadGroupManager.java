...
public class PlugloadGroupManager {
	...
	public void updatePlugloadGroupProfile(PlugloadProfileHandler plugloadProfileHandler, Long groupId) {
		PlugloadProfileHandler copyProfileHandler = null;
        copyProfileHandler = plugloadProfileDao.savePlugloadProfileHandler(plugloadProfileHandler);
        PlugloadImpl.getInstance().updatePlugloadGroupProfile(copyProfileHandler, groupId);
    }

    public void updateAdvancePlugloadGroupProfile(PlugloadProfileHandler plugloadProfileHandler, Long groupId) {
    	PlugloadProfileHandler copyProfileHandler = null;
        copyProfileHandler = plugloadProfileDao.savePlugloadProfileHandler(plugloadProfileHandler);
        PlugloadImpl.getInstance().updateAdvancePlugloadGroupProfile(copyProfileHandler, groupId);
    }
