...
public class EventsAndFaultController {
    ...
    public String viewEvents(@RequestParam("id") String id, Model model) throws EmsValidationException{
		CommonUtils.isParamValueAllowedAndThrowException(messageSource, systemConfigurationManager, "eventandfaultcontroller.id", id);
    ...
    public String filterEvents(Model model) {
    	...
    	model.addAttribute("plugloadgroups", plugloadGroupManager.loadAllPlugloadGroups());
