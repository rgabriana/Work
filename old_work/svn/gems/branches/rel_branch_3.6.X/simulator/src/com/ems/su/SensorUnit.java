...
public class SensorUnit {
	...
	// Used to simulate mbits
	private long mbits;
	private Date mbitSetTime;
    ...
    public SensorUnit(String name) {
        ...
        currentApp = 2;
        mbits = 0;
        mbitSetTime = new Date(System.currentTimeMillis());
    }
...
//                .setEnergyCalibValue((short) (EnergyStatsConstant.ENERGY_CALIB_VALUE * percentageDimLevel / 100));
        ...
        byte[] mBitArr = Utils.longToByteArray(mbits);
        
        pmStatFrame.setMotion_mask_word_1(Utils.extractIntFromByteArray(mBitArr, 0));
        pmStatFrame.setMotion_mask_word_2(Utils.extractIntFromByteArray(mBitArr, 4));
    ...
    public void setMbits(long mbits) {
        this.mbits = mbits;
        this.mbitSetTime = new Date(System.currentTimeMillis());
    }

    public Date getMbitSetTime() {
        return mbitSetTime;
    }
}
