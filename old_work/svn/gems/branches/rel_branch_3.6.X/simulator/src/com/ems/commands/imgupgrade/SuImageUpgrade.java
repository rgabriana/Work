 ...
 * 
 */
public class SuImageUpgrade implements ICommandPktFrame {
    private Logger oLogger = Logger.getLogger(SuImageUpgrade.class.getName());
    ...
    public SuImageUpgrade(byte chunckno) {
