...
public class Groups implements Serializable {
    ...
    public Groups(Long id, String name, long profileHandlerId, short profileChecksum, short globalProfileChecksum,
            byte profileGroupId, byte profileNo,long templateId,boolean defaultProfile) {
        this.id = id;
        this.name = name;
    ...
    public Groups(Long id, String name, long profileHandlerId, short profileChecksum, short globalProfileChecksum,
            byte profileGroupId, byte drReactivity, byte profileNo,long templateId,boolean defaultProfile) {
        this.id = id;
        this.name = name;
        this.profileNo = profileNo;
        profileHandler = new ProfileHandler();
     ...
     */
	public void setProfileNo(Byte profileNo) {
		this.profileNo = profileNo;
	}
