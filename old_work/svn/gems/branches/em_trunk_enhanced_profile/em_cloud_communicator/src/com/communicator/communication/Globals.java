...
public class Globals {
	...
	final public static String separator_encode_string = "RCDLMTRENCODE"; 
	final public static String separator_string = "~"; 

	public static String buffer			= "";
	
	public static String propFile = "" ;
	public static Logger log = Logger.getLogger("EMS_COMMUNICATOR");
