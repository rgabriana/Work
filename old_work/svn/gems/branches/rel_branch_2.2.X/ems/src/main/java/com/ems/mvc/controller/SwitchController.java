...
//            model.addAttribute("switches", (oArea.getFloor() != null ? (switchManager.loadSwitchByFloorId(oArea.getFloor().getId())) : null));
    ...
    public String assignAreaToSwitchDialog(Model model, @CookieValue(value = FacilityCookieHandler.selectedFacilityCookie, required = false) String cookie){
	    FacilityCookieHandler cookieHandler = new FacilityCookieHandler(cookie);
    ...
    @RequestMapping("/assignareatoswitchesandfixtures.ems")
    public String assignAreaToSwitchesandFixturesDialog(Model model, @CookieValue(value = FacilityCookieHandler.selectedFacilityCookie, required = false) String cookie){
	    FacilityCookieHandler cookieHandler = new FacilityCookieHandler(cookie);
        ...
        return "devices/switchesandfixtures/assignarea/dialog";
    }
