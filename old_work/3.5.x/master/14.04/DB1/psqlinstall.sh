...
pg_dumpall --username=DB1 --clean --file=$src_dir/psql/DBBKUP_$(date +%d%b%Y_%T)
dropdb --username=DB1 --if-exists emscloud
createdb --username=DB1 --encoding=LATIN1 emscloud

SQL='psql --username=DB1 --dbname=emscloud'
