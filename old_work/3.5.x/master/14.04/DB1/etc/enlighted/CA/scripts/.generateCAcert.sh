...
openssl req -passout pass:enlighted -config $CA_HOME/openssl.my.cnf -new -x509 -extensions v3_ca -keyout $CA_HOME/private/enlca.key -out $CA_HOME/certs/enlca.crt -days 9125 \
